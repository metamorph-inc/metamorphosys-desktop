...
// components of OvervoltageProtection
 ...
 Modelica.Electrical.Analog.Basic.Capacitor CL(C=1e-7) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={62,4})));
 Semiconductors.ZDiode zDiode annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={-20,-20})));
 Semiconductors.ZDiode zDiode1 annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-20,22})));

// algorithms and equations of OvervoltageProtection
equation
 ...
 connect(sineVoltage.n,zDiode.p) annotation(Line(points={{-66,-4},{-66,-30},{-20,-30}},color={0,0,255},smooth=Smooth.None));
 connect(zDiode.p,ground.p) annotation(Line(points={{-20,-30},{-20,-62}},color={0,0,255},smooth=Smooth.None));
 connect(zDiode.p,RL.n) annotation(Line(points={{-20,-30},{26,-30},{26,-6}},color={0,0,255},smooth=Smooth.None));
 connect(zDiode1.p,Rv.n) annotation(Line(points={{-20,32},{-20,42},{-36,42}},color={0,0,255},smooth=Smooth.None));
 connect(RL.p,Rv.n) annotation(Line(points={{26,14},{26,42},{-36,42}},color={0,0,255},smooth=Smooth.None));
 connect(zDiode1.n,zDiode.n) annotation(Line(points={{-20,12},{-20,1},{-20,1},{-20,-10}},color={0,0,255},smooth=Smooth.None));
