...
package Internal
 ...
 partial package PartialModelicaServices
  ...
  package Animation
   ...
   annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}},grid={2,2}),graphics),Documentation(info="<html>
...
"));
   ...
   // locally defined classes in PartialSurface
    replaceable     function surfaceCharacteristic = Modelica.Mechanics.MultiBody.Interfaces.partialSurfaceCharacteristic "Function defining the surface characteristic" annotation(__Dymola_choicesAllMatching=true,Dialog(group="Surface properties"));

   // components of PartialSurface
...
protected
 ...
 package FileSystem
  ...
  // components of getNumberOfFiles
