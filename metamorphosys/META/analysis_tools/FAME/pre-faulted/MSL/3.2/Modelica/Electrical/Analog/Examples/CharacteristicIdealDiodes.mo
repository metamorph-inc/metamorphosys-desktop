...
model CharacteristicIdealDiodes
 "Characteristic of ideal diodes"
 extends Modelica.Icons.Example;

// components of CharacteristicIdealDiodes
 ...
 Modelica.Electrical.Analog.Basic.Resistor R1(R=1.e-3) annotation(Placement(transformation(extent={{60,40},{80,60}},rotation=0)));
 Modelica.Electrical.Analog.Basic.Resistor R2(R=1.e-3) annotation(Placement(transformation(extent={{60,0},{80,20}},rotation=0)));
 Modelica.Electrical.Analog.Basic.Resistor R3(R=1.e-3) annotation(Placement(transformation(extent={{60,-40},{80,-20}},rotation=0)));
...
// algorithms and equations of CharacteristicIdealDiodes
equation
