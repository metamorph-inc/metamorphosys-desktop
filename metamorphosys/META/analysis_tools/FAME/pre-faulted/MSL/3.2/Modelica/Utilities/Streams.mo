...
package Streams
 ...
 // components of print
  ...
  input String fileName="" "File where to print (empty string is the terminal)" annotation(Dialog(__Dymola_saveSelector(filter="Text files (*.txt)",caption="Text file to store the output of print(..)")));
...
<a href=\"modelica://ModelicaReference.Operators.string\">String</a>
 ...
 // components of readFile
  input String fileName "Name of the file that shall be read" annotation(Dialog(__Dymola_loadSelector(filter="Text files (*.txt)",caption="Open text file for reading")));
  output String stringVector[countLines(fileName)] "Content of file";

 // algorithms and equations of readFile
 algorithm
...
and endOfFile=true. Otherwise endOfFile=false.
 ...
 // components of countLines
  input String fileName "Name of the file that shall be read" annotation(Dialog(__Dymola_loadSelector(filter="Text files (*.txt)",caption="Open text file for coutning lines")));
...
<a href=\"modelica://ModelicaReference.Operators.string\">String</a>
 ...
 // components of close
  input String fileName "Name of the file that shall be closed" annotation(Dialog(__Dymola_loadSelector(filter="Text files (*.txt)",caption="Close text file")));
