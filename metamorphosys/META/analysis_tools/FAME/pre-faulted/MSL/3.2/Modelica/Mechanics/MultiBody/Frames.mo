...
package Frames
 ...
 // locally defined classes in Orientation
...
"));
 ...
 // components of resolve2
  input Orientation R "Orientation object to rotate frame 1 into frame 2";
  input Real v1[3] "Vector in frame 1";
  output Real v2[3] "Vector in frame 2";

 // algorithms and equations of resolve2
 algorithm
    v2:=R.T*v1;
 ...
 // algorithms and equations of resolveRelative
 algorithm
    v2:=resolve2(R2,resolve1(R1,v1));

 annotation(derivative(noDerivative=R1,noDerivative=R2)=Internal.resolveRelative_der,__Dymola_InlineAfterIndexReduction=true);
 end resolveRelative;
 ...
 // components of relativeRotation
  input Orientation R1 "Orientation object to rotate frame 0 into frame 1";
  input Orientation R2 "Orientation object to rotate frame 0 into frame 2";
  output Orientation R_rel "Orientation object to rotate frame 1 into frame 2";

 // algorithms and equations of relativeRotation
 algorithm
 ...
 // components of absoluteRotation
  input Orientation R1 "Orientation object to rotate frame 0 into frame 1";
 ...
 // algorithms and equations of absoluteRotation
 algorithm
 ...
 // algorithms and equations of planarRotation
 algorithm
 ...
 // components of planarRotationAngle
 ...
 // algorithms and equations of planarRotationAngle
 algorithm
...
and/or a division by zero will occur.
 ...
 // algorithms and equations of axesRotations
 algorithm
 ...
 // components of axesRotationsAngles
  input Orientation R "Orientation object to rotate frame 1 into frame 2";
  input Integer sequence[3](min={1,1,1},max={3,3,3})={1,2,3} "Sequence of rotations from frame 1 to frame 2 along axis sequence[i]";
 ...
 // algorithms and equations of axesRotationsAngles
 algorithm
...
<pre>
 ...
 // algorithms and equations of smallRotation
 algorithm
 ...
 // algorithms and equations of from_nxy
 algorithm
...
arbitrarily such that e_x and e_y are orthogonal to each other.
 ...
 // algorithms and equations of from_nxz
 algorithm
...
arbitrarily such that n_x and e_z are orthogonal to each other.
 ...
 // algorithms and equations of from_T
 algorithm
 ...
 // components of from_T2
  input Real T[3,3] "Transformation matrix to transform vector from frame 1 to frame 2 (v2=T*v1)";
  input Real der_T[3,3] "= der(T)";
  output Orientation R "Orientation object to rotate frame 1 into frame 2";

 // algorithms and equations of from_T2
 algorithm
...
is not possible or too difficult to compute, use function from_T2(..).
 ...
 // algorithms and equations of from_T_inv
 algorithm
 ...
 // algorithms and equations of from_Q
 algorithm
 ...
 // algorithms and equations of to_T
 algorithm
    T:=R.T;
 ...
 // algorithms and equations of to_Q
 algorithm
 ...
 // components of to_vector
  input Orientation R "Orientation object to rotate frame 1 into frame 2";
  output Real vec[9] "Elements of R in one vector";

 // algorithms and equations of to_vector
 algorithm
 ...
 // algorithms and equations of axis
 algorithm
...
and/or a division by zero will occur.
  ...
  // components of axesRotationsAngles
   ...
   input Integer sequence[3](min={1,1,1},max={3,3,3})={1,2,3} "Sequence of rotations from frame 1 to frame 2 along axis sequence[i]";
   input SI.Angle guessAngle1=0 "Select angles[1] such that |angles[1] - guessAngle1| is a minimum";
   output SI.Angle angles[3] "Rotation angles around the axes defined in 'sequence' such that T=TransformationMatrices.axesRotation(sequence,angles); -pi < angles[i] <= pi";
  protected
   Real e1_1[3](each final unit="1") "First rotation axis, resolved in frame 1";
   Real e2_1a[3](each final unit="1") "Second rotation axis, resolved in frame 1a";
   Real e3_1[3](each final unit="1") "Third rotation axis, resolved in frame 1";
  ...
  algorithm
     ...
     angles[2]:=TransformationMatrices.planarRotationAngle(e2_1a,TransformationMatrices.resolve2(T_1a,e3_1),e3_2);
     angles[3]:=TransformationMatrices.planarRotationAngle(e3_2,e2_1a,TransformationMatrices.resolve2(T,TransformationMatrices.resolve1(T_1a,e2_1a)));
...
<table border=1 cellspacing=0 cellpadding=2>
 ...
 package Internal
  ...
  // algorithms and equations of maxWithoutEvent
  algorithm
...
messages.
  ...
  // components of maxWithoutEvent_d
   input Real u1;
   input Real u2;
   input Real u1_d;
   input Real u2_d;
  ...
  // algorithms and equations of maxWithoutEvent_d
  algorithm
  ...
  // components of maxWithoutEvent_dd
   input Real u1;
   input Real u2;
   input Real u1_d;
   input Real u2_d;
  ...
  // algorithms and equations of maxWithoutEvent_dd
  algorithm
  ...
  // algorithms and equations of resolve1_der
  algorithm
  ...
  // algorithms and equations of resolve2_der
  algorithm
  ...
  // components of resolveRelative_der
   input Real v1[3] "Vector in frame 1";
   input Orientation R1 "Orientation object to rotate frame 0 into frame 1";
   input Orientation R2 "Orientation object to rotate frame 0 into frame 2";
   input Real v1_der[3] "= der(v1)";
  ...
  // algorithms and equations of resolveRelative_der
  algorithm
