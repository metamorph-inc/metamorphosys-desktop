...
<li><i> 1998   </i>
 ...
 // locally defined classes in ZDiode
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of ZDiode
 ...
 // algorithms and equations of ZDiode
 equation
 ...
 annotation(__Dymola_structurallyIncomplete=true,Documentation(info="<html>
...
<li><i>April 5, 2004   </i>
 ...
 // locally defined classes in PMOS
 ...
 // components of PMOS
  parameter Modelica.SIunits.Transconductance Beta=0.0105e-3 "Transconductance parameter";
 ...
 // algorithms and equations of PMOS
 equation
  ...
  v = Beta*(W+dW)/(L+dL);
  ud = smooth(0,(if _famefault_D.port_b.v>_famefault_S.port_b.v then _famefault_S.port_b.v else _famefault_D.port_b.v));
  us = smooth(0,(if _famefault_D.port_b.v>_famefault_S.port_b.v then _famefault_D.port_b.v else _famefault_S.port_b.v));
  uds = ud-us;
  ubs = smooth(0,(if _famefault_B.port_b.v<us then 0 else _famefault_B.port_b.v-us));
  ugst = (_famefault_G.port_b.v-us-Vt+K2*ubs)*K5;
  id = smooth(0,(if ugst>=0 then uds*gds else (if ugst<uds then (-v)*uds*(ugst-uds/(2))+uds*gds else (-v)*ugst*ugst/(2)+uds*gds)));
  _famefault_G.port_b.i = 0;
  _famefault_D.port_b.i = smooth(0,(if _famefault_D.port_b.v>_famefault_S.port_b.v then -id else id));
  _famefault_S.port_b.i = smooth(0,(if _famefault_D.port_b.v>_famefault_S.port_b.v then id else -id));
  _famefault_B.port_b.i = 0;
  LossPower = _famefault_D.port_b.i*(_famefault_D.port_b.v-_famefault_S.port_b.v);
  if not useHeatPort then
   T_heatPort = T;
  end if;
  ...
  connect(G,_famefault_G__S.port_a);
  connect(S,_famefault_G__S.port_b);
  connect(G,_famefault_B__G.port_a);
  connect(B,_famefault_B__G.port_b);
  connect(D,_famefault_D__S.port_a);
  connect(S,_famefault_D__S.port_b);
...
<li><i> 1998   </i>
 ...
 // locally defined classes in NMOS
    model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // components of NMOS
  parameter Modelica.SIunits.Transconductance Beta=0.041e-3 "Transconductance parameter";
  Modelica.Electrical.Analog.Interfaces.Pin D "Drain" annotation(Placement(transformation(extent={{90,40},{110,60}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_D(amount=0.0);
 ...
 // algorithms and equations of NMOS
 equation
  ...
  v = Beta*(W+dW)/(L+dL);
  ud = smooth(0,(if _famefault_D.port_b.v<_famefault_S.port_b.v then _famefault_S.port_b.v else _famefault_D.port_b.v));
  us = (if _famefault_D.port_b.v<_famefault_S.port_b.v then _famefault_D.port_b.v else _famefault_S.port_b.v);
  uds = ud-us;
  ubs = smooth(0,(if _famefault_B.port_b.v>us then 0 else _famefault_B.port_b.v-us));
  ugst = (_famefault_G.port_b.v-us-Vt+K2*ubs)*K5;
  id = smooth(0,(if ugst<=0 then uds*gds else (if ugst>uds then v*uds*(ugst-uds/(2))+uds*gds else v*ugst*ugst/(2)+uds*gds)));
  ...
  connect(B,_famefault_B__S.port_a);
  connect(S,_famefault_B__S.port_b);
  connect(G,_famefault_D__G.port_a);
  connect(D,_famefault_D__G.port_b);
  connect(G,_famefault_G__S.port_a);
  connect(S,_famefault_G__S.port_b);
...
<li><i> 1998   </i>
 ...
 // locally defined classes in NPN
 ...
 // components of NPN
  ...
  parameter Modelica.SIunits.Voltage Vt=0.02585 "Voltage equivalent of temperature";
  parameter Real Br=0.1 "Reverse beta";
  parameter Real Me=0.4 "Base-emitter gradation exponent";
  parameter Real Bf=50 "Forward beta";
  parameter Modelica.SIunits.Capacitance Cje=0.4e-12 "Base-emitter zero bias depletion cap.";
  parameter Modelica.SIunits.Capacitance Cjc=0.5e-12 "Base-coll. zero bias depletion cap.";
 ...
 protected
  ...
  function pow
   "Just a helper function for x^y"
  ...
  // algorithms and equations of pow
  algorithm
     z:=x^y;
  end pow;
 protected
 ...
 // algorithms and equations of NPN
 equation
  ExMin = exp(EMin);
  ExMax = exp(EMax);
  ...
  _famefault_C.port_b.i = (ibe-ibc)*qbk-ibc/(Br)-cbc*der(vbc)+Ccs*der(_famefault_C.port_b.v);
  _famefault_B.port_b.i = ibe/(Bf)+ibc/(Br)+cbc*der(vbc)+cbe*der(vbe);
  _famefault_E.port_b.i = -_famefault_B.port_b.i-_famefault_C.port_b.i+Ccs*der(_famefault_C.port_b.v);
  LossPower = (_famefault_C.port_b.v-_famefault_E.port_b.v)*(ibe-ibc)*qbk+vbc*ibc/(Br)+vbe*ibe/(Bf);
  if not useHeatPort then
   T_heatPort = T;
  end if;
...
<li><i> 1998   </i>
 ...
 // locally defined classes in PNP
    model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // algorithms and equations of PNP
 equation
  ExMin = exp(EMin);
  ExMax = exp(EMax);
  vbc = _famefault_C.port_b.v-_famefault_B.port_b.v;
  vbe = _famefault_E.port_b.v-_famefault_B.port_b.v;
  qbk = 1-vbc*Vak;
  ibc = smooth(1,(if (vbc/(Vt))<EMin then Is*(ExMin*(vbc/(Vt)-EMin+1)-1)+vbc*Gbc else (if (vbc/(Vt))>EMax then Is*(ExMax*(vbc/(Vt)-EMax+1)-1)+vbc*Gbc else Is*(exp(vbc/(Vt))-1)+vbc*Gbc)));
  ibe = smooth(1,(if (vbe/(Vt))<EMin then Is*(ExMin*(vbe/(Vt)-EMin+1)-1)+vbe*Gbe else (if (vbe/(Vt))>EMax then Is*(ExMax*(vbe/(Vt)-EMax+1)-1)+vbe*Gbe else Is*(exp(vbe/(Vt))-1)+vbe*Gbe)));
  Capcjc = smooth(1,(if (vbc/(Phic))>0 then Cjc*(1+Mc*vbc/(Phic)) else Cjc*pow(1-vbc/(Phic),-Mc)));
  ...
  cbe = smooth(1,(if (vbe/(Vt))<EMin then Tauf*Is/(Vt)*ExMin*(vbe/(Vt)-EMin+1)+Capcje else (if (vbe/(Vt))>EMax then Tauf*Is/(Vt)*ExMax*(vbe/(Vt)-EMax+1)+Capcje else Tauf*Is/(Vt)*exp(vbe/(Vt))+Capcje)));
  _famefault_C.port_b.i = -((ibe-ibc)*qbk-ibc/(Br)-cbc*der(vbc)-Ccs*der(_famefault_C.port_b.v));
  _famefault_B.port_b.i = -(ibe/(Bf)+ibc/(Br)+cbe*der(vbe)+cbc*der(vbc));
  _famefault_E.port_b.i = -_famefault_B.port_b.i-_famefault_C.port_b.i+Ccs*der(_famefault_C.port_b.v);
  LossPower = (_famefault_E.port_b.v-_famefault_C.port_b.v)*(ibe-ibc)*qbk+vbc*ibc/(Br)+vbe*ibe/(Bf);
  if not useHeatPort then
   T_heatPort = T;
  end if;
  connect(E,_famefault_E.port_a);
...
<li><i> 1998   </i>
 ...
 // locally defined classes in HeatingDiode
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of HeatingDiode
 ...
 // algorithms and equations of HeatingDiode
 equation
...
<li><i>April 5, 2004   </i>
 ...
 // locally defined classes in HeatingNMOS
    model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // algorithms and equations of HeatingNMOS
 equation
  ...
  uds = ud-us;
  ubs = smooth(0,(if _famefault_B.port_b.v>us then 0 else _famefault_B.port_b.v-us));
  ugst = (_famefault_G.port_b.v-us-vt_t+k2_t*ubs)*K5;
  id = smooth(0,(if ugst<=0 then uds*gds else (if ugst>uds then v*uds*(ugst-uds/(2))+uds*gds else v*ugst*ugst/(2)+uds*gds)));
...
<li><i>March 31, 2004   </i>
 ...
 // locally defined classes in HeatingPMOS
    model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // algorithms and equations of HeatingPMOS
 equation
...
<li><i>March 31, 2004   </i>
 ...
 // locally defined classes in HeatingNPN
    model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // algorithms and equations of HeatingNPN
 equation
  assert(T_heatPort>0,"temperature must be positive");
  ExMin = exp(EMin);
  ExMax = exp(EMax);
  ...
  _famefault_C.port_b.i = (ibe-ibc)*qbk-ibc/(br_t)-cbc*der(vbc)+Ccs*der(_famefault_C.port_b.v);
  _famefault_B.port_b.i = ibe/(bf_t)+ibc/(br_t)+cbc*der(vbc)+cbe*der(vbe);
  _famefault_E.port_b.i = -_famefault_B.port_b.i-_famefault_C.port_b.i+Ccs*der(_famefault_C.port_b.v);
  LossPower = vbc*ibc/(br_t)+vbe*ibe/(bf_t)+(ibe-ibc)*qbk*(_famefault_C.port_b.v-_famefault_E.port_b.v);
  if not useHeatPort then
   T_heatPort = T;
  end if;
  connect(E,_famefault_E.port_a);
...
<li><i>March 20, 2004   </i>
 ...
 // locally defined classes in HeatingPNP
    model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_heatPort = FAME.Dampers.ThermalWithoutConnectEquations;
    model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
 ...
 // algorithms and equations of HeatingPNP
 equation
  assert(T_heatPort>0,"temperature must be positive");
  ExMin = exp(EMin);
  ExMax = exp(EMax);
  vcb = _famefault_C.port_b.v-_famefault_B.port_b.v;
  veb = _famefault_E.port_b.v-_famefault_B.port_b.v;
  qbk = 1-vcb*Vak;
  hexp = (T_heatPort/(Tnom)-1)*EG/(vt_t);
  htempexp = smooth(1,(if hexp<EMin then ExMin*(hexp-EMin+1) else (if hexp>EMax then ExMax*(hexp-EMax+1) else exp(hexp))));
  is_t = Is*pow(T_heatPort/(Tnom),XTI)*htempexp;
  ...
  _famefault_C.port_b.i = icb/(br_t)+ccb*der(vcb)+Ccs*der(_famefault_C.port_b.v)+(icb-ieb)*qbk;
  _famefault_B.port_b.i = (-ieb)/(bf_t)-icb/(br_t)-ceb*der(veb)-ccb*der(vcb);
  _famefault_E.port_b.i = -_famefault_B.port_b.i-_famefault_C.port_b.i+Ccs*der(_famefault_C.port_b.v);
  LossPower = vcb*icb/(br_t)+veb*ieb/(bf_t)+(icb-ieb)*qbk*(_famefault_C.port_b.v-_famefault_E.port_b.v);
  if not useHeatPort then
   T_heatPort = T;
  end if;
  connect(E,_famefault_E.port_a);
...
<li><i>March 20, 2004   </i>
 ...
 // locally defined classes in Thyristor
    model _famefaults_Gate = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_Cathode = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_Anode = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_Anode__Cathode = FAME.Bridges.Electrical;
    model _famefaults_Anode__Gate = FAME.Bridges.Electrical;
    model _famefaults_Cathode__Gate = FAME.Bridges.Electrical;

 // components of Thyristor
  ...
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_Gate(amount=0.0);
  ...
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_Cathode(amount=0.0);
  ...
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_Anode(amount=0.0);
  ...
  FAME.Bridges.Electrical _famefault_Anode__Cathode(amount=0.0);
  FAME.Bridges.Electrical _famefault_Anode__Gate(amount=0.0);
  FAME.Bridges.Electrical _famefault_Cathode__Gate(amount=0.0);
 protected
 ...
 // algorithms and equations of Thyristor
 equation
  _famefault_Anode.port_b.i+_famefault_Gate.port_b.i+_famefault_Cathode.port_b.i = 0;
  vGK = _famefault_Gate.port_b.v-_famefault_Cathode.port_b.v;
  vAK = _famefault_Anode.port_b.v-_famefault_Cathode.port_b.v;
  iGK = _famefault_Gate.port_b.i;
  ...
  _famefault_Anode.port_b.i = smooth(1,(if vAK<-VRRM then (-VRRM)/(Roff)*exp((-(vAK+VRRM))/(Nbv*Vt)) else (if vControl<Voff then vAK/(Roff) else (if vControl<Von then vAK/(sqrt(Ron*Roff)*(Ron/(Roff))^((3*(2*vControl-Von-Voff)/(2*(Von-Voff))-4*((2*vControl-Von-Voff)/(2*(Von-Voff)))^(3))/(2))) else vAK/(Ron)))));
  vConmain = (if (_famefault_Anode.port_b.i>IH) or (vAK>VDRM) then Von else 0);
  connect(Gate,_famefault_Gate.port_a);
  connect(Cathode,_famefault_Cathode.port_a);
  connect(Anode,_famefault_Anode.port_a);
  connect(Anode,_famefault_Anode__Cathode.port_a);
  connect(Cathode,_famefault_Anode__Cathode.port_b);
  connect(Anode,_famefault_Anode__Gate.port_a);
  connect(Gate,_famefault_Anode__Gate.port_b);
  connect(Cathode,_famefault_Cathode__Gate.port_a);
  connect(Gate,_famefault_Cathode__Gate.port_b);
...
<li><i>May 12, 2009   </i>
 ...
 // components of SimpleTriac
  ...
  Modelica.Electrical.Analog.Interfaces.PositivePin g "Gate" annotation(Placement(transformation(extent={{-72,-106},{-52,-86}})));
  Modelica.Electrical.Analog.Semiconductors.Thyristor thyristor(VDRM=VDRM,VRRM=VRRM) annotation(Placement(transformation(extent={{-20,30},{0,50}})));
  Modelica.Electrical.Analog.Semiconductors.Thyristor thyristor1(VDRM=VDRM,VRRM=VRRM) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=180,origin={-12,-40})));
  Modelica.Electrical.Analog.Ideal.IdealDiode idealDiode(Vknee=0) annotation(Placement(transformation(extent={{-40,58},{-20,78}})));
  Modelica.Electrical.Analog.Ideal.IdealDiode idealDiode1(Vknee=0) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={-20,-72})));

 // algorithms and equations of SimpleTriac
 equation
  connect(thyristor.Anode,n) annotation(Line(points={{-19,40},{-18,40},{-18,48},{-70,48},{-70,0},{-100,0}},color={0,0,255},smooth=Smooth.None));
  connect(thyristor1.Anode,p) annotation(Line(points={{-3,-40},{-2,-40},{-2,-60},{80,-60},{80,0},{104,0}},color={0,0,255},smooth=Smooth.None));
  connect(thyristor1.Anode,thyristor.Cathode) annotation(Line(points={{-3,-40},{-2,-40},{-2,40},{-1,40}},color={0,0,255},smooth=Smooth.None));
  connect(thyristor1.Cathode,thyristor.Anode) annotation(Line(points={{-21,-40},{-22,-40},{-22,40},{-19,40}},color={0,0,255},smooth=Smooth.None));
  connect(thyristor.Gate,idealDiode.n) annotation(Line(points={{-3,49},{-3,59.5},{-20,59.5},{-20,68}},color={0,0,255},smooth=Smooth.None));
  connect(idealDiode.p,g) annotation(Line(points={{-40,68},{-82,68},{-82,-96},{-62,-96}},color={0,0,255},smooth=Smooth.None));
  connect(idealDiode1.n,thyristor1.Gate) annotation(Line(points={{-20,-62},{-20,-49},{-19,-49}},color={0,0,255},smooth=Smooth.None));
  connect(idealDiode1.p,g) annotation(Line(points={{-20,-82},{-42,-82},{-42,-96},{-62,-96}},color={0,0,255},smooth=Smooth.None));
...
protected
 ...
 // algorithms and equations of exlin
 algorithm
