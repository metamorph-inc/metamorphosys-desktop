...
// algorithms and equations of CauerLowPassOPV
equation
 ...
 connect(R2.n,n2) annotation(Line(points={{-220,0},{-218,0},{-218,6.52256e-016},{-216,6.52256e-016},{-216,0},{-212,0}},color={0,0,255}));
 ...
 connect(R6.n,n8) annotation(Line(points={{-11,0},{-9.25,0},{-9.25,6.52256e-016},{-7.5,6.52256e-016},{-7.5,0},{-4,0}},color={0,0,255}));
 ...
 connect(R8.n,n9) annotation(Line(points={{80,0},{82,0},{82,6.52256e-016},{84,6.52256e-016},{84,0},{88,0}},color={0,0,255}));
 ...
 connect(C9.n,n13) annotation(Line(points={{228,0},{231,0},{231,6.52256e-016},{234,6.52256e-016},{234,0},{240,0}},color={0,0,255}));
 ...
 connect(C9.p,p4) annotation(Line(points={{208,0},{203.75,0},{203.75,6.52256e-016},{199.5,6.52256e-016},{199.5,0},{191,0}},color={0,0,255}));
