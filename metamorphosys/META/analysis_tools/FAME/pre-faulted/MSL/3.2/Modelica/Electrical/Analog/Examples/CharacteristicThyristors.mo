...
model CharacteristicThyristors
 "Characteristic of ideal thyristors"
 extends Modelica.Icons.Example;

// components of CharacteristicThyristors
 ...
 Modelica.Electrical.Analog.Basic.Resistor R3(R=1.e-3) annotation(Placement(transformation(extent={{40,0},{60,20}},rotation=0)));
 ...
 Modelica.Electrical.Analog.Basic.Resistor R1(R=1.e-3) annotation(Placement(transformation(extent={{40,-30},{60,-10}},rotation=0)));

// algorithms and equations of CharacteristicThyristors
equation
