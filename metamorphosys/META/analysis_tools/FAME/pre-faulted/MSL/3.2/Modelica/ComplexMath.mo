...
<blockquote><pre>  <b>reverse</b>({1,2,3,4});  // = {4,3,2,1}</pre></blockquote>
  ...
  // components of sort
   ...
   input Boolean sortFrequency=true "= true, if sorting is first for imaginary then for real value; = false, if sorting is for absolute value";
...
<p>This function returns the inverse Complex hyperbolic cosine of the Complex input.</p>
 ...
 // algorithms and equations of atanh
 algorithm
...
<p>This function returns the Real absolute of the Complex input, i.e., it's length.</p>
 ...
 // algorithms and equations of arg
 algorithm
...
<p>This function returns the Real argument of the Complex input, i.e., it's angle.</p>
 ...
 // algorithms and equations of conj
 algorithm
...
<p>This function returns the Complex conjugate of the Complex input.</p>
 ...
 // algorithms and equations of real
 algorithm
    r:=c.re;
...
<p>This function returns the real part of the Complex input.</p>
 ...
 // algorithms and equations of imag
 algorithm
    r:=c.im;
...
</html>"),Icon(graphics={Text(extent={{-94,-14},{72,-56}},lineColor={0,0,0},textString="f(x+j*y)")}));
end ComplexMath;
