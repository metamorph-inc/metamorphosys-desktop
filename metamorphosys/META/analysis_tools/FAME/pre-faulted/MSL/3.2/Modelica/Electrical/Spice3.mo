...
<li><i>Feb 2010 </i>by Kristin Majetta initially written</li>
 ...
 package Examples
  ...
  // components of Inverter
   Semiconductors.M_PMOS mp(modelcard(RD=0,RS=0,CBD=0,CBS=0)) annotation(Placement(transformation(extent={{-14,8},{6,28}})));
   Semiconductors.M_NMOS mn(modelcard(RD=0,RS=0,CBD=0,CBS=0)) annotation(Placement(transformation(extent={{-14,-34},{6,-14}})));
   Basic.Ground ground annotation(Placement(transformation(extent={{-14,-60},{6,-40}})));
   Sources.V_pulse vin(V2=5,TD=4e-12,TR=0.1e-12,TF=0.1e-12,PW=1e-12,PER=2e-12) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-40,-16})));
   Sources.V_pulse v(V2=5,TR=0.1e-12) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={40,-4})));

  // algorithms and equations of Inverter
  equation
   connect(mn.D,mp.S) annotation(Line(points={{-4,-14},{-4,8}},color={0,0,255},smooth=Smooth.None));
   connect(mp.G,mn.G) annotation(Line(points={{-14,17.9},{-14,-24.1}},color={0,0,255},smooth=Smooth.None));
   connect(mn.S,mn.B) annotation(Line(points={{-4,-34},{6,-34},{6,-24}},color={0,0,0},smooth=Smooth.None));
   connect(mp.B,mp.D) annotation(Line(points={{6,18},{6,28},{-4,28}},color={0,0,255},smooth=Smooth.None));
   connect(mn.S,ground.p) annotation(Line(points={{-4,-34},{-4,-40}},color={0,0,0},smooth=Smooth.None));
   connect(v.p,mp.D) annotation(Line(points={{40,6},{40,28},{-4,28}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground.p) annotation(Line(points={{40,-14},{40,-40},{-4,-40}},color={0,0,0},smooth=Smooth.None));
   connect(vin.p,mp.G) annotation(Line(points={{-40,-6},{-40,17.9},{-14,17.9}},color={0,0,255},smooth=Smooth.None));
   connect(vin.n,ground.p) annotation(Line(points={{-40,-26},{-40,-40},{-4,-40}},color={0,0,0},smooth=Smooth.None));

  annotation(Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),experiment(StopTime=1e-011,NumberOfIntervals=2000,Tolerance=1e-007),Documentation(info="<html>
...
<li><i>March 2009 </i>by Kristin Majetta initially implemented</li>
  ...
  // components of InvertersApartRecord
   Basic.Ground ground annotation(Placement(transformation(extent={{-38,-80},{-18,-60}},rotation=0)));
   parameter Semiconductors.ModelcardMOS MPmos(GAMMA=0.37) "Specified modelcardMOS for MPmos";
   parameter Semiconductors.ModelcardMOS MNmos(GAMMA=0.37,LAMBDA=0.02) "Specified modelcardMOS for MNmos";
   Semiconductors.M_PMOS mp1(modelcard=MPmos) annotation(Placement(transformation(extent={{-38,20},{-18,40}},rotation=0)));
   Semiconductors.M_NMOS mn1(modelcard=MNmos) annotation(Placement(transformation(extent={{-38,-30},{-18,-10}},rotation=0)));
   Semiconductors.M_PMOS mp2(modelcard=MPmos) annotation(Placement(transformation(extent={{2,20},{22,40}},rotation=0)));
   Semiconductors.M_NMOS mn2(modelcard=MNmos) annotation(Placement(transformation(extent={{2,-30},{22,-10}},rotation=0)));
   Basic.C_Capacitor c1(C=1e-5) annotation(Placement(transformation(origin={-8,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Basic.C_Capacitor c2(C=1e-5) annotation(Placement(transformation(origin={34,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse vin(V2=5,TD=2,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-60,-32})));
   Sources.V_pulse v(V2=5,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={60,-32})));

  // algorithms and equations of InvertersApartRecord
  equation
   connect(mp1.B,mp1.D) annotation(Line(points={{-18,30},{-18,40},{-28,40}},color={0,0,255}));
   connect(mn1.S,ground.p) annotation(Line(points={{-28,-30},{-28,-60}},color={0,0,255}));
   connect(mp1.S,mn1.D) annotation(Line(points={{-28,20},{-28,-10}},color={0,0,255}));
   connect(mn1.G,mp1.G) annotation(Line(points={{-38,-20.1},{-38,29.9}},color={0,0,255}));
   connect(mn1.B,mn1.S) annotation(Line(points={{-18,-20},{-18,-30},{-28,-30}},color={0,0,255}));
   connect(mp2.B,mp2.D) annotation(Line(points={{22,30},{22,40},{12,40}},color={0,0,255}));
   connect(mn2.S,ground.p) annotation(Line(points={{12,-30},{12,-60},{-28,-60}},color={0,0,255}));
   connect(mp2.S,mn2.D) annotation(Line(points={{12,20},{12,-10}},color={0,0,255}));
   connect(mn2.G,mp2.G) annotation(Line(points={{2,-20.1},{2,29.9}},color={0,0,255}));
   connect(mn2.B,mn2.S) annotation(Line(points={{22,-20},{22,-30},{12,-30}},color={0,0,255}));
   connect(mp2.G,mn1.D) annotation(Line(points={{2,29.9},{2,0},{-28,0},{-28,-10}},color={0,0,255}));
   connect(c1.p,mn1.D) annotation(Line(points={{-8,-20},{-8,0},{-28,0},{-28,-10}},color={0,0,255}));
   connect(mn2.D,c2.p) annotation(Line(points={{12,-10},{12,0},{34,0},{34,-20}},color={0,0,255}));
   connect(c2.n,ground.p) annotation(Line(points={{34,-40},{34,-60},{-28,-60}},color={0,0,255}));
   connect(c1.n,ground.p) annotation(Line(points={{-8,-40},{-8,-60},{-28,-60}},color={0,0,255}));
   connect(mp1.G,vin.p) annotation(Line(points={{-38,29.9},{-60,29.9},{-60,-22}},color={0,0,255},smooth=Smooth.None));
   connect(vin.n,ground.p) annotation(Line(points={{-60,-42},{-60,-60},{-28,-60}},color={0,0,0},smooth=Smooth.None));
   connect(v.p,mp2.D) annotation(Line(points={{60,-22},{60,40},{12,40}},color={0,0,255},smooth=Smooth.None));
   connect(mp1.D,mp2.D) annotation(Line(points={{-28,40},{12,40}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground.p) annotation(Line(points={{60,-42},{60,-60},{-28,-60}},color={0,0,0},smooth=Smooth.None));

  annotation(Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),experiment(StopTime=5),Documentation(info="<html>
...
<li><i>April 2009 </i>by Kristin Majetta initially implemented</li>
  ...
  // locally defined classes in InvertersExtendedModel
...
<p>This model MNmos is inherited by the model <i>InverterExtendedModel</i> to build an inverter circuit. For detailed information</p><p>please see <i>InverterExtendedModel</i>.</p>
  ...
  // components of InvertersExtendedModel
   Basic.Ground ground annotation(Placement(transformation(extent={{-40,-80},{-20,-60}},rotation=0)));
   MPmos mp1 annotation(Placement(transformation(extent={{-40,20},{-20,40}},rotation=0)));
   MNmos mn1 annotation(Placement(transformation(extent={{-40,-30},{-20,-10}},rotation=0)));
   MPmos mp2 annotation(Placement(transformation(extent={{0,20},{20,40}},rotation=0)));
   MNmos mn2 annotation(Placement(transformation(extent={{0,-30},{20,-10}},rotation=0)));
   Basic.C_Capacitor c1(C=1e-5) annotation(Placement(transformation(origin={-10,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Basic.C_Capacitor c2(C=1e-5) annotation(Placement(transformation(origin={32,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse vin(V2=5,TD=2,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-60,-22})));
   Sources.V_pulse v(V2=5,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={56,-22})));

  // algorithms and equations of InvertersExtendedModel
  equation
   connect(mp1.B,mp1.D) annotation(Line(points={{-20,30},{-20,40},{-30,40}},color={0,0,255}));
   connect(mn1.S,ground.p) annotation(Line(points={{-30,-30},{-30,-60}},color={0,0,255}));
   connect(mp1.S,mn1.D) annotation(Line(points={{-30,20},{-30,-10}},color={0,0,255}));
   ...
   connect(mp2.S,mn2.D) annotation(Line(points={{10,20},{10,-10}},color={0,0,255}));
   ...
   connect(c1.p,mn1.D) annotation(Line(points={{-10,-20},{-10,0},{-30,0},{-30,-10}},color={0,0,255}));
   connect(mn2.D,c2.p) annotation(Line(points={{10,-10},{10,0},{32,0},{32,-20}},color={0,0,255}));
   connect(c2.n,ground.p) annotation(Line(points={{32,-40},{32,-60},{-30,-60}},color={0,0,255}));
   connect(c1.n,ground.p) annotation(Line(points={{-10,-40},{-10,-60},{-30,-60}},color={0,0,255}));
   connect(vin.p,mp1.G) annotation(Line(points={{-60,-12},{-60,26},{-40,26},{-40,29.9}},color={0,0,255},smooth=Smooth.None));
   connect(vin.n,ground.p) annotation(Line(points={{-60,-32},{-60,-60},{-30,-60}},color={0,0,0},smooth=Smooth.None));
   connect(v.p,mp2.D) annotation(Line(points={{56,-12},{56,40},{10,40}},color={0,0,255},smooth=Smooth.None));
   connect(mp2.D,mp1.D) annotation(Line(points={{10,40},{-30,40}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground.p) annotation(Line(points={{56,-32},{56,-60},{-30,-60}},color={0,0,0},smooth=Smooth.None));

  annotation(Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),experiment(StopTime=5),DymolaStoredErrors,Documentation(info="<html>
...
<li><i>April 2009 </i>by Kristin Majetta initially implemented</li>
  ...
  // components of FourInverters
   Basic.Ground ground annotation(Placement(transformation(extent={{-74,-80},{-54,-60}},rotation=0)));
   ...
   Semiconductors.M_PMOS mp1(modelcard=modp) annotation(Placement(transformation(extent={{-74,20},{-54,40}},rotation=0)));
   Semiconductors.M_NMOS mn1(modelcard=modn) annotation(Placement(transformation(extent={{-74,-30},{-54,-10}},rotation=0)));
   Semiconductors.M_PMOS mp2(modelcard=modp) annotation(Placement(transformation(extent={{-34,20},{-14,40}},rotation=0)));
   Semiconductors.M_NMOS mn2(modelcard=modn) annotation(Placement(transformation(extent={{-34,-30},{-14,-10}},rotation=0)));
   Semiconductors.M_PMOS mp3(modelcard=modp) annotation(Placement(transformation(extent={{6,20},{26,40}},rotation=0)));
   Semiconductors.M_PMOS mp4(modelcard=modn) annotation(Placement(transformation(extent={{46,20},{66,40}},rotation=0)));
   Semiconductors.M_NMOS mn3(modelcard=modp) annotation(Placement(transformation(extent={{6,-30},{26,-10}},rotation=0)));
   Semiconductors.M_NMOS mn4(modelcard=modn) annotation(Placement(transformation(extent={{46,-30},{66,-10}},rotation=0)));
   Basic.C_Capacitor c1(C=10e-6) annotation(Placement(transformation(origin={-44,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Basic.C_Capacitor c2(C=10e-6) annotation(Placement(transformation(origin={-2,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Basic.C_Capacitor c3(C=10e-6) annotation(Placement(transformation(origin={36,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Basic.C_Capacitor c4(C=10e-6) annotation(Placement(transformation(origin={76,-30},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse vin(V2=5,TD=2,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-86,-42})));
   Sources.V_pulse v(V2=5,TR=1) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={92,-48})));

  // algorithms and equations of FourInverters
  equation
   connect(mp1.B,mp1.D) annotation(Line(points={{-54,30},{-54,40},{-64,40}},color={0,0,255}));
   connect(mn1.S,ground.p) annotation(Line(points={{-64,-30},{-64,-60}},color={0,0,255}));
   connect(mp1.S,mn1.D) annotation(Line(points={{-64,20},{-64,-10}},color={0,0,255}));
   connect(mn1.G,mp1.G) annotation(Line(points={{-74,-20.1},{-74,29.9}},color={0,0,255}));
   connect(mn1.B,mn1.S) annotation(Line(points={{-54,-20},{-54,-30},{-64,-30}},color={0,0,255}));
   connect(mp2.B,mp2.D) annotation(Line(points={{-14,30},{-14,40},{-24,40}},color={0,0,255}));
   connect(mn2.S,ground.p) annotation(Line(points={{-24,-30},{-24,-60},{-64,-60}},color={0,0,255}));
   connect(mp2.S,mn2.D) annotation(Line(points={{-24,20},{-24,-10}},color={0,0,255}));
   connect(mn2.G,mp2.G) annotation(Line(points={{-34,-20.1},{-34,29.9}},color={0,0,255}));
   connect(mn2.B,mn2.S) annotation(Line(points={{-14,-20},{-14,-30},{-24,-30}},color={0,0,255}));
   connect(c1.p,mn1.D) annotation(Line(points={{-44,-20},{-44,0},{-64,0},{-64,-10}},color={0,0,255}));
   connect(mn2.D,c2.p) annotation(Line(points={{-24,-10},{-24,0},{-2,0},{-2,-20}},color={0,0,255}));
   connect(c2.n,ground.p) annotation(Line(points={{-2,-40},{-2,-60},{-64,-60}},color={0,0,255}));
   connect(c1.n,ground.p) annotation(Line(points={{-44,-40},{-44,-60},{-64,-60}},color={0,0,255}));
   connect(c3.n,ground.p) annotation(Line(points={{36,-40},{36,-60},{-64,-60}},color={0,0,255}));
   connect(c4.n,ground.p) annotation(Line(points={{76,-40},{76,-60},{-64,-60}},color={0,0,255}));
   connect(mn4.B,mn4.S) annotation(Line(points={{66,-20},{66,-30},{56,-30}},color={0,0,255}));
   connect(mn3.B,mn3.S) annotation(Line(points={{26,-20},{26,-30},{16,-30}},color={0,0,255}));
   ...
   connect(mp3.S,mn3.D) annotation(Line(points={{16,20},{16,-10}},color={0,0,255}));
   connect(mp4.S,mn4.D) annotation(Line(points={{56,20},{56,-10}},color={0,0,255}));
   connect(mn3.S,ground.p) annotation(Line(points={{16,-30},{16,-60},{-64,-60}},color={0,0,255}));
   connect(mn4.S,ground.p) annotation(Line(points={{56,-30},{56,-60},{-64,-60}},color={0,0,255}));
   connect(c3.p,mn3.D) annotation(Line(points={{36,-20},{36,0},{16,0},{16,-10}},color={0,0,255}));
   connect(c4.p,mn4.D) annotation(Line(points={{76,-20},{76,0},{56,0},{56,-10}},color={0,0,255}));
   connect(c2.p,mn3.G) annotation(Line(points={{-2,-20},{2,-20},{2,-20.1},{6,-20.1}},color={0,0,255}));
   connect(mn3.G,mp3.G) annotation(Line(points={{6,-20.1},{6,29.9}},color={0,0,255}));
   connect(c3.p,mn4.G) annotation(Line(points={{36,-20},{41,-20},{41,-20.1},{46,-20.1}},color={0,0,255}));
   connect(mn4.G,mp4.G) annotation(Line(points={{46,-20.1},{46,29.9}},color={0,0,255}));
   connect(c1.p,mn2.G) annotation(Line(points={{-44,-20},{-39,-20},{-39,-20.1},{-34,-20.1}},color={0,0,255}));
   connect(vin.p,mn1.G) annotation(Line(points={{-86,-32},{-86,0},{-74,0},{-74,-20.1}},color={0,0,255},smooth=Smooth.None));
   connect(vin.n,ground.p) annotation(Line(points={{-86,-52},{-86,-60},{-64,-60}},color={0,0,0},smooth=Smooth.None));
   connect(v.p,mp4.D) annotation(Line(points={{92,-38},{92,40},{56,40}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground.p) annotation(Line(points={{92,-58},{92,-60},{-64,-60}},color={0,0,0},smooth=Smooth.None));
   connect(mp3.D,mp4.D) annotation(Line(points={{16,40},{56,40}},color={0,0,255},smooth=Smooth.None));
   connect(mp2.D,mp3.D) annotation(Line(points={{-24,40},{16,40}},color={0,0,255},smooth=Smooth.None));
   connect(mp1.D,mp2.D) annotation(Line(points={{-64,40},{-24,40}},color={0,0,255},smooth=Smooth.None));

  annotation(Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}},initialScale=0.1),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},initialScale=0.1),graphics),experiment(StopTime=5),Documentation(info="<html>
...
<li><i>April 2009 </i>by Kristin Majetta initially implemented</li>
  ...
  // components of Nand
   Semiconductors.M_PMOS mp1(L=2e-5,W=1e-5,modelcard(PHI=0.7)) annotation(Placement(transformation(extent={{-22,24},{-2,44}},rotation=0)));
   Semiconductors.M_PMOS mp2(modelcard(PHI=0.7)) annotation(Placement(transformation(extent={{24,24},{44,44}},rotation=0)));
   Semiconductors.M_NMOS mn2 annotation(Placement(transformation(extent={{-24,-44},{-4,-24}},rotation=0)));
   Semiconductors.M_NMOS mn1 annotation(Placement(transformation(extent={{-24,-10},{-4,10}},rotation=0)));
   Sources.V_constant vconstant(V=5) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={62,34})));
   Basic.Ground ground annotation(Placement(transformation(extent={{20,-100},{40,-80}},rotation=0)));
   Sources.V_pulse vin1(TR=1e-9,TF=1e-9,V2=5,TD=2e-8,PW=4e-8,PER=8e-8) annotation(Placement(transformation(origin={-50,24},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse vin2(V2=5,TR=1e-9,TF=1e-9,TD=1e-8,PW=4e-8,PER=8e-8) annotation(Placement(transformation(origin={-52,-44},extent={{-10,-10},{10,10}},rotation=270)));

  // algorithms and equations of Nand
  equation
   connect(mp1.B,mp1.D) annotation(Line(points={{-2,34},{-2,44},{-12,44}},color={0,0,255}));
   connect(mp2.B,mp2.D) annotation(Line(points={{44,34},{44,44},{34,44}},color={0,0,255}));
   connect(vconstant.p,mp2.D) annotation(Line(points={{62,44},{62,44},{34,44}},color={0,0,255}));
   connect(mp2.D,mp1.D) annotation(Line(points={{34,44},{-12,44}},color={0,0,255}));
   connect(mp1.G,mn1.G) annotation(Line(points={{-22,33.9},{-22,16},{-24,16},{-24,-0.1}},color={0,0,255}));
   connect(mp1.G,vin1.p) annotation(Line(points={{-22,33.9},{-38,33.9},{-38,34},{-50,34}},color={0,0,255}));
   connect(vin1.n,ground.p) annotation(Line(points={{-50,14},{-62,14},{-62,-80},{30,-80}},color={0,0,255}));
   connect(mp2.G,mn2.G) annotation(Line(points={{24,33.9},{24,14},{-32,14},{-32,-34.1},{-24,-34.1}},color={0,0,255}));
   connect(mn2.G,vin2.p) annotation(Line(points={{-24,-34.1},{-38,-34.1},{-38,-34},{-52,-34}},color={0,0,255}));
   connect(vin2.n,ground.p) annotation(Line(points={{-52,-54},{-52,-80},{30,-80}},color={0,0,255}));
   connect(mn2.S,ground.p) annotation(Line(points={{-14,-44},{-14,-80},{30,-80}},color={0,0,255}));
   connect(mn1.B,mn2.B) annotation(Line(points={{-4,0},{-4,-34}},color={0,0,255}));
   connect(mn2.B,mn2.S) annotation(Line(points={{-4,-34},{-4,-44},{-14,-44}},color={0,0,255}));
   connect(mn1.S,mn2.D) annotation(Line(points={{-14,-10},{-14,-24}},color={0,0,255}));
   connect(mp1.S,mn1.D) annotation(Line(points={{-12,24},{-12,18},{-14,18},{-14,10}},color={0,0,255}));
   connect(mp2.S,mn1.D) annotation(Line(points={{34,24},{34,10},{-14,10}},color={0,0,255}));
   connect(vconstant.n,ground.p) annotation(Line(points={{62,24},{62,-80},{30,-80}},color={0,0,255}));
...
<li><i>May 2009 </i>by Kristin Majetta initially implemented</li>
...
</html>"),experiment(StopTime=2e-007));
  end Nand;
  ...
  // components of Nor
   Semiconductors.M_PMOS mp1(modelcard(RD=1e-4,RS=1e-4,CBD=1e-5,CBS=1e-5,CGSO=1e-5,CGDO=1e-5,CGBO=1e-5)) annotation(Placement(transformation(extent={{-16,24},{4,44}},rotation=0)));
   Semiconductors.M_PMOS mp2(modelcard(RD=1e-4,RS=1e-4,CBD=1e-5,CBS=1e-5,CGSO=1e-5,CGDO=1e-5,CGBO=1e-5)) annotation(Placement(transformation(extent={{-16,-6},{4,14}},rotation=0)));
   Semiconductors.M_NMOS mn1(modelcard(RD=1e-4,RS=1e-4,CBD=1e-5,CBS=1e-5,CGSO=1e-5,CGDO=1e-5,CGBO=1e-5)) annotation(Placement(transformation(extent={{-16,-44},{4,-24}},rotation=0)));
   Semiconductors.M_NMOS mn2(modelcard(RD=1e-4,RS=1e-4,CBD=1e-5,CBS=1e-5,CGSO=1e-5,CGDO=1e-5,CGBO=1e-5)) annotation(Placement(transformation(extent={{32,-44},{52,-24}},rotation=0)));
   Basic.Ground ground annotation(Placement(transformation(extent={{28,-100},{48,-80}},rotation=0)));
   Sources.V_pulse vin1(V2=5,TR=0.001,TF=0.001,PW=2,PER=10,TD=2) annotation(Placement(transformation(origin={-42,24},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse vin2(V2=5,TR=0.001,TF=0.001,PW=2,PER=10,TD=1) annotation(Placement(transformation(origin={-44,-44},extent={{-10,-10},{10,10}},rotation=270)));
   Sources.V_pulse v(TD=0.5,TR=0.1,V2=5) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={62,34})));

  // algorithms and equations of Nor
  equation
   connect(mn1.B,mn1.S) annotation(Line(points={{4,-34},{4,-44},{-6,-44}},color={0,0,255}));
   connect(mn2.B,mn2.S) annotation(Line(points={{52,-34},{52,-44},{42,-44}},color={0,0,255}));
   connect(mn2.S,ground.p) annotation(Line(points={{42,-44},{38,-44},{38,-80}},color={0,0,255}));
   connect(mn1.S,ground.p) annotation(Line(points={{-6,-44},{-6,-80},{38,-80}},color={0,0,255}));
   connect(vin2.p,mn1.G) annotation(Line(points={{-44,-34},{-29,-34},{-29,-34.1},{-16,-34.1}},color={0,0,255}));
   connect(vin2.n,ground.p) annotation(Line(points={{-44,-54},{-44,-80},{38,-80}},color={0,0,255}));
   connect(vin1.p,mp1.G) annotation(Line(points={{-42,34},{-29,34},{-29,33.9},{-16,33.9}},color={0,0,255}));
   connect(vin1.n,ground.p) annotation(Line(points={{-42,14},{-64,14},{-64,-80},{38,-80}},color={0,0,255}));
   connect(mp1.S,mp2.D) annotation(Line(points={{-6,24},{-6,14}},color={0,0,255}));
   ...
   connect(vin2.p,mp2.G) annotation(Line(points={{-44,-34},{-44,4},{-16,4},{-16,3.9}},color={0,0,255}));
   connect(vin1.p,mn2.G) annotation(Line(points={{-42,34},{-28,34},{-28,-18},{32,-18},{32,-34.1}},color={0,0,255}));
   connect(mp1.B,mp1.D) annotation(Line(points={{4,34},{4,44},{-6,44}},color={0,0,255},smooth=Smooth.None));
   connect(mp2.B,mp1.B) annotation(Line(points={{4,4},{4,34}},color={0,0,255},smooth=Smooth.None));
   connect(v.p,mp1.D) annotation(Line(points={{62,44},{-6,44}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground.p) annotation(Line(points={{62,24},{62,-80},{38,-80}},color={0,0,0},smooth=Smooth.None));
...
<li><i>March 2009 </i>by Kristin Majetta initially implemented</li>
  ...
  // components of Graetz
   Semiconductors.D_DIODE D1(modelcarddiode(CJO=1e-7)) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={0,14})));
   Semiconductors.D_DIODE D3(modelcarddiode(CJO=1e-7)) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={20,-8})));
   Semiconductors.D_DIODE D4(modelcarddiode(CJO=1e-7)) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={1,-30})));
   Semiconductors.D_DIODE D2(modelcarddiode(CJO=1e-7)) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-20,-8})));
   Semiconductors.R_Resistor rout(R=10) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={42,-7})));
   Sources.V_sin vsin(VA=10,FREQ=200) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-44,-8})));
   Basic.Ground ground annotation(Placement(transformation(extent={{-30,-60},{-10,-40}})));

  // algorithms and equations of Graetz
  equation
   connect(D1.n,D3.p) annotation(Line(points={{10,14},{20,14},{20,2}},color={0,0,0},smooth=Smooth.None));
   connect(D2.p,D1.p) annotation(Line(points={{-20,2},{-20,14},{-10,14}},color={0,0,255},smooth=Smooth.None));
   connect(D4.n,D3.n) annotation(Line(points={{11,-30},{20,-30},{20,-18}},color={0,0,0},smooth=Smooth.None));
   connect(D4.p,D2.n) annotation(Line(points={{-9,-30},{-20,-30},{-20,-18}},color={0,0,255},smooth=Smooth.None));
   connect(D4.p,ground.p) annotation(Line(points={{-9,-30},{-20,-30},{-20,-40}},color={0,0,255},smooth=Smooth.None));
   connect(vsin.n,ground.p) annotation(Line(points={{-44,-18},{-44,-40},{-20,-40}},color={0,0,0},smooth=Smooth.None));
   connect(D4.n,rout.p) annotation(Line(points={{11,-30},{42,-30},{42,-17}},color={0,0,0},smooth=Smooth.None));
   connect(rout.n,D1.p) annotation(Line(points={{42,3},{42,26},{-20,26},{-20,14},{-10,14}},color={0,0,255},smooth=Smooth.None));
   connect(D3.p,vsin.p) annotation(Line(points={{20,2},{20,40},{-44,40},{-44,2}},color={0,0,255},smooth=Smooth.None));

  annotation(Diagram(graphics),Icon(graphics),experiment(StopTime=0.025),Documentation(info="<html>
...
<li><i>Jan. 2010 </i>by Kristin Majetta initially implemented</li>
  ...
  // components of Oscillator
   Basic.R_Resistor r(R=1000) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={-36,20})));
   Basic.C_Capacitor c(C=1e-7) annotation(Placement(transformation(extent={{-32,0},{-12,20}})));
   Basic.C_Capacitor c1(C=1e-7) annotation(Placement(transformation(extent={{24,0},{44,20}})));
   Basic.R_Resistor r1(R=22000) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={-6,20})));
   Basic.R_Resistor r2(R=22000) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={18,20})));
   Basic.R_Resistor r3(R=1000) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={50,20})));
   Semiconductors.Q_NPNBJT T1(modelcard(CJE=1e-9,CJC=1e-9)) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=180,origin={-30,-24})));
   Semiconductors.Q_NPNBJT T2(modelcard(CJE=1e-9,CJC=1e-9)) annotation(Placement(transformation(extent={{30,-40},{50,-20}})));
   Basic.Ground ground1 annotation(Placement(transformation(extent={{-78,-34},{-58,-14}})));
   Basic.Ground ground2 annotation(Placement(transformation(extent={{50,-60},{70,-40}})));
   Basic.R_Resistor r4(R=10000) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={64,-2})));
   Sources.V_pulse v(V2=8,TD=0.0005,TR=0.01,PW=1000,PER=1000,TF=0) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={-68,20})));

  // algorithms and equations of Oscillator
  equation
   connect(r.n,r1.n) annotation(Line(points={{-36,30},{-6,30}},color={0,0,0},smooth=Smooth.None));
   connect(r1.n,r2.n) annotation(Line(points={{-6,30},{18,30}},color={0,0,0},smooth=Smooth.None));
   connect(r2.n,r3.n) annotation(Line(points={{18,30},{50,30}},color={0,0,0},smooth=Smooth.None));
   connect(r.p,c.p) annotation(Line(points={{-36,10},{-32,10}},color={0,0,255},smooth=Smooth.None));
   connect(c.n,r1.p) annotation(Line(points={{-12,10},{-6,10}},color={0,0,0},smooth=Smooth.None));
   connect(r2.p,c1.p) annotation(Line(points={{18,10},{24,10}},color={0,0,255},smooth=Smooth.None));
   connect(c1.n,r3.p) annotation(Line(points={{44,10},{50,10}},color={0,0,0},smooth=Smooth.None));
   connect(r1.p,T2.B) annotation(Line(points={{-6,10},{-6,-30},{30.4,-30}},color={0,0,255},smooth=Smooth.None));
   connect(r2.p,T1.B) annotation(Line(points={{18,10},{18,-24},{-20.4,-24}},color={0,0,255},smooth=Smooth.None));
   connect(T1.C,r.p) annotation(Line(points={{-33,-34},{-48,-34},{-48,10},{-36,10}},color={0,0,255},smooth=Smooth.None));
   connect(T1.E,ground1.p) annotation(Line(points={{-33,-14},{-68,-14}},color={0,0,0},smooth=Smooth.None));
   connect(T2.E,ground2.p) annotation(Line(points={{43,-40},{60,-40}},color={0,0,0},smooth=Smooth.None));
   connect(r3.p,T2.C) annotation(Line(points={{50,10},{50,-20},{43,-20}},color={0,0,255},smooth=Smooth.None));
   connect(r3.p,r4.p) annotation(Line(points={{50,10},{58,10},{58,8},{64,8}},color={0,0,255},smooth=Smooth.None));
   connect(ground2.p,r4.n) annotation(Line(points={{60,-40},{60,-12},{64,-12}},color={0,0,255},smooth=Smooth.None));
   connect(v.p,r.n) annotation(Line(points={{-68,30},{-36,30}},color={0,0,255},smooth=Smooth.None));
   connect(v.n,ground1.p) annotation(Line(points={{-68,10},{-68,-14}},color={0,0,0},smooth=Smooth.None));
...
<p>This package Example circuits contains some useful examples to demonstrate how the library is working and how the models can be used.</p>
 ...
 package Basic
  ...
  // components of Ground
   Modelica.Electrical.Analog.Interfaces.Pin p "Ground pin" annotation(Placement(transformation(origin={0,100},extent={{10,-10},{-10,10}},rotation=270)));
...
by this gound element.
...
</HTML>"),Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}},grid={2,2}),graphics={Line(points={{0,100},{0,40}},color={0,0,255},smooth=Smooth.None),Line(points={{-60,40},{60,40}},color={0,0,255},smooth=Smooth.None),Line(points={{-40,20},{40,20}},color={0,0,255},smooth=Smooth.None),Line(points={{-20,0},{20,0}},color={0,0,255},smooth=Smooth.None),Text(extent={{-50,-14},{58,-54}},lineColor={0,0,255},textString="%name")}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}},grid={2,2}),graphics),Window(x=0.23,y=0.23,width=0.59,height=0.63));
  end Ground;

  model R_Resistor
   "Ideal linear electrical resistor"

  // locally defined classes in R_Resistor
  ...
  // components of R_Resistor
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Resistance R(start=1000) "Resistance";
  ...
  // algorithms and equations of R_Resistor
  equation
   R*i = v;
...
The Resistance <i>R</i> is allowed to be positive, zero, or negative.
...
</HTML>"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics={Rectangle(extent={{-70,30},{70,-30}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{-70,0}},color={0,0,255}),Line(points={{70,0},{90,0}},color={0,0,255}),Text(extent={{-136,-46},{140,-62}},lineColor={0,0,0},textString="R=%R"),Text(extent={{-136,34},{138,54}},textString="%name")}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics),Window(x=0.2,y=0.06,width=0.62,height=0.69));
  end R_Resistor;

  model C_Capacitor
   "Ideal linear electrical capacitor"

  // locally defined classes in C_Capacitor
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of C_Capacitor
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Capacitance C(start=0) "Capacitance";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   parameter Boolean UIC=false "Use initial conditions: true, if initial condition is used";
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   ...
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
  protected
   Modelica.SIunits.Voltage vinternal(start=IC,fixed=UIC);

  // algorithms and equations of C_Capacitor
  equation
   vinternal = _famefault_p.port_b.v-_famefault_n.port_b.v;
   i = C*der(vinternal);
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
  ...
  annotation(Window(x=0.32,y=0.33,width=0.48,height=0.58),Documentation(info="<HTML>
<p>
...
"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics={Line(points={{-14,28},{-14,-28}},color={0,0,255},thickness=0.5),Line(points={{14,28},{14,-28}},color={0,0,255},thickness=0.5),Line(points={{-90,0},{-14,0}}),Line(points={{14,0},{90,0}}),Text(extent={{-130,-40},{134,-60}},lineColor={0,0,0},textString="C=%C"),Text(extent={{-138,42},{136,62}},textString="%name")}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics));
  end C_Capacitor;

  model L_Inductor
   "Ideal linear electrical inductor"

  // locally defined classes in L_Inductor
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of L_Inductor
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   Modelica.SIunits.Current iinternal(start=IC,fixed=UIC);
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   parameter Boolean UIC=false "Use initial conditions: true, if initial condition is used";
  ...
  // algorithms and equations of L_Inductor
  equation
   iinternal = _famefault_p.port_b.i;
   L*der(iinternal) = v;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
...
<p>The linear inductor connects the branch voltage <i>v</i> with the branch current <i>i</i> by <i>v = L * di/dt</i>. The inductance <i>L</i> is allowed to be positive, zero, or negative.</p>
</html>"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics={Ellipse(extent={{-60,-15},{-30,15}}),Ellipse(extent={{-30,-15},{0,15}}),Ellipse(extent={{0,-15},{30,15}}),Ellipse(extent={{30,-15},{60,15}}),Rectangle(extent={{-60,-30},{60,0}},lineColor={255,255,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{60,0},{90,0}}),Line(points={{-90,0},{-60,0}}),Text(extent={{-142,-40},{142,-60}},lineColor={0,0,0},textString="L=%L"),Text(extent={{-136,36},{138,56}},textString="%name")}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={2,2}),graphics),Window(x=0.3,y=0.12,width=0.6,height=0.6));
  end L_Inductor;

  model E_VCV
   "Linear voltage-controlled voltage source"

  // locally defined classes in E_VCV
  ...
  // components of E_VCV
   Modelica.SIunits.Voltage v1 "Voltage drop over the controlling port";
   Modelica.Electrical.Analog.Interfaces.NegativePin n1 "Negative pin of the controlling port" annotation(Placement(transformation(extent={{-90,-60},{-110,-40}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n1(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p2 "Positive pin of the controlled port" annotation(Placement(transformation(extent={{110,40},{90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p2(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p1 "Positive pin of the controlling port" annotation(Placement(transformation(extent={{-110,40},{-90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p1(amount=0.0);
   Modelica.SIunits.Voltage v2 "Voltage drop over the controlled port";
   Modelica.Electrical.Analog.Interfaces.NegativePin n2 "Negative pin of the controlled port" annotation(Placement(transformation(extent={{90,-60},{110,-40}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n2(amount=0.0);
   Modelica.SIunits.Current i2 "Current flowing from pos. to neg. pin of the controlled port";
   parameter Real gain(start=0) "Voltage gain";
   Modelica.SIunits.Current i1 "Current flowing from pos. to neg. pin of the controlling port";
  ...
  // algorithms and equations of E_VCV
  equation
   v2 = v1*gain;
   i1 = 0;
...
"),Window(x=0.28,y=0.02,width=0.59,height=0.92),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Rectangle(extent={{-70,70},{70,-70}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Text(extent={{-99,-79},{100,-129}},textString="%name"),Line(points={{-90,50},{-30,50}}),Line(points={{-30,-50},{-90,-50}}),Line(points={{100,50},{30,50},{30,-50},{100,-50}}),Ellipse(extent={{10,20},{50,-20}}),Line(points={{-20,60},{20,60}}),Polygon(points={{20,60},{10,63},{10,57},{20,60}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics));
  end E_VCV;

  model G_VCC
   "Linear voltage-controlled current source"

  // locally defined classes in G_VCC
      model _famefaults_n1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p2 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n2 = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // components of G_VCC
   ...
   Modelica.Electrical.Analog.Interfaces.NegativePin n1 "Negative pin of the controlling port" annotation(Placement(transformation(extent={{-90,-60},{-110,-40}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n1(amount=0.0);
   parameter Modelica.SIunits.Conductance transConductance(start=0) "Transconductance";
   Modelica.Electrical.Analog.Interfaces.PositivePin p2 "Positive pin of the controlled port" annotation(Placement(transformation(extent={{110,40},{90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p2(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p1 "Positive pin of the controlling port" annotation(Placement(transformation(extent={{-110,40},{-90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p1(amount=0.0);
  ...
  // algorithms and equations of G_VCC
  equation
...
"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Rectangle(extent={{-71,70},{69,-70}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Text(extent={{-100,-80},{99,-129}},textString="%name"),Line(points={{-91,50},{-31,50}}),Line(points={{-31,-50},{-91,-50}}),Ellipse(extent={{9,20},{49,-20}}),Line(points={{-21,60},{19,60}}),Polygon(points={{19,60},{9,63},{9,57},{19,60}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Line(points={{89,50},{29,50},{29,20}}),Line(points={{90,-50},{29,-50},{29,-20}}),Line(points={{9,0},{49,0}})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.34,y=0.05,width=0.6,height=0.6));
  end G_VCC;

  model H_CCV
   "Linear current-controlled voltage source"

  // locally defined classes in H_CCV
      model _famefaults_n1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p2 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n2 = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // components of H_CCV
   ...
   Modelica.Electrical.Analog.Interfaces.NegativePin n1 "Negative pin of the controlling port" annotation(Placement(transformation(extent={{-90,-60},{-110,-40}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n1(amount=0.0);
   parameter Modelica.SIunits.Resistance transResistance(start=0) "Transresistance";
   Modelica.Electrical.Analog.Interfaces.PositivePin p2 "Positive pin of the controlled port" annotation(Placement(transformation(extent={{110,40},{90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p2(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p1 "Positive pin of the controlling port" annotation(Placement(transformation(extent={{-110,40},{-90,60}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p1(amount=0.0);
  ...
  // algorithms and equations of H_CCV
  equation
...
<pre>
...
</html>"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Rectangle(extent={{-70,70},{70,-70}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Text(extent={{-99,-80},{100,-130}},textString="%name"),Line(points={{100,50},{30,50},{30,-50},{100,-50}}),Ellipse(extent={{10,20},{50,-20}}),Line(points={{-20,60},{20,60}}),Polygon(points={{20,60},{10,63},{10,57},{20,60}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Line(points={{-90,50},{-20,50},{-20,-50},{-90,-50}})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.3,y=0.13,width=0.6,height=0.6));
  end H_CCV;

  model F_CCC
   "Linear current-controlled current source"

  // locally defined classes in F_CCC
      model _famefaults_n1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p2 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p1 = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n2 = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // algorithms and equations of F_CCC
  equation
   i2 = i1*gain;
   v1 = 0;
   v1 = _famefault_p1.port_b.v-_famefault_n1.port_b.v;
...
<pre>    VALUE -&gt; gain </pre>
</html>"),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Rectangle(extent={{-70,70},{70,-70}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Text(extent={{-104,-76},{97,-127}},textString="%name"),Line(points={{-100,50},{-30,50},{-30,-50},{-100,-50}}),Ellipse(extent={{10,20},{50,-20}}),Line(points={{-20,60},{20,60}}),Polygon(points={{20,60},{10,63},{10,57},{20,60}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Line(points={{90,50},{30,50},{30,20}}),Line(points={{91,-50},{30,-50},{30,-20}}),Line(points={{10,0},{50,0}})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.31,y=0.09,width=0.6,height=0.6));
  end F_CCC;

 annotation(preferedView="info",Window(x=0.03,y=0.04,width=0.54,height=0.35,library=1,autolayout=1),Documentation(info="<html>
...
<p>
 ...
 package Semiconductors
  ...
  // locally defined classes in M_PMOS
      model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_S = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B__S = FAME.Bridges.Electrical;
      model _famefaults_D__S = FAME.Bridges.Electrical;
      model _famefaults_G__S = FAME.Bridges.Electrical;
      model _famefaults_B__D = FAME.Bridges.Electrical;
      model _famefaults_B__G = FAME.Bridges.Electrical;
      model _famefaults_D__G = FAME.Bridges.Electrical;

  // components of M_PMOS
   Modelica.Electrical.Analog.Interfaces.PositivePin D "drain node" annotation(Placement(transformation(extent={{-10,90},{10,110}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_D(amount=0.0);
   Real ibsgmin;
   Modelica.Electrical.Analog.Interfaces.PositivePin G "gate node" annotation(Placement(transformation(extent={{-110,-12},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_G(amount=0.0);
   Real irs;
   Modelica.Electrical.Analog.Interfaces.PositivePin B "bulk node" annotation(Placement(transformation(extent={{90,-10},{110,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_B(amount=0.0);
   Modelica.SIunits.Voltage vGS "Gate - source voltage";
   Modelica.Electrical.Spice3.Internal.SpiceConstants C "General constants of SPICE simulator";
   parameter Modelica.SIunits.Length L=1e-4 "Length";
   Real icGD;
   parameter Modelica.Electrical.Spice3.Internal.ModelcardMOS modelcard "MOSFET modelcard" annotation(Evaluate=true);
   Real icGB;
   final parameter Modelica.Electrical.Spice3.Internal.Mos.MosModelLineVariables vp=Mos1.mos1ModelLineParamsInitEquations(p,C,m_type) "Model line variables";
   parameter Modelica.SIunits.Temp_C TEMP=27 "Operating temperature of the device";
   Real icBS;
   parameter Modelica.SIunits.Length W=1e-4 "Width";
   constant Boolean m_bInit=false;
   Modelica.Electrical.Analog.Interfaces.NegativePin S "source node" annotation(Placement(transformation(extent={{-10,-110},{10,-90}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_S(amount=0.0);
   parameter Modelica.SIunits.Voltage IC(start=-1e40) "Initial condition values, not implemented yet";
   Real Dinternal;
   Real ibdgmin;
   parameter Modelica.SIunits.Area AS=0 "Area of the source diffusion";
   Modelica.SIunits.Voltage vDS "Drain - source voltage";
   final parameter Modelica.Electrical.Spice3.Internal.Mosfet.Mosfet m=Mos1.mos1RenameParametersDev(modelcard,mtype,W,L,AS,AS,PD,PS,NRD,NRS,OFF,IC,TEMP) "Renamed parameters" annotation(Evaluate=true);
   parameter Integer OFF=0 "Optional initial condition: 0 - IC not used, 1 - IC used, not implemented yet";
   final parameter Integer mtype(start=0)=1 "MOSFET type: 0 - N channel, 1 - P channel";
   final parameter Integer m_type=(if m.m_bPMOS>0.5 then -1 else 1) "Type of the transistor";
   ...
   final parameter Modelica.Electrical.Spice3.Internal.Mos1.Mos1Calc c1=Mos.mosCalcInitEquations(p,C,vp,m) "Precalculated parameters";
   final parameter Modelica.Electrical.Spice3.Internal.Mos1.Mos1Calc c2=Mos.mosCalcCalcTempDependencies(p,C,vp,m,c1,m_type) "Precalculated parameters";
   Real ird;
   Real icGS;
   final parameter Modelica.Electrical.Spice3.Internal.Mos1.Mos1ModelLineParams p=Mos1.mos1RenameParameters(modelcard,C) "Model line parameters" annotation(Evaluate=true);
   parameter Modelica.SIunits.Length PS=0 "Perimeter of the source junction";
   ...
   Modelica.Electrical.Spice3.Internal.Mos.CurrrentsCapacitances cc;
   Real Sinternal;
   FAME.Bridges.Electrical _famefault_B__S(amount=0.0);
   FAME.Bridges.Electrical _famefault_D__S(amount=0.0);
   FAME.Bridges.Electrical _famefault_G__S(amount=0.0);
   FAME.Bridges.Electrical _famefault_B__D(amount=0.0);
   FAME.Bridges.Electrical _famefault_B__G(amount=0.0);
   FAME.Bridges.Electrical _famefault_D__G(amount=0.0);

  // algorithms and equations of M_PMOS
  equation
   ...
   vDS = _famefault_D.port_b.v-_famefault_S.port_b.v;
   vGS = _famefault_G.port_b.v-_famefault_S.port_b.v;
   cc = Modelica.Electrical.Spice3.Internal.Mos.mosCalcNoBypassCode(m,m_type,c2,p,C,vp,m_bInit,{_famefault_G.port_b.v,_famefault_B.port_b.v,Dinternal,Sinternal});
   ird*c1.m_drainResistance = _famefault_D.port_b.v-Dinternal;
   irs*p.m_sourceResistance = _famefault_S.port_b.v-Sinternal;
   icBD = cc.cBD*(der(_famefault_B.port_b.v)-der(Dinternal));
   icBS = cc.cBS*(der(_famefault_B.port_b.v)-der(Sinternal));
   icGB = cc.cGB*(der(_famefault_G.port_b.v)-der(_famefault_B.port_b.v));
   icGD = cc.cGD*(der(_famefault_G.port_b.v)-der(Dinternal));
   icGS = cc.cGS*(der(_famefault_G.port_b.v)-der(Sinternal));
   ibsgmin = Modelica.Electrical.Spice3.Internal.SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Sinternal);
   ibdgmin = Modelica.Electrical.Spice3.Internal.SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Dinternal);
   _famefault_G.port_b.i = icGB+icGD+icGS;
   _famefault_B.port_b.i = cc.iBD+cc.iBS+ibdgmin+ibsgmin-icGB+icBD+icBS;
   _famefault_D.port_b.i = ird;
   _famefault_S.port_b.i = irs;
   0 = -ird+cc.idrain-cc.iBD-ibdgmin-icGD-icBD;
   0 = -irs-cc.idrain-cc.iBS-ibsgmin-icGS-icBS;
   connect(D,_famefault_D.port_a);
   connect(G,_famefault_G.port_a);
   connect(B,_famefault_B.port_a);
   connect(S,_famefault_S.port_a);
   connect(S,_famefault_B__S.port_a);
   connect(B,_famefault_B__S.port_b);
   connect(S,_famefault_D__S.port_a);
   connect(D,_famefault_D__S.port_b);
   connect(S,_famefault_G__S.port_a);
   connect(G,_famefault_G__S.port_b);
   connect(B,_famefault_B__D.port_a);
   connect(D,_famefault_B__D.port_b);
   connect(B,_famefault_B__G.port_a);
   connect(G,_famefault_B__G.port_b);
   connect(D,_famefault_D__G.port_a);
   connect(G,_famefault_D__G.port_b);

  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics={Polygon(points={{60,0},{40,5},{40,-5},{60,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Documentation(info="<html>
...
<li><i>March 2008 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // locally defined classes in M_NMOS
      model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_S = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // components of M_NMOS
   ...
   final parameter Modelica.Electrical.Spice3.Internal.Mosfet.Mosfet m=Mos1.mos1RenameParametersDev(modelcard,mtype,W,L,AS,AS,PD,PS,NRD,NRS,OFF,IC,TEMP) "Renamed parameters" annotation(Evaluate=true);
   parameter Integer OFF=0 "Optional initial condition: 0 - IC not used, 1 - IC used, not implemented yet";
   final parameter Integer mtype(start=0)=0 "MOSFET type: 0 - N channel, 1 - P channel";
   final parameter Integer m_type=(if m.m_bPMOS>0.5 then -1 else 1) "Type of the transistor";
   parameter Modelica.SIunits.Area AD=0 "Area of the drain diffusion";
   parameter Real NRS=1 "Number of squares of the source diffusions";
   final parameter Modelica.Electrical.Spice3.Internal.Mos1.Mos1Calc c1=Mos.mosCalcInitEquations(p,C,vp,m) "Precalculated parameters";
  ...
  // algorithms and equations of M_NMOS
  equation
   assert(NRD<>0,"NRD, length of drain in squares, must not be zero");
   assert(NRS<>0,"NRS, length of source in squares, must not be zero");
   vDS = _famefault_D.port_b.v-_famefault_S.port_b.v;
   ...
   connect(D,_famefault_D__G.port_a);
   connect(G,_famefault_D__G.port_b);
   connect(D,_famefault_B__D.port_a);
   connect(B,_famefault_B__D.port_b);
   connect(G,_famefault_B__G.port_a);
   connect(B,_famefault_B__G.port_b);

  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics={Polygon(points={{40,0},{60,5},{60,-5},{40,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Documentation(info="<html>
...
<p>In modelcards, that are typical for SPICE3, the so called technology parameters are stored. These parameters are usually set for more than one semiconductor device in a circuit, e.g., the temperature of a whole electrical circuit.</p>
  ...
  // locally defined classes in Q_NPNBJT
      model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_C__E = FAME.Bridges.Electrical;
      model _famefaults_B__C = FAME.Bridges.Electrical;
      model _famefaults_B__E = FAME.Bridges.Electrical;

  // components of Q_NPNBJT
   final parameter Modelica.Electrical.Spice3.Internal.Bjt3.BjtModelLineVariables vl=Bjt3.bjtModelLineInitEquations(p) "Model line variables";
   Modelica.Electrical.Analog.Interfaces.NegativePin E "Emitter node" annotation(Placement(transformation(extent={{10,-108},{30,-88}}),iconTransformation(extent={{20,-110},{40,-90}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_E(amount=0.0);
   Real Binternal;
   final parameter Modelica.Electrical.Spice3.Internal.Bjt3.Bjt p1=Bjt3.bjtRenameParametersDev(AREA,OFF,IC_VBE,IC_VCE,SENS_AREA) "Renamed parameters" annotation(Evaluate=true);
   Modelica.Electrical.Analog.Interfaces.PositivePin B "Base node" annotation(Placement(transformation(extent={{-108,-10},{-88,10}}),iconTransformation(extent={{-106,-10},{-86,10}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_B(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin C "Collector node" annotation(Placement(transformation(extent={{10,88},{30,108}}),iconTransformation(extent={{20,90},{40,110}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_C(amount=0.0);
   final parameter Real TBJT(start=1)=1 "Type of transistor (NPN=1, PNP=-1)";
   parameter Modelica.Electrical.Spice3.Internal.ModelcardBJT modelcard "BJT modelcard" annotation(Evaluate=true);
   parameter Modelica.SIunits.Voltage IC_VBE(start=-1e40) "Initial condition value (VBC, not implemented yet";
   parameter Modelica.SIunits.Temp_C TEMP=27 "Operating temperature of the device";
   Real icapbx;
   parameter Boolean SENS_AREA=false "Flag to request sensitivity WRT area, not implemented yet";
   ...
   parameter Modelica.SIunits.Voltage IC_VCE(start=-1e40) "Initial condition value (VBE, not implemented yet";
   final parameter Modelica.Electrical.Spice3.Internal.Bjt3.Bjt3Calc c=Bjt3.bjt3CalcTempDependencies(p1,p,m,vl) "Precalculated parameters";
   final parameter Modelica.Electrical.Spice3.Internal.Model.Model m=Bjt3.bjtRenameParametersDevTemp(TEMP) "Renamed parameters" annotation(Evaluate=true);
   parameter Boolean OFF=false "Optional initial condition: false - IC not used, true - IC used, not implemented yet";
   Real capbx;
   Real ibcgmin;
   Real ire;
   final parameter Modelica.Electrical.Spice3.Internal.Bjt3.BjtVariables v=Bjt3.bjtInitEquations(p1,p,vl) "Precalculated parameters";
   Real irb;
   Modelica.SIunits.Voltage vCE "Collector - emitter voltage";
   Real irc;
   final parameter Modelica.Electrical.Spice3.Internal.Bjt3.BjtModelLineParams p=Bjt3.bjtRenameParameters(modelcard,Con,TBJT) "Model line parameters" annotation(Evaluate=true);
   constant Modelica.Electrical.Spice3.Internal.SpiceConstants Con "General constants of SPICE simulator";
   Real Cinternal;
   Real Einternal;
   Modelica.Electrical.Spice3.Internal.Bjt3.CurrentsCapacitances cc;
   FAME.Bridges.Electrical _famefault_C__E(amount=0.0);
   FAME.Bridges.Electrical _famefault_B__C(amount=0.0);
   FAME.Bridges.Electrical _famefault_B__E(amount=0.0);

  // algorithms and equations of Q_NPNBJT
  equation
   vBE = _famefault_B.port_b.v-_famefault_E.port_b.v;
   vCE = _famefault_C.port_b.v-_famefault_E.port_b.v;
   vBC = _famefault_B.port_b.v-_famefault_C.port_b.v;
   (cc,capbe,capbc,capbx) = Modelica.Electrical.Spice3.Internal.Bjt3.bjtNoBypassCode(m,p1,p,c,v,vl,{_famefault_C.port_b.v,_famefault_B.port_b.v,_famefault_E.port_b.v,Cinternal,Binternal,Einternal},m_bInit);
   ...
   icapbx = (if m_bInit then 0.0 else capbx*(der(_famefault_B.port_b.v)-der(Cinternal)));
   irc*p.m_collectorResist = _famefault_C.port_b.v-Cinternal;
   ire*p.m_emitterResist = _famefault_E.port_b.v-Einternal;
   irb*p.m_baseResist = _famefault_B.port_b.v-Binternal;
   ...
   _famefault_C.port_b.i = irc;
   _famefault_E.port_b.i = ire;
   _famefault_B.port_b.i = irb+icapbx;
   0 = ibcgmin+irc-cc.iCC+cc.iBCN+cc.iBC+icapbc+icapbx;
   0 = ibegmin+ire+cc.iCC+cc.iBEN+cc.iBE+icapbe;
   0 = -ibcgmin-ibegmin+irb-cc.iBC-cc.iBE-cc.iBCN-cc.iBEN-icapbc-icapbe;
   connect(E,_famefault_E.port_a);
   connect(B,_famefault_B.port_a);
   connect(C,_famefault_C.port_a);
   connect(C,_famefault_C__E.port_a);
   connect(E,_famefault_C__E.port_b);
   connect(C,_famefault_B__C.port_a);
   connect(B,_famefault_B__C.port_b);
   connect(E,_famefault_B__E.port_a);
   connect(B,_famefault_B__E.port_b);

  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Polygon(points={{8,-68},{2,-55},{-4,-62},{8,-68}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<li><i>August 2009 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // locally defined classes in Q_PNPBJT
      model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_C__E = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of Q_PNPBJT
  equation
   vBE = _famefault_B.port_b.v-_famefault_E.port_b.v;
   vCE = _famefault_C.port_b.v-_famefault_E.port_b.v;
   vBC = _famefault_B.port_b.v-_famefault_C.port_b.v;
   ...
   connect(B,_famefault_B.port_a);
   connect(C,_famefault_C.port_a);
   connect(E,_famefault_C__E.port_a);
   connect(C,_famefault_C__E.port_b);
   connect(E,_famefault_B__E.port_a);
   connect(B,_famefault_B__E.port_b);
   connect(C,_famefault_B__C.port_a);
   connect(B,_famefault_B__C.port_b);

  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Polygon(points={{0,-60},{14,-67},{8,-74},{0,-60}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<p>Technology parameters of the modified Gummel-Poon bipolar junction transistor model</p>
  ...
  // locally defined classes in D_DIODE
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of D_DIODE
   parameter Modelica.Electrical.Spice3.Internal.ModelcardDIODE modelcarddiode "DIODE modelcard" annotation(Evaluate=true);
   Real ir;
   parameter Real AREA=1 "Area factor";
   final parameter Modelica.Electrical.Spice3.Internal.Diode.DiodeModelLineParams param=Diode.diodeRenameParameters(modelcarddiode,C) "Model line parameters";
   Modelica.Electrical.Spice3.Internal.SpiceConstants C "General constants of SPICE simulator";
   ...
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   final parameter Modelica.Electrical.Spice3.Internal.Model.Model m=Diode.diodeRenameParametersDevTemp(TEMP) "Renamed parameters" annotation(Evaluate=true);
   parameter Boolean OFF=false "Optional initial condition: false - IC not used, true - IC used, not implemented yet";
   parameter Modelica.SIunits.Temp_C TEMP=27 "Operating temperature of the device";
   parameter Boolean SENS_AREA(start=false) "Flag to request sensitivity WRT area, not implemented yet";
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   final parameter Modelica.Electrical.Spice3.Internal.Diode.DiodeVariables c1=Diode.diodeInitEquations(param) "Precalculated values";
   final parameter Modelica.Electrical.Spice3.Internal.Diode.DiodeCalc c2=Diode.diodeCalcTempDependencies(param,dp,m,c1) "Precalculated values";
   Real pin;
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Real icap;
   Real igmin;
   parameter Modelica.SIunits.Voltage IC(start=-1e40) "Initial condition value (VD, not implemented yet";
   Real m_dCap;
   final parameter Modelica.Electrical.Spice3.Internal.Diode.DiodeParams dp=Diode.diodeRenameParametersDev(TEMP,AREA,IC,OFF,SENS_AREA) "Renamed parameters" annotation(Evaluate=true);
   constant Boolean m_mbInit=false;
   Modelica.Electrical.Spice3.Internal.Diode.CurrentsCapacitances cc;
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

  // algorithms and equations of D_DIODE
  equation
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   (cc,m_dCap) = Modelica.Electrical.Spice3.Internal.Diode.diodeNoBypassCode(param,dp,c2,m,m_mbInit,{pin,_famefault_n.port_b.v});
   icap = (if m_mbInit then 0.0 else m_dCap*(der(pin)-der(_famefault_n.port_b.v)));
   ir*param.m_resist = _famefault_p.port_b.v-pin;
   igmin = Modelica.Electrical.Spice3.Internal.SpiceConstants.CKTgmin*(pin-_famefault_n.port_b.v);
   _famefault_p.port_b.i = ir;
   _famefault_n.port_b.i = -(cc.m_dCurrent+igmin)-icap;
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),Diagram(graphics),DymolaStoredErrors,Documentation(info="<html>
...
<p>Technology parameters of the junction diode model</p>
  ...
  // components of R_Resistor
   final parameter Modelica.Electrical.Spice3.Internal.Rsemiconductor.ResistorParams rp=Rsemiconductor.resistorRenameParametersDev(R,W,L,TEMP,SENS_AREA,C) "Renamed parameters";
   final parameter Modelica.Electrical.Spice3.Internal.Rsemiconductor.ResistorModelLineParams lp=Rsemiconductor.resistorRenameParameters(modelcard,C) "Model Line Parameters";
   Modelica.Electrical.Spice3.Internal.SpiceConstants C "General constants of SPICE simulator";
   parameter Modelica.SIunits.Length L=-1e40 "Lenght of the resistor";
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Modelica.Electrical.Spice3.Internal.ModelcardR modelcard "Resistor modelcard";
   parameter Modelica.SIunits.Temp_C TEMP=-1e40 "Temperature of resistor";
   Modelica.Electrical.Spice3.Internal.Rsemiconductor.ResistorVariables vp;
   Modelica.SIunits.Current i "Current flowing from pin p to pin n";
   parameter Boolean SENS_AREA=false "Parameter for sensitivity analyses, not implemented yet";
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Length W=-1e40 "Width of the resistor, default DEFW (modelcard)";
   parameter Modelica.SIunits.Resistance R=-1e40 "Resistance, if specified, geometrical information is overwritten";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
  ...
  algorithm
     ...
     (vp.m_dConduct,vp.m_dCond_dTemp):=Modelica.Electrical.Spice3.Internal.Functions.resDepTemp(vp.m_dResist,rp.m_dTemp,lp.m_dTnom,lp.m_dTC1,lp.m_dTC2);
     i:=vp.m_dConduct*v;
  equation
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  ...
  annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0),iconTransformation(extent={{-100,0},{-80,20}})),Placement(transformation(extent={{110,-10},{90,10}},rotation=0),iconTransformation(extent={{120,0},{100,20}})),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<p>Technology parameters of the semiconductor resistor model</p>
 ...
 annotation(preferedView="info",Window(x=0.03,y=0.04,width=0.50,height=0.36,library=1,autolayout=1),Documentation(info="<html>
...
<dl>
 ...
 package Sources
  ...
  // locally defined classes in V_constant
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of V_constant
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  ...
  // algorithms and equations of V_constant
  equation
   v = V;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  ...
  annotation(Window(x=0.33,y=0.18,width=0.6,height=0.6),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Line(points={{-90,0},{-10,0}},color={0,0,0}),Line(points={{-10,60},{-10,-60}},color={0,0,0}),Line(points={{0,30},{0,-30}},color={0,0,0}),Line(points={{0,0},{90,0}},color={0,0,0}),Text(extent={{-100,-120},{100,-80}},textString="%name=%V")}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
...
<p></p>
  ...
  // locally defined classes in V_sin
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // components of V_sin
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Damping THETA=0.0 "Damping factor";
   parameter Modelica.SIunits.Time TD=0.0 "Delay";
   parameter Modelica.SIunits.Frequency FREQ(start=1) "Frequency";
   parameter Modelica.SIunits.Voltage VA=0.0 "Amplitude";
   parameter Modelica.SIunits.Voltage VO=0.0 "Offset";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  ...
  // algorithms and equations of V_sin
  equation
   assert(FREQ>0,"Frequency less or equal zero");
   v = VO+(if time<TD then 0 else VA*Modelica.Math.exp((-(time-TD))*THETA)*Modelica.Math.sin(2*pi*FREQ*(time-TD)));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(p,_famefault_p.port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-122,53},{-22,3}},lineColor={0,0,255},textString="+"),Text(extent={{19,59},{119,9}},lineColor={0,0,255},textString="-"),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-80,4},{-75.2,36.3},{-72,54.3},{-68.7,68.5},{-65.5,78.2},{-62.3,83.3},{-59.1,83.6},{-55.9,79.3},{-52.7,71.1},{-48.6,56.2},{-43,29.8},{-35,-9.9},{-30.2,-29.7},{-26.1,-41.9},{-22.1,-49.2},{-18.1,-51.3},{-14.1,-48.5},{-10.1,-41.3},{-5.23,-28.1},{8.44,17.7},{13.3,30.4},{18.1,38.8},{22.1,42},{26.9,41.2},{31.8,35.8},{38.2,23.4},{51.1,-6.5},{57.5,-17.2},{63.1,-21.9},{68.7,-21.9},{75.2,-16.5},{80,-9.8}},color={192,192,192}),Text(extent={{-150,-56},{150,-96}},textString="%name",lineColor={0,0,255})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.<br></li>
  ...
  // locally defined classes in V_exp
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // components of V_exp
   ...
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   parameter Modelica.SIunits.Time TAU2=1 "Fall time constant";
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Modelica.SIunits.Time TAU1=1 "Rise time constant";
   parameter Modelica.SIunits.Time TD2=1 "Fall delay time";
   parameter Modelica.SIunits.Time TD1=0.0 "Rise delay time";
   Modelica.SIunits.Current i "Current flowing from pin p to pin n";
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

  // algorithms and equations of V_exp
  equation
   v = V1+(if time<TD1 then 0 else (if time<TD2 then (V2-V1)*(1-Modelica.Math.exp((-(time-TD1))/(TAU1))) else (V2-V1)*(1-Modelica.Math.exp((-(time-TD1))/(TAU1)))+(V1-V2)*(1-Modelica.Math.exp((-(time-TD2))/(TAU2)))));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(p,_famefault_p.port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-117,57},{-17,7}},lineColor={0,0,255},textString="+"),Text(extent={{22,60},{122,10}},lineColor={0,0,255},textString="-"),Text(extent={{-153,-58},{147,-98}},textString="%name",lineColor={0,0,255}),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-70,-48},{-67.2,-33.3},{-64.3,-20.1},{-60.8,-5.6},{-57.3,7},{-53.7,17.92},{-49.5,29.18},{-45.3,38.7},{-40.3,48},{-34.6,56.5},{-28.3,64.1},{-21.2,70.6},{-12.7,76.3},{-2.1,81.2},{0,82},{2.12,69.5},{4.95,54.7},{7.78,41.8},{10,31},{14.14,18.3},{17.68,8},{21.9,-2.2},{26.2,-10.6},{31.1,-18.5},{36.8,-25.4},{43.1,-31.3},{50.9,-36.5},{60.8,-40.8},{70,-43.4}},color={192,192,192})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.11,y=0.12,width=0.78,height=0.83),Documentation(info="<html>
...
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.- it should be set all the parameters definitly <br>- normally, there exist differences between Dymola and Spice, because TSTEP and TSTOP are not available. <br></li>
  ...
  // locally defined classes in V_pulse
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of V_pulse
   parameter Modelica.SIunits.Voltage V2=0 "Pulsed value";
   ...
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
  protected
   parameter Modelica.SIunits.Time Trising=TR "End time of rising phase within one period";
   parameter Modelica.SIunits.Time Tfalling=Twidth+TF "End time of falling phase within one period";
   Integer counter(start=-1) "Period counter";
   Integer counter2(start=-1);
   parameter Modelica.SIunits.Time Twidth=Trising+PW "End time of width phase within one period";
   Modelica.SIunits.Time T0(final start=TD) "Start time of current period";

  // algorithms and equations of V_pulse
  equation
   ...
   v = V1+(if ((time<TD) or (counter2==0)) or (time>=(T0+Tfalling)) then 0 else (if time<(T0+Trising) then (time-T0)*(V2-V1)/(Trising) else (if time<(T0+Twidth) then V2-V1 else (T0+Tfalling-time)*(V2-V1)/(Tfalling-Twidth))));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(n,_famefault_n.port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-120,49},{-20,-1}},lineColor={0,0,255},textString="+"),Text(extent={{25,53},{125,3}},lineColor={0,0,255},textString="-"),Text(extent={{-157,-62},{143,-102}},textString="%name",lineColor={0,0,255}),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-86,-74},{-65,-74},{-35,66},{-4,66},{25,-74},{46,-74},{75,66}},color={192,192,192})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.21,y=0.22,width=0.6,height=0.63),Documentation(info="<html>
...
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
  ...
  // locally defined classes in V_pwl
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of V_pwl
  equation
   v = tab.y;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-150,-56},{150,-96}},textString="%name",lineColor={0,0,255}),Text(extent={{-120,49},{-20,-1}},lineColor={0,0,255},textString="+"),Text(extent={{25,53},{125,3}},lineColor={0,0,255},textString="-"),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-40,-50},{-40,70},{60,70},{60,-50},{-40,-50},{-40,-20},{60,-20},{60,10},{-40,10},{-40,40},{60,40},{60,70},{10,70},{10,-51}},color={192,192,192})}),Window(x=0.25,y=0.01,width=0.72,height=0.86),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
...
If, e.g., time = 1.0, the voltage v =  0.0 (before event), 1.0 (after event)
  ...
  // locally defined classes in V_sffm
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of V_sffm
   parameter Modelica.SIunits.Frequency FS=FC "Singnal frequency";
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Voltage VA=0 "Amplitude";
   parameter Modelica.SIunits.Frequency FC(start=0) "Carrier frequency";
   parameter Modelica.SIunits.Voltage VO=0 "Offset";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  ...
  // algorithms and equations of V_sffm
  equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-150,-56},{150,-96}},textString="%name",lineColor={0,0,255}),Text(extent={{-120,49},{-20,-1}},lineColor={0,0,255},textString="+"),Text(extent={{25,53},{125,3}},lineColor={0,0,255},textString="-"),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Text(extent={{-51,57},{55,18}},lineColor={0,0,255},textString="SFFM")}),Window(x=0.25,y=0.01,width=0.72,height=0.86),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
...
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
  ...
  // locally defined classes in I_constant
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of I_constant
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Modelica.SIunits.Current I=1 "Value of constant voltage";
   Modelica.SIunits.Current i "Current flowing from pin p to pin n";
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

  // algorithms and equations of I_constant
  equation
   i = I;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  ...
  annotation(Window(x=0.33,y=0.18,width=0.6,height=0.6),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-94,-106},{106,-66}},textString="%name=%I"),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{-50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-1,-50},{-1,50}},color={0,0,255})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
<p>The I_constant source is a simple constant current source for an ideal constant current which is provided by a parameter.</p>
  ...
  // locally defined classes in I_sin
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // components of I_sin
   ...
   parameter Modelica.SIunits.Time TD=0.0 "Delay";
   parameter Modelica.SIunits.Frequency FREQ(start=1) "Frequency";
   parameter Modelica.SIunits.Current IO=0 "Offset";
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Modelica.SIunits.Current IA=0 "Amplitude";
   Modelica.SIunits.Current i "Current flowing from pin p to pin n";
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
  protected
   constant Real pi=Modelica.Constants.pi;

  // algorithms and equations of I_sin
  equation
   assert(FREQ>0,"Frequency less or equal zero");
   i = IO+(if time<TD then 0 else IA*Modelica.Math.exp((-(time-TD))*THETA)*Modelica.Math.sin(2*pi*FREQ*(time-TD)));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(p,_famefault_p.port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Polygon(points={{90,0},{60,10},{60,-10},{90,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{-50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-1,-50},{-1,50}},color={0,0,255}),Text(extent={{-144,-64},{156,-104}},textString="%name",lineColor={0,0,255}),Line(points={{-77,-12},{-72.2,20.3},{-69,38.3},{-65.7,52.5},{-62.5,62.2},{-59.3,67.3},{-56.1,67.6},{-52.9,63.3},{-49.7,55.1},{-45.6,40.2},{-40,13.8},{-32,-25.9},{-27.2,-45.7},{-23.1,-57.9},{-19.1,-65.2},{-15.1,-67.3},{-11.1,-64.5},{-7.1,-57.3},{-2.23,-44.1},{11.44,1.7},{16.3,14.4},{21.1,22.8},{25.1,26},{29.9,25.2},{34.8,19.8},{41.2,7.4},{54.1,-22.5},{60.5,-33.2},{66.1,-37.9},{71.7,-37.9},{78.2,-32.5},{83,-25.8}},color={192,192,192})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.33,y=0.06,width=0.6,height=0.75),Documentation(info="<html>
<p>Damped sinusoidal source</p>
<h4>Note:</h4>
<ul>
<li>All parameters of sources should be set explicitly.</li>
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
  ...
  // locally defined classes in I_exp
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // components of I_exp
   ...
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Modelica.SIunits.Current I1=0 "Initial value";
   parameter Modelica.SIunits.Time TAU1=1 "Rise time constant";
   parameter Modelica.SIunits.Current I2=0 "Pulsed value";
   parameter Modelica.SIunits.Time TD2=2 "Fall delay time";
   parameter Modelica.SIunits.Time TD1=0.0 "Rise delay time";
   Modelica.SIunits.Current i "Current flowing from pin p to pin n";
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

  // algorithms and equations of I_exp
  equation
   i = I1+(if time<TD1 then 0 else (if time<TD2 then (I2-I1)*(1-Modelica.Math.exp((-(time-TD1))/(TAU1))) else (I2-I1)*(1-Modelica.Math.exp((-(time-TD1))/(TAU1)))+(I1-I2)*(1-Modelica.Math.exp((-(time-TD2))/(TAU2)))));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(p,_famefault_p.port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Polygon(points={{90,0},{60,10},{60,-10},{90,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Ellipse(extent={{-50,50},{50,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-89,0},{-49,0}},color={0,0,255}),Line(points={{51,0},{91,0}},color={0,0,255}),Line(points={{0,-50},{0,50}},color={0,0,255}),Text(extent={{-145,-60},{155,-100}},textString="%name",lineColor={0,0,255}),Line(points={{-79,-53},{-76.2,-38.3},{-73.3,-25.1},{-69.8,-10.6},{-66.3,2},{-62.7,12.92},{-58.5,24.18},{-54.3,33.7},{-49.3,43},{-43.6,51.5},{-37.3,59.1},{-30.2,65.6},{-21.7,71.3},{-11.1,76.2},{-9,77},{-6.88,64.5},{-4.05,49.7},{-1.22,36.8},{1.606,25.45},{5.14,13.3},{8.68,3},{12.9,-7.2},{17.2,-15.6},{22.1,-23.5},{27.8,-30.4},{34.1,-36.3},{41.9,-41.5},{51.8,-45.8},{61,-48.4}},color={192,192,192})}),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.11,y=0.12,width=0.78,height=0.83),Documentation(info="<html>
<p>Rising and falling exponential source.</p>
<h4>Note:</h4>
<ul>
<li>All parameters of sources should be set explicitly.</li>
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
  ...
  // locally defined classes in I_pulse
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of I_pulse
   parameter Modelica.SIunits.Time TF=TR "Fall time";
   parameter Modelica.SIunits.Time TD=0.0 "Delay time";
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  ...
  // algorithms and equations of I_pulse
  equation
   when (pre(counter2)<>0) and sample(TD,PER) then
    T0 = time;
    counter2 = pre(counter);
   ...
   i = I1+(if ((time<TD) or (counter2==0)) or (time>=(T0+Tfalling)) then 0 else (if time<(T0+Trising) then (time-T0)*(I2-I1)/(Trising) else (if time<(T0+Twidth) then I2-I1 else (T0+Tfalling-time)*(I2-I1)/(Tfalling-Twidth))));
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
   i = _famefault_p.port_b.i;
   connect(n,_famefault_n.port_a);
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics={Polygon(points={{90,0},{60,10},{60,-10},{90,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{-50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-1,-50},{-1,50}},color={0,0,255}),Text(extent={{-150,-58},{150,-98}},textString="%name",lineColor={0,0,255}),Line(points={{-85,-60},{-64,-60},{-34,80},{-3,80},{26,-60},{47,-60},{76,80}},color={192,192,192})}),Documentation(info="<html>
<p>Periodic pulse source with not limited number of periods.</p>
<p>A single pulse is described by the following table:</p>
<table cellspacing=\"2\" cellpadding=\"0\" border=\"0\"><tr>
<td><h4>time</h4></td>
...
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
  ...
  // locally defined classes in I_pwl
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of I_pwl
  equation
   i = tab.y;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
   0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{-50,0}},color={0,0,255}),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-1,-50},{-1,50}},color={0,0,255}),Text(extent={{-148,-57},{152,-97}},textString="%name",lineColor={0,0,255}),Line(points={{-44,-39},{-44,81},{56,81},{56,-39},{-44,-39},{-44,-9},{56,-9},{56,21},{-44,21},{-44,51},{56,51},{56,81},{6,81},{6,-40}},color={192,192,192}),Polygon(points={{90,0},{60,10},{60,-10},{90,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid)}),Window(x=0.25,y=0.01,width=0.72,height=0.86),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
...
If, e.g., time = 1.0, the current i =  0.0 (before event), 1.0 (after event)
  ...
  // locally defined classes in I_sffm
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of I_sffm
   parameter Modelica.SIunits.Frequency FS=FC "Singnal frequency";
   Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
   parameter Modelica.SIunits.Current IO=0 "Offset";
   parameter Modelica.SIunits.Frequency FC(start=0) "Carrier frequency";
  ...
  // algorithms and equations of I_sffm
  equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics={Text(extent={{-150,-56},{150,-96}},textString="%name",lineColor={0,0,255}),Ellipse(extent={{-51,50},{49,-50}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{50,0},{90,0}},color={0,0,255}),Line(points={{-92,0},{-52,0}},color={0,0,255}),Line(points={{0,-50},{0,50}},color={0,0,255}),Polygon(points={{90,0},{60,10},{60,-10},{90,0}},lineColor={0,0,255},fillColor={0,0,255},fillPattern=FillPattern.Solid),Text(extent={{-58,53},{48,14}},lineColor={0,0,255},textString="SFFM")}),Window(x=0.25,y=0.01,width=0.72,height=0.86),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Documentation(info="<html>
<p>The single-frequency frequency modulation source generates a carrier signal of the frequency FC. This signal is modulated by the signal frequency FS. See the formula in the modelica text.</p>
<h4>Note:</h4>
<ul>
<li>All parameters of sources should be set explicitly.</li>
<li>since TSTEP and TSTOP are not available for modeling in Modelica, differences to SPICE may occur if not all parameters are set.</li>
 ...
 annotation(preferedView="info",Window(x=0.03,y=0.04,width=0.50,height=0.60,library=1,autolayout=1),Documentation(info="<html>
...
<li><i>October 2008 </i>by Christoph Clauss initially implemented.</li>
 ...
 package Additionals
  ...
  // algorithms and equations of poly
  algorithm
     n:=size(s,1);
     na:=size(a,1);
...
<li>F_CCC_POLY</li>
  ...
  // locally defined classes in E_VCV_POLY
      model _famefaults_pc = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
      model _famefaults_n__pc = FAME.Bridges.Electrical;
      model _famefaults_p__pc = FAME.Bridges.Electrical;

  // components of E_VCV_POLY
   Real control[N];
   Modelica.Electrical.Analog.Interfaces.PositivePin pc[2*N] "Pin vector of controlling pins (normally left)" annotation(Placement(transformation(extent={{-90,-80},{-70,80}},rotation=0),iconTransformation(extent={{-90,-80},{-70,80}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_pc[2*N](each amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin of the controlled (normally right) port (potential p2.v > n2.v for positive voltage drop v2)" annotation(Placement(transformation(extent={{110,40},{90,60}},rotation=0),iconTransformation(extent={{110,40},{90,60}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin of the controlled (normally right) port" annotation(Placement(transformation(extent={{90,-60},{110,-40}},rotation=0),iconTransformation(extent={{90,-60},{110,-40}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Integer N(final min=1)=1 "Number of controlling voltages";
   parameter Real coeff[:]={1} "Coefficients of polynomial";
   FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
   FAME.Bridges.Electrical _famefault_n__pc[2*N](each amount=0.0);
   FAME.Bridges.Electrical _famefault_p__pc[2*N](each amount=0.0);

  // algorithms and equations of E_VCV_POLY
  equation
   _famefault_p.port_b.i+_famefault_n.port_b.i = 0;
   for i in 1:2*N loop
    _famefault_pc[i].port_b.i = 0;
   end for;
   for i in 1:N loop
    control[i] = _famefault_pc[2*i-1].port_b.v-_famefault_pc[2*i].port_b.v;
   end for;
   _famefault_p.port_b.v-_famefault_n.port_b.v = poly(control,coeff);
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_pc[_fame_lhs_0].port_a);
   end for;
   connect(p,_famefault_p.port_a);
   connect(n,_famefault_n.port_a);
   connect(n,_famefault_n__p.port_a);
   connect(p,_famefault_n__p.port_b);
   for _fame_rhs_0 in 1:2*N loop
    connect(n,_famefault_n__pc[_fame_rhs_0].port_a);
   end for;
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_n__pc[_fame_lhs_0].port_b);
   end for;
   for _fame_rhs_0 in 1:2*N loop
    connect(p,_famefault_p__pc[_fame_rhs_0].port_a);
   end for;
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_p__pc[_fame_lhs_0].port_b);
   end for;

  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Rectangle(extent={{-70,70},{70,-70}},fillColor={255,255,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-100,-62},{99,-112}},textString="%name",lineColor={0,0,255}),Line(points={{100,50},{30,50},{30,-50},{100,-50}},color={0,0,255}),Ellipse(extent={{10,20},{50,-20}},lineColor={0,0,255}),Line(points={{-20,50},{20,50}},color={0,0,255}),Polygon(points={{20,50},{10,53},{10,47},{20,50}},fillColor={0,0,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-54,-26},{22,-60}},lineColor={0,0,255},textString="VCV")}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<li><i>Sept 2008 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // locally defined classes in G_VCC_POLY
      model _famefaults_pc = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p__pc = FAME.Bridges.Electrical;
  ...
  // components of G_VCC_POLY
   Real control[N];
   Modelica.Electrical.Analog.Interfaces.PositivePin pc[2*N] "Pin vector of controlling pins" annotation(Placement(transformation(extent={{-90,-80},{-70,80}},rotation=0),iconTransformation(extent={{-90,-80},{-70,80}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_pc[2*N](each amount=0.0);
   Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin of the right port (potential p2.v > n2.v for positive voltage drop v2)" annotation(Placement(transformation(extent={{110,40},{90,60}},rotation=0),iconTransformation(extent={{110,40},{90,60}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin of the right port" annotation(Placement(transformation(extent={{90,-60},{110,-40}},rotation=0),iconTransformation(extent={{90,-60},{110,-40}})));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
   parameter Integer N(final min=1)=1 "Number of controlling voltages";
   parameter Real coeff[:]={1} "Coefficients of polynomial";
   FAME.Bridges.Electrical _famefault_p__pc[2*N](each amount=0.0);
  ...
  // algorithms and equations of G_VCC_POLY
  equation
   _famefault_p.port_b.i+_famefault_n.port_b.i = 0;
   for i in 1:2*N loop
    _famefault_pc[i].port_b.i = 0;
   ...
   _famefault_p.port_b.i = poly(control,coeff);
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_pc[_fame_lhs_0].port_a);
   end for;
   connect(p,_famefault_p.port_a);
   ...
   connect(n,_famefault_n__p.port_b);
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_n__pc[_fame_lhs_0].port_a);
   end for;
   for _fame_rhs_0 in 1:2*N loop
    connect(n,_famefault_n__pc[_fame_rhs_0].port_b);
   end for;

  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Rectangle(extent={{-70,70},{70,-70}},fillColor={255,255,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-100,-62},{99,-112}},textString="%name",lineColor={0,0,255}),Line(points={{100,50},{30,50},{30,-50},{100,-50}},color={0,0,255}),Ellipse(extent={{10,20},{50,-20}},lineColor={0,0,255}),Line(points={{-20,50},{20,50}},color={0,0,255}),Polygon(points={{20,50},{10,53},{10,47},{20,50}},fillColor={0,0,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-60,-24},{16,-58}},lineColor={0,0,255},textString="VCC")}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
<p>The polynomial source is a SPICE2 model, which is also known in other SPICE derivates.</p>
...
<li><i>Sept 2008 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // locally defined classes in H_CCV_POLY
      model _famefaults_pc = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p__pc = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of H_CCV_POLY
  equation
   _famefault_p.port_b.i+_famefault_n.port_b.i = 0;
   for i in 1:N loop
    _famefault_pc[2*i-1].port_b.i+_famefault_pc[2*i].port_b.i = 0;
    _famefault_pc[2*i-1].port_b.v-_famefault_pc[2*i].port_b.v = 0;
   end for;
   for i in 1:N loop
    control[i] = _famefault_pc[2*i-1].port_b.i;
   end for;
   _famefault_p.port_b.v-_famefault_n.port_b.v = poly(control,coeff);
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_pc[_fame_lhs_0].port_a);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Rectangle(extent={{-70,70},{70,-70}},fillColor={255,255,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-100,-62},{99,-112}},textString="%name",lineColor={0,0,255}),Line(points={{100,50},{30,50},{30,-50},{100,-50}},color={0,0,255}),Ellipse(extent={{10,20},{50,-20}},lineColor={0,0,255}),Line(points={{-20,50},{20,50}},color={0,0,255}),Polygon(points={{20,50},{10,53},{10,47},{20,50}},fillColor={0,0,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-60,-26},{16,-60}},lineColor={0,0,255},textString="CCV")}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
<p>The polynomial source is a SPICE2 model, which is also known in other SPICE derivates.</p>
...
<li><i>Sept 2008 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // locally defined classes in F_CCC_POLY
      model _famefaults_pc = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p__pc = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of F_CCC_POLY
  equation
   _famefault_p.port_b.i+_famefault_n.port_b.i = 0;
   for i in 1:N loop
    _famefault_pc[2*i-1].port_b.i+_famefault_pc[2*i].port_b.i = 0;
   ...
   connect(n,_famefault_n.port_a);
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_p__pc[_fame_lhs_0].port_a);
   end for;
   for _fame_rhs_0 in 1:2*N loop
    connect(p,_famefault_p__pc[_fame_rhs_0].port_b);
   end for;
   for _fame_lhs_0 in 1:2*N loop
    connect(pc[_fame_lhs_0],_famefault_n__pc[_fame_lhs_0].port_a);
   end for;
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Rectangle(extent={{-70,70},{70,-70}},fillColor={255,255,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-100,-62},{99,-112}},textString="%name",lineColor={0,0,255}),Line(points={{100,50},{30,50},{30,-50},{100,-50}},color={0,0,255}),Ellipse(extent={{10,20},{50,-20}},lineColor={0,0,255}),Line(points={{-20,50},{20,50}},color={0,0,255}),Polygon(points={{20,50},{10,53},{10,47},{20,50}},fillColor={0,0,255},fillPattern=FillPattern.Solid,lineColor={0,0,255}),Text(extent={{-60,-24},{16,-58}},lineColor={0,0,255},textString="CCC")}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
<p>The polynomial source is a SPICE2 model, which is also known in other SPICE derivates.</p>
...
<p>This package contains additional useful models which do not belong to the original SPICE3 model set.</p>
 ...
 package Interfaces
  ...
  // components of TwoPortControlledSources
  ...
  // algorithms and equations of TwoPortControlledSources
  equation
   v1 = p1.v-n1.v;
   v2 = p2.v-n2.v;
   0 = p1.i+n1.i;
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}},grid={1,1}),graphics),Window(x=0.16,y=0.12,width=0.6,height=0.6),Documentation(info="<html>
<p>TwoPort is a partial model that consists of two ports. It is assumed that the current flowing into the positive pin is identical to the current flowing out of pin n. This currents of each port are provided explicitly as currents i1 and i2, the voltages respectively as v1 and v2.</p>
 ...
 annotation(preferedView="info",Window(x=0.03,y=0.04,width=0.21,height=0.49,library=1,autolayout=1),Documentation(info="<html>
<p>The SPICE3 package uses the Modelica.Electrical.Analog interfaces. Only special partial models used in the SPICE3 package are located in this Interfaces package.</p>
 ...
 package Internal
  ...
  // locally defined classes in MOS
      model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_S = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // components of MOS
   ...
   parameter Modelica.SIunits.Area AS=0 "Area of the source diffusion";
   Modelica.SIunits.Voltage vDS "Drain - source voltage";
   parameter Integer mtype(start=0) "MOSFET type: 0 - N channel, 1 - P channel";
   parameter Integer OFF=0 "Optional initial condition: 0 - IC not used, 1 - IC used, not implemented yet";
   final parameter Modelica.Electrical.Spice3.Internal.Mosfet.Mosfet m=Mos1.mos1RenameParametersDev(modelcard,mtype,W,L,AS,AS,PD,PS,NRD,NRS,OFF,IC,TEMP) "Renamed parameters" annotation(Evaluate=true);
   final parameter Integer m_type=(if m.m_bPMOS>0.5 then -1 else 1) "Type of the transistor";
   parameter Modelica.SIunits.Area AD=0 "Area of the drain diffusion";
  ...
  // algorithms and equations of MOS
  equation
   assert(NRD<>0,"NRD, length of drain in squares, must not be zero");
   assert(NRS<>0,"NRS, length of source in squares, must not be zero");
   vDS = _famefault_D.port_b.v-_famefault_S.port_b.v;
   vGS = _famefault_G.port_b.v-_famefault_S.port_b.v;
   cc = Mos.mosCalcNoBypassCode(m,m_type,c2,p,C,vp,m_bInit,{_famefault_G.port_b.v,_famefault_B.port_b.v,Dinternal,Sinternal});
   ird*c1.m_drainResistance = _famefault_D.port_b.v-Dinternal;
   irs*p.m_sourceResistance = _famefault_S.port_b.v-Sinternal;
   icBD = cc.cBD*(der(_famefault_B.port_b.v)-der(Dinternal));
   icBS = cc.cBS*(der(_famefault_B.port_b.v)-der(Sinternal));
   ...
   icGD = cc.cGD*(der(_famefault_G.port_b.v)-der(Dinternal));
   icGS = cc.cGS*(der(_famefault_G.port_b.v)-der(Sinternal));
   ibsgmin = SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Sinternal);
   ibdgmin = SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Dinternal);
   _famefault_G.port_b.i = icGB+icGD+icGS;
   _famefault_B.port_b.i = cc.iBD+cc.iBS+ibdgmin+ibsgmin-icGB+icBD+icBS;
   _famefault_D.port_b.i = ird;
   _famefault_S.port_b.i = irs;
...
</html>"),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Line(points={{0,92},{0,40},{-12,40},{-12,-40},{0,-40},{0,-94}},color={0,0,255}),Line(points={{-92,0},{-20,0}},color={0,0,255}),Line(points={{-12,0},{94,0}},color={0,0,255}),Line(points={{-20,40},{-20,-40}},color={0,0,255}),Text(extent={{8,-34},{92,-86}},lineColor={0,0,255},textString="%name")}),DymolaStoredErrors);
  end MOS;

  record ModelcardMOS
   "Record with technological parameters (.model)"

  // components of ModelcardMOS
   parameter SI.Voltage VTO=-1e40 "Zero-bias threshold voltage, default 0";
   parameter SI.Transconductance KP=-1e40 "Transconductance parameter, default 2e-5";
   ...
   parameter SI.Capacitance CBD=-1e40 "Zero-bias B-D junction capacitance, default 0";
   parameter SI.Capacitance CBS=-1e40 "Zero-bias B-S junction capacitance, default 0";
   ...
   parameter SI.Temp_C TNOM=-1e40 "Parameter measurement temperature, default 27";
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  // locally defined classes in MOS2
      model _famefaults_D = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_G = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_S = FAME.Dampers.ElectricalWithoutConnectEquations;
  ...
  // components of MOS2
   ...
   Modelica.Electrical.Analog.Interfaces.PositivePin B "bulk node" annotation(Placement(transformation(extent={{90,-10},{110,10}},rotation=0)));
   FAME.Dampers.ElectricalWithoutConnectEquations _famefault_B(amount=0.0);
   constant Modelica.Electrical.Spice3.Internal.SpiceConstants C "General constants of SPICE simulator";
   parameter Modelica.SIunits.Length L=1e-4 "Length";
   Real icGD;
   parameter Modelica.Electrical.Spice3.Internal.ModelcardMOS2 modelcard "MOSFET modelcard" annotation(Evaluate=true);
   Real icGB;
   parameter Real TEMP=27 "Operating temperature of the device";
   final parameter Modelica.Electrical.Spice3.Internal.Mos2.Mos2ModelLineVariables vp=Mos2.mos2ModelLineParamsInitEquations(p,C,m_type) "Model line variables";
   Real icBS;
   Real icqmGD;
   parameter Modelica.SIunits.Length W=1e-4 "Width";
   Real icqmGB;
   ...
   parameter Integer mtype(start=0) "MOSFET type: 0 - N channel, 1 - P channel";
   parameter Integer OFF=0 "Optional initial condition: 0 - IC not used, 1 - IC used, not implemented yet";
   final parameter Modelica.Electrical.Spice3.Internal.Mosfet.Mosfet m=Mos2.mos2RenameParametersDev(modelcard,mtype,W,L,AD,AS,PD,PS,NRD,NRS,OFF,IC,TEMP) "Renamed parameters" annotation(Evaluate=true);
   final parameter Integer m_type=(if m.m_bPMOS>0.5 then -1 else 1) "Type of the transistor";
   parameter Modelica.SIunits.Area AD=0 "Area of the drain diffusion";
   parameter Real NRS=1 "Number of squares of the source diffusions";
   final parameter Modelica.Electrical.Spice3.Internal.Mos2.Mos2Calc c1=Mos.mos2CalcInitEquations(p,C,vp,m) "Precalculated parameters";
   final parameter Modelica.Electrical.Spice3.Internal.Mos2.Mos2Calc c2=Mos.mos2CalcCalcTempDependencies(p,C,vp,m,c1,m_type) "Precalculated parameters";
   Real icGS;
   Real ird;
   parameter Modelica.SIunits.Length PS=0 "Perimeter of the source junction";
   final parameter Modelica.Electrical.Spice3.Internal.Mos2.Mos2ModelLineParams p=Mos2.mos2RenameParameters(modelcard,C) "Model line parameters" annotation(Evaluate=true);
   parameter Modelica.SIunits.Length PD=0 "Perimeter of the drain junction";
   Real icBD;
   parameter Real NRD=1 "Number of squares of the drain diffusions";
   Modelica.Electrical.Spice3.Internal.Mos.CurrrentsCapacitances cc;
  ...
  // algorithms and equations of MOS2
  equation
   assert(NRD<>0,"NRD, length of drain in squares, must not be zero");
   assert(NRS<>0,"NRS, length of source in squares, must not be zero");
   vDS = _famefault_D.port_b.v-_famefault_S.port_b.v;
   vGS = _famefault_G.port_b.v-_famefault_S.port_b.v;
   (cc,qm) = Mos.mos2CalcNoBypassCode(m,m_type,c2,p,C,vp,m_bInit,{_famefault_G.port_b.v,_famefault_B.port_b.v,Dinternal,Sinternal});
   ird*c1.m_drainResistance = _famefault_D.port_b.v-Dinternal;
   irs*p.m_sourceResistance = _famefault_S.port_b.v-Sinternal;
   icBD = cc.cBD*(der(_famefault_B.port_b.v)-der(Dinternal));
   icBS = cc.cBS*(der(_famefault_B.port_b.v)-der(Sinternal));
   ...
   icGD = cc.cGD*(der(_famefault_G.port_b.v)-der(Dinternal));
   icGS = cc.cGS*(der(_famefault_G.port_b.v)-der(Sinternal));
   icqmGB = qm.qm_capgb*(der(_famefault_G.port_b.v)-der(_famefault_B.port_b.v));
   icqmGS = qm.qm_capgs*(der(_famefault_G.port_b.v)-der(Sinternal));
   icqmGD = qm.qm_capgd*(der(_famefault_G.port_b.v)-der(Dinternal));
   ibsgmin = SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Sinternal);
   ibdgmin = SpiceConstants.CKTgmin*(_famefault_B.port_b.v-Dinternal);
   _famefault_G.port_b.i = icGB+icGD+icGS+icqmGB+icqmGD+icqmGS;
   _famefault_B.port_b.i = cc.iBD+cc.iBS+ibdgmin+ibsgmin-icGB+icBD+icBS-icqmGB;
   _famefault_D.port_b.i = ird;
   _famefault_S.port_b.i = irs;
   ...
   connect(G,_famefault_B__G.port_a);
   connect(B,_famefault_B__G.port_b);
   connect(G,_famefault_D__G.port_a);
   connect(D,_famefault_D__G.port_b);
   connect(B,_famefault_B__D.port_a);
   connect(D,_famefault_B__D.port_b);
...
</html>"),Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics),Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),graphics={Line(points={{0,92},{0,40},{-12,40},{-12,-40},{0,-40},{0,-94}},color={0,0,255}),Line(points={{-92,0},{-20,0}},color={0,0,255}),Line(points={{-12,0},{94,0}},color={0,0,255}),Line(points={{-20,40},{-20,-40}},color={0,0,255}),Text(extent={{8,-34},{92,-86}},lineColor={0,0,255},textString="%name")}),DymolaStoredErrors);
  end MOS2;

  record ModelcardMOS2
   "Record with technological parameters (.model)"
   extends ModelcardMOS(MJSW=0.33);

  // components of ModelcardMOS2
   parameter Real NFS=0.0 "Fast surface state density";
   parameter Real XJ=0.0 "Metallurgiecal junction depth";
   parameter Real UCRIT=1.e4 "Critical field for mobility degradation (MOS2 only)";
   parameter Real UEXP=0.0 "Critical field exponent in mobility degradation (MOS2 only)";
   parameter Real VMAX=0.0 "Maximum drift velocity of carries";
   parameter Real NEFF=1.0 "Total channel charge (fixed and mobile) coefficient (MOS2 only)";
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  // locally defined classes in BJT
      model _famefaults_E = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_C = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_B__E = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of BJT
  equation
   vBE = _famefault_B.port_b.v-_famefault_E.port_b.v;
   vCE = _famefault_C.port_b.v-_famefault_E.port_b.v;
   vBC = _famefault_B.port_b.v-_famefault_C.port_b.v;
   (cc,capbe,capbc,capbx) = Bjt3.bjtNoBypassCode(m,p1,p,c,v,vl,{_famefault_C.port_b.v,_famefault_B.port_b.v,_famefault_E.port_b.v,Cinternal,Binternal,Einternal},m_bInit);
   icapbe = (if m_bInit then 0.0 else capbe*(der(Binternal)-der(Einternal)));
   icapbc = (if m_bInit then 0.0 else capbc*(der(Binternal)-der(Cinternal)));
   icapbx = (if m_bInit then 0.0 else capbx*(der(_famefault_B.port_b.v)-der(Cinternal)));
   irc*p.m_collectorResist = _famefault_C.port_b.v-Cinternal;
   ...
   connect(B,_famefault_B.port_a);
   connect(C,_famefault_C.port_a);
   connect(B,_famefault_B__E.port_a);
   connect(E,_famefault_B__E.port_b);
   connect(B,_famefault_B__C.port_a);
   connect(C,_famefault_B__C.port_b);
   connect(E,_famefault_C__E.port_a);
   connect(C,_famefault_C__E.port_b);

  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Line(points={{-20,60},{-20,-60}},color={0,0,255},smooth=Smooth.None),Line(points={{-20,0},{-86,0}},color={0,0,255},smooth=Smooth.None),Line(points={{34,94},{-20,40}},color={0,0,255},smooth=Smooth.None),Line(points={{-20,-40},{32,-92}},color={0,0,255},smooth=Smooth.None),Text(extent={{-94,56},{206,16}},textString="%name",lineColor={0,0,255})}),Diagram(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics),Documentation(info="<html>
...
<li><i>August 2009 </i>by Kristin Majetta <br/>initially implemented</li>
  ...
  // components of ModelcardBJT
   ...
   parameter SI.Current ISE=-1e40 "B-E leakage saturation current, default = 0";
   constant Real C2=-1e40 "Obsolete parameter name, default = 0";
   parameter SI.Current ISC=-1e40 "B-C leakage saturation current, default = 0";
   ...
   parameter SI.GapEnergy EG=1.11 "Energy gap for IS temperature effect on IS ";
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  // locally defined classes in DIODE
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;
  ...
  // algorithms and equations of DIODE
  equation
   (cc,m_dCap) = Diode.diodeNoBypassCode(param,dp,c2,m,m_mbInit,{pin,_famefault_n.port_b.v});
   icap = (if m_mbInit then 0.0 else m_dCap*(der(pin)-der(_famefault_n.port_b.v)));
   ir*param.m_resist = _famefault_p.port_b.v-pin;
   igmin = SpiceConstants.CKTgmin*(pin-_famefault_n.port_b.v);
   _famefault_p.port_b.i = ir;
   _famefault_n.port_b.i = -(cc.m_dCurrent+igmin)-icap;
   0 = -ir+cc.m_dCurrent+igmin+icap;
   v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  ...
  annotation(Icon(graphics={Line(points={{90,0},{-90,0}},color={0,0,255}),Polygon(points={{30,0},{-30,40},{-30,-40},{30,0}},lineColor={0,0,0},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-90,0},{40,0}},color={0,0,255}),Line(points={{40,0},{90,0}},color={0,0,255}),Line(points={{30,40},{30,-40}},color={0,0,255}),Text(extent={{-154,100},{146,60}},textString="%name",lineColor={0,0,255})}),Diagram(graphics),DymolaStoredErrors,Documentation(info="<html>
<p>DIODE model</p>
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
</html>",revisions="<html>
<ul>
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  // locally defined classes in R_SEMI
      model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
      model _famefaults_n__p = FAME.Bridges.Electrical;

  // components of R_SEMI
   final parameter Modelica.Electrical.Spice3.Internal.Rsemiconductor.ResistorParams rp=Rsemiconductor.resistorRenameParametersDev(R,W,L,TEMP,SENS_AREA,C) "Renamed parameters";
   Modelica.Electrical.Spice3.Internal.SpiceConstants C "General constants of SPICE simulator";
   final parameter Modelica.Electrical.Spice3.Internal.Rsemiconductor.ResistorModelLineParams lp=Rsemiconductor.resistorRenameParameters(modelcard,C) "Model Line Parameters";
   Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  ...
  // algorithms and equations of R_SEMI
  algorithm
     vp:=Rsemiconductor.resistorInitEquations(rp,lp);
     (vp.m_dConduct,vp.m_dCond_dTemp):=Modelica.Electrical.Spice3.Internal.Functions.resDepTemp(vp.m_dResist,rp.m_dTemp,lp.m_dTnom,lp.m_dTC1,lp.m_dTC2);
     i:=vp.m_dConduct*v;
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Rectangle(extent={{-70,28},{70,-32}},lineColor={0,0,255},fillColor={255,255,255},fillPattern=FillPattern.Solid),Line(points={{-70,0},{-90,0}},color={0,0,255},smooth=Smooth.None),Line(points={{70,0},{90,0}},color={0,0,255},smooth=Smooth.None),Text(extent={{-150,64},{150,24}},textString="%name",lineColor={0,0,255})}),Documentation(revisions="<html>
<ul>
<li><i>  </i>
       </li>
<li><i> April 2009 </i>
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  // components of ModelcardR
   parameter SI.Conversions.NonSIunits.FirstOrderTemperaturCoefficient TC1=0.0 "First order temperature coefficient";
   parameter SI.Conversions.NonSIunits.SecondOrderTemperaturCoefficient TC2=0.0 "In Ohm/(deg C*deg C), Second2 order temperature coefficient";
...
<p>The package Repository is not for user access. There all function, records and data are stored, that are needed for the semiconductor models of the package Semiconductors.</p>
  ...
  package Functions
   ...
   // components of energyGapDepTemp
   ...
   // algorithms and equations of energyGapDepTemp
   algorithm
...
<p>This internal function calculates the temperature dependent energy gap based on the actual temperature, and two coefficients given as input to the function.</p>
   ...
   // components of junctionPotDepTemp
   ...
   // algorithms and equations of junctionPotDepTemp
   algorithm
...
<p>This internal function calculates the temperature dependent junction potential based on the actual and the nominal temperature.</p>
   ...
   // components of saturationCurDepTempSPICE3MOSFET
   ...
   // algorithms and equations of saturationCurDepTempSPICE3MOSFET
   algorithm
      vt:=SpiceConstants.CONSTKoverQ*temp;
...
<p>This internal function calculates the temperature dependent saturation current based on the actual and the nominal temperature.</p>
   ...
   // algorithms and equations of junctionVCrit
   algorithm
...
<p>This internal function limits the junction voltage. If it increases 1.e10, it is hold to be constant at that value.</p>
   ...
   // components of junctionParamDepTempSPICE3
    input Real phi0;
    input Real cap0;
    input Real mcoeff;
    input Modelica.SIunits.Temp_K temp "Device temperature";
   ...
   // algorithms and equations of junctionParamDepTempSPICE3
   algorithm
      phibtemp:=energyGapDepTemp(temp);
      phibtnom:=energyGapDepTemp(tnom);
      vt:=SpiceConstants.CONSTKoverQ*temp;
      vtnom:=SpiceConstants.CONSTKoverQ*tnom;
      arg:=(-phibtemp)/(2*Modelica.Constants.k*temp)+1.1150877/(Modelica.Constants.k*2*SpiceConstants.REFTEMP);
      fact2:=temp/(SpiceConstants.REFTEMP);
      pbfact:=(-2)*vt*(1.5*Modelica.Math.log(fact2)+SpiceConstants.CHARGE*arg);
      arg1:=(-phibtnom)/(Modelica.Constants.k*2*tnom)+1.1150877/(2*Modelica.Constants.k*SpiceConstants.REFTEMP);
...
<p>This internal function calculates several temperature dependent junction parameters based on the actual and the nominal temperature.</p>
   ...
   // components of junctionCapCoeffs
    input Real mj;
    input Real fc;
    input Real phij;
    output Real f1;
   ...
   // algorithms and equations of junctionCapCoeffs
   algorithm
...
<p>This internal auxiliary function calculates some coefficients which are necessary for the calculation of junction capacities.</p>
   ...
   // components of junction2SPICE3MOSFET
   ...
   // algorithms and equations of junction2SPICE3MOSFET
   algorithm
      out_current:=current;
      out_cond:=cond;
...
<p>This internal function calculates both the junction current and the junction conductance dependent from the given voltage.</p>
   ...
   // algorithms and equations of junctionCap
   algorithm
...
<p>This internal function calculates the charge and the capacitance of the junction capacity dependent from the given voltage.</p>
   ...
   // components of saturationCurDepTempSPICE3
   ...
   // algorithms and equations of saturationCurDepTempSPICE3
   algorithm
      vt:=SpiceConstants.CONSTKoverQ*temp;
      vte:=emissioncoeff*vt;
      ret:=satcur0*exp((temp/(tnom)-1)*energygap/(vte)+satcurexp/(emissioncoeff)*Modelica.Math.log(temp/(tnom)));
...
<p>This internal function calculates the temperature dependent saturation current based on the actual and the nominal temperature.</p>
   ...
   // components of junctionVoltage23SPICE3
   ...
   // algorithms and equations of junctionVoltage23SPICE3
   algorithm
      vt:=SpiceConstants.CONSTKoverQ*temp;
      v23:=vb;
      cbv:=ivb;
...
<p>This internal function calculates the junction voltage based on the actual temperature, voltage and saturation current.</p>
   ...
   // algorithms and equations of junction3
   algorithm
...
<p>This internal function calculates both the junction current and the junction conductance dependent from the given voltage.</p>
   ...
   // components of junctionCapTransTime
    input Modelica.SIunits.Capacitance capin "Input capacitance";
    input Modelica.SIunits.Voltage voltage "Input voltage";
    input Modelica.SIunits.Voltage depcap;
    input Real mj;
   ...
   // algorithms and equations of junctionCapTransTime
   algorithm
...
<p>This internal function calculates the capacitance and the charge dependent on the transittime.</p>
   ...
   // algorithms and equations of junction2
   algorithm
      if satcur>1.0e-101 then
        vte:=SpiceConstants.CONSTKoverQ*temp*ncoeff;
        max_exponent:=Modelica.Math.log(max_current/(satcur));
...
<p>This internal function calculates both the junction current and the junction conductance dependent from the given voltage.</p>
   ...
   // algorithms and equations of resDepTemp
   algorithm
...
<p>This internal function calculates the conductance in dependency from the temperature.</p>
   ...
   // algorithms and equations of resDepGeom
   algorithm
...
<p>The package Equation contains functions that are needed to model the semiconductor models. Some of these functions are used by several semiconductor models.</p>
  ...
  package SpiceRoot
   ...
   // components of SpiceRoot
    Modelica.SIunits.Current m_pCurrentValues[6](start=zeros(6));
    Real m_pResJacobi[36](start=zeros(36));
    Real m_pCapJacobi[36](start=zeros(36));
...
<p>This data are to collect intermediate results to be inserted into SPICE-like matrices for linear ssystems of equations.</p>
   ...
   // components of useInitialConditions
    output Boolean ret;

   // algorithms and equations of useInitialConditions
   algorithm
      ret:=false;
...
<p>This function useInitialConditions appoints wether the initial conditions that are given in the description are used or not.</p>
   ...
   // components of initJunctionVoltages
    output Boolean ret;

   // algorithms and equations of initJunctionVoltages
   algorithm
      ret:=false;
...
<p>This internal function is provided to choose the junction voltage handling which is at the current library version fixed to false.</p>
   ...
   // components of limitJunctionVoltage
    input Modelica.SIunits.Voltage voltage "Input voltage";
    output Modelica.SIunits.Voltage ret;

   // algorithms and equations of limitJunctionVoltage
   algorithm
      ret:=voltage;
...
<p>The package Model contains the record Model that includes the device temperature.</p>
  ...
  package Mosfet
   ...
   // components of Mosfet
    Modelica.SIunits.Length m_len(start=1e-4) "L, length of channel region";
    Modelica.SIunits.Length m_width(start=1e-4) "W, width of channel region";
    Modelica.SIunits.Area m_drainArea(start=SpiceConstants.CKTdefaultMosAD) "AD, area of drain diffusion";
    Modelica.SIunits.Area m_sourceArea(start=SpiceConstants.CKTdefaultMosAS) "AS, area of source diffusion";
...
<p>This record Mosfet contains parameters that are used for all types of Mosfet transistors in SPICE3.</p>
   ...
   // components of MosfetModelLineParams
...
<p>This record MosfetModelLineParams contains the model line parameters that are used for all kinds of mosfet transistors in SPICE3.</p>
   ...
   record MosfetModelLine
    "Type of the transistor"

   // components of MosfetModelLine
...
<p>This record MosfetCalc contains variables that are neede for calculation within modeling the semiconductor models.</p>
   ...
   // components of mosfetInitEquations
    input Mosfet in_m "Input parameter set";
    output Mosfet out_m "Changed parameter set";

   // algorithms and equations of mosfetInitEquations
   algorithm
      out_m:=in_m;
...
<p>This function initially precalculats some values for transistor area which can be used for all transistor models.</p>
   ...
   function mosfetModelLineInitEquations
    "Type transscription"

   // components of mosfetModelLineInitEquations
    input Mosfet in_m "Input parameter set";
    output MosfetModelLine out_ml "Changed parameter set";

   // algorithms and equations of mosfetModelLineInitEquations
   algorithm
...
<p>In this function during the initialization phase the transistor type is transscibed to another parameter for further usage.</p>
   ...
   // components of getNumberOfElectricalPins
    output Integer ret "Number of pins";

   // algorithms and equations of getNumberOfElectricalPins
   algorithm
      ret:=4;
...
<p>The package Mosfet contains all functions and records that are used for all types of Mosfet transistors in SPICE3.</p>
  ...
  package Mos
   ...
   // components of MosModelLineParams
    ...
    Modelica.SIunits.Current m_jctSatCur(start=1.0e-14) "IS, Bulk junction sat. current";
    ...
    Modelica.SIunits.Temp_K m_tnom(start=SpiceConstants.CKTnomTemp) "TNOM, Parameter measurement temperature";
...
<p>This record MosModelLineParams contains the model line parameters that are used for the mosfet transistors level 1, 2, 3 and 6 in SPICE3.</p>
   ...
   // components of MosModelLineVariables
...
<p>This record DEVqmeyer contains values that are needed for the calculation of the meyer capacities and charge.</p>
   ...
   // components of CurrrentsCapacitances
...
<p>This record CurrentsCapacities contains values for the currents and the capacities inside the mosfet models level 1, 2, 3 and 6.</p>
   ...
   // components of mosCalcInitEquations
    input Mos1.Mos1ModelLineParams in_p "Input record model line parameters for MOS1";
   ...
   // algorithms and equations of mosCalcInitEquations
   algorithm
...
<p>This function mosCalcInitEquations does the initial precalculation of the mosfet parameters (level 1).</p>
   ...
   // components of mosCalcCalcTempDependencies
    input Mos1.Mos1ModelLineParams in_p "Input record model line parameters for MOS1";
    input SpiceConstants in_C "Input record SPICE constants";
    input Mos.MosModelLineVariables in_vp "Input record model line variables";
    input Mosfet.Mosfet in_m "Input record mosfet parameters";
   ...
   // algorithms and equations of mosCalcCalcTempDependencies
   algorithm
      out_c:=in_c;
      ...
      out_c.m_tVbi:=in_vp.m_vt0-in_m_type*in_vp.m_gamma*sqrt(in_vp.m_phi)+0.5*(Modelica.Electrical.Spice3.Internal.Functions.energyGapDepTemp(in_p.m_tnom)-Modelica.Electrical.Spice3.Internal.Functions.energyGapDepTemp(in_m.m_dTemp))+in_m_type*0.5*(out_c.m_tPhi-in_vp.m_phi);
...
<p>This function mosCalcCalcTempDependencies does precalculation relating to the temperature (level 1).</p>
   ...
   // components of mosCalcNoBypassCode
    input Mosfet.Mosfet in_m "Input record mosfet parameters";
    input Integer in_m_type "Type of MOS transistor";
    input Mos1.Mos1Calc in_c "Input record Mos1Calc";
    input Mos1.Mos1ModelLineParams in_p "Input record model line parameters for MOS1";
    ...
    input Modelica.SIunits.Voltage in_m_pVoltageValues[4];
   ...
   // algorithms and equations of mosCalcNoBypassCode
   algorithm
      int_c:=in_c;
...
<p>This function NoBypassCode calculates the currents (and the capacitances) that are necessary for the currents sum in the toplevelmodel (level 1).</p>
   ...
   // components of mosCalcDEVqmeyer
   ...
   // algorithms and equations of mosCalcDEVqmeyer
   algorithm
      vgst:=vgs-in_c.m_von;
...
<p>This function mosCalcDEVqmeyer calculates the meyer capacities and charge for the meyer model.</p>
   ...
   // components of mos2CalcInitEquations
   ...
   // algorithms and equations of mos2CalcInitEquations
   algorithm
      out_c.m_drainResistance:=(if in_p.m_drainResistanceIsGiven>0.5 then in_p.m_drainResistance else in_p.m_sheetResistance*in_m.m_drainSquares);
      out_c.m_sourceResistance:=(if in_p.m_sourceResistanceIsGiven>0.5 then in_p.m_sourceResistance else in_p.m_sheetResistance*in_m.m_sourceSquares);
      out_c.m_lEff:=in_m.m_len-2*in_p.m_latDiff;
...
<p>This function mosCalcInitEquations does the initial precalculation of the mosfet parameters (level 2).</p>
   ...
   // components of mos2CalcCalcTempDependencies
   ...
   // algorithms and equations of mos2CalcCalcTempDependencies
   algorithm
      out_c:=in_c;
      ratio:=in_m.m_dTemp/(in_p.m_tnom);
      ratio4:=ratio*sqrt(ratio);
      ...
      if not in_p.m_capBDIsGiven>0.5 or not in_p.m_capBSIsGiven>0.5 then
        (out_c.m_tCj):=Modelica.Electrical.Spice3.Internal.Functions.junctionParamDepTempSPICE3(in_p.m_bulkJctPotential,in_p.m_bulkCapFactor,in_p.m_bulkJctBotGradingCoeff,in_m.m_dTemp,in_p.m_tnom);
        (out_c.m_tCjsw):=Modelica.Electrical.Spice3.Internal.Functions.junctionParamDepTempSPICE3(in_p.m_bulkJctPotential,in_p.m_sideWallCapFactor,in_p.m_bulkJctSideGradingCoeff,in_m.m_dTemp,in_p.m_tnom);
        (out_c.m_f1s,out_c.m_f2s,out_c.m_f3s):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapCoeffs(in_p.m_bulkJctSideGradingCoeff,in_p.m_fwdCapDepCoeff,out_c.m_tBulkPot);
      end if;
      if in_p.m_capBDIsGiven>0.5 then
        (out_c.m_tCBDb):=Modelica.Electrical.Spice3.Internal.Functions.junctionParamDepTempSPICE3(in_p.m_bulkJctPotential,in_p.m_capBD,in_p.m_bulkJctBotGradingCoeff,in_m.m_dTemp,in_p.m_tnom);
        out_c.m_tCBDs:=0.0;
      else
        out_c.m_tCBDb:=out_c.m_tCj*in_m.m_drainArea;
        out_c.m_tCBDs:=out_c.m_tCjsw*in_m.m_drainPerimiter;
      ...
      if in_p.m_capBSIsGiven>0.5 then
        (out_c.m_tCBSb):=Modelica.Electrical.Spice3.Internal.Functions.junctionParamDepTempSPICE3(in_p.m_bulkJctPotential,in_p.m_capBS,in_p.m_bulkJctBotGradingCoeff,in_m.m_dTemp,in_p.m_tnom);
        out_c.m_tCBSs:=0.0;
      else
        out_c.m_tCBSb:=out_c.m_tCj*in_m.m_sourceArea;
        out_c.m_tCBSs:=out_c.m_tCjsw*in_m.m_sourcePerimiter;
...
<p>This function mosCalcCalcTempDependencies does precalculation relating to the temperature (level 2).</p>
   ...
   // components of mos2CalcNoBypassCode
    input Mosfet.Mosfet in_m "Input record mosfet parameters";
    input Integer in_m_type "Type of MOS transistor";
    input Mos2.Mos2Calc in_c "Input record Mos2Calc";
   ...
   // algorithms and equations of mos2CalcNoBypassCode
   algorithm
      int_c:=in_c;
      int_c.m_vgs:=in_m_type*(in_m_pVoltageValues[1]-in_m_pVoltageValues[4]);
      int_c.m_vbs:=in_m_type*(in_m_pVoltageValues[2]-in_m_pVoltageValues[4]);
...
<p>This package Mos contains functions and records with data of the mosfet models level 1, 2, 3 and 6.</p>
  ...
  package Mos1
   ...
   record Mos1ModelLineParams
    ...
    extends Mos.MosModelLineParams(m_lambda(start=0.0),m_transconductance(start=2.0e-5));
...
<p>This record Mos1Calc contains further mosfet variables (for level 1) that are needed for the calculations.</p>
   ...
   // components of mos1ModelLineParamsInitEquations
   ...
   // algorithms and equations of mos1ModelLineParamsInitEquations
   algorithm
      ...
      if not in_p.m_oxideThicknessIsGiven>0.5 or (in_p.m_oxideThickness==0) then
        ...
        if out_v.m_oxideCapFactor<>0 then
          if not in_p.m_transconductanceIsGiven>0.5 then
            out_v.m_transconductance:=in_p.m_surfaceMobility*out_v.m_oxideCapFactor*1e-4;
          end if;
          if in_p.m_substrateDopingIsGiven>0.5 then
            if (in_p.m_substrateDoping*1e6)>1.45e16 then
              if not in_p.m_phiIsGiven>0.5 then
                out_v.m_phi:=2*vtnom*Modelica.Math.log(in_p.m_substrateDoping*1e6/(1.45e16));
              ...
              if not in_p.m_gammaIsGiven>0.5 then
                out_v.m_gamma:=sqrt(2*11.70*8.854214871e-12*SpiceConstants.CHARGE*in_p.m_substrateDoping*1e6/(out_v.m_oxideCapFactor));
              end if;
              if not in_p.m_vtOIsGiven>0.5 then
                vfb:=wkfngs-in_p.m_surfaceStateDensity*1e4*SpiceConstants.CHARGE/(out_v.m_oxideCapFactor);
...
<p>This function mos1ModelLineParamsInitEquation does the initial precalculation of the mosfet model line parameters for level 1.</p>
   ...
   // algorithms and equations of drainCur
   algorithm
      out_c:=in_c;
      if vb<=0 then
...
<p>This function drainCur calculates the main currents that flows from drain node to source node (level 1).</p>
   ...
   // components of mos1RenameParameters
   ...
   // algorithms and equations of mos1RenameParameters
   algorithm
...
to the internal parameters (e.g., m_drainResistance). It also does the analysis of the IsGiven values (level 1).</p>
   ...
   // components of mos1RenameParametersDev
   ...
   // algorithms and equations of mos1RenameParametersDev
   algorithm
      dev.m_len:=L;
      dev.m_width:=W;
      dev.m_drainArea:=AD;
      ...
      dev.m_drainPerimiter:=PD;
      dev.m_sourcePerimiter:=PS;
...
<p>This package Mos1 contains functions and record with data of the mosfet model level 1.</p>
  ...
  package Mos2
   ...
   record Mos2ModelLineParams
    ...
    extends Mos.MosModelLineParams(m_lambda(start=0.0),m_transconductance(start=2.0e-5),m_bulkJctSideGradingCoeff(start=0.33),m_oxideThickness(start=1.0e-7));

   // components of Mos2ModelLineParams
    ...
    Modelica.SIunits.Charge m_channelCharge(start=1.0) "NEFF, Total channel charge coeff";
...
<p>This record Mos1ModelLineParams contains the model line parameters that are used for the mosfet transistors level 2 in SPICE3.</p>
   ...
   // components of Mos2ModelLineVariables
...
<p>This record Mos1Calc contains further mosfet variables (for level 2) that are needed for the calculations.</p>
   ...
   // components of mos2ModelLineParamsInitEquations
   ...
   // algorithms and equations of mos2ModelLineParamsInitEquations
   algorithm
      out_v.m_oxideCapFactor:=in_p.m_oxideCapFactor;
      out_v.m_transconductance:=in_p.m_transconductance;
      out_v.m_phi:=in_p.m_phi;
      ...
      if in_p.m_substrateDopingIsGiven>0.5 then
        if (out_v.m_substrateDoping*1.0e6)>1.45e16 then
          ...
          wkfngs:=wkfng-(3.25+0.5*egfet1+fermis);
          if not in_p.m_gammaIsGiven>0.5 then
            out_v.m_gamma:=sqrt(2.0*11.70*8.854214871e-12*in_C.CHARGE*out_v.m_substrateDoping*1.0e6)/(out_v.m_oxideCapFactor);
          end if;
          if not in_p.m_vtOIsGiven>0.5 then
      ...
      if not in_p.m_bulkCapFactorIsGiven>0.5 then
        out_v.m_bulkCapFactor:=sqrt(in_C.EPSSIL*in_C.CHARGE*out_v.m_substrateDoping*1e6/(2*in_p.m_bulkJctPotential));
      end if;
   ...
   algorithm
      ...
      if (in_vp.m_gamma>0.0) or (in_vp.m_substrateDoping>0.0) then
        ...
        if in_p.m_junctionDepth>0 then
          ...
          dasdb2:=(-in_vp.m_xd)*(d2sdb2+dsrgdb*dsrgdb*in_vp.m_xd/(in_p.m_junctionDepth*argxs))/(out_c.m_lEff*args);
          daddb2:=(-in_vp.m_xd)*(d2bdb2+dbrgdb*dbrgdb*in_vp.m_xd/(in_p.m_junctionDepth*argxd))/(out_c.m_lEff*argd);
      ...
      if in_p.m_maxDriftVel>0 then
        ...
        sig2[4]:=-1.0;
        if p1<0 then
          y3:=2.0*exp(Modelica.Math.log(sqrt(s2/(4.0)+p0))/(3.0))*cos(Modelica.Math.atan((-2.0)*p2/(s1))/(3.0))+b1/(3.0);
        else
          y3:=exp(Modelica.Math.log(abs((-s1)/(2.0)+p2))/(3.0))+exp(Modelica.Math.log(abs((-s1)/(2.0)-p2))/(3.0))+b1/(3.0);
        end if;
      ...
      elseif vds<=out_c.m_vdsat then
        ...
        out_c.m_gds:=arg+beta1*(vgs-vbin-eta*vds-gammad*barg-dgdvds*body/(1.5));
        arg:=out_c.m_cdrain*(dudvbs/(ufact)-dldvbs/(clfact));
        out_c.m_gmbs:=arg-beta1*(gdbdv+dgdvbs*body/(1.5)-factor*vds);
      else
        out_c.m_cdrain:=beta1*((vgs-vbin-eta*out_c.m_vdsat/(2.0))*out_c.m_vdsat-gammad*bodys/(1.5));
        arg:=out_c.m_cdrain*(dudvgs/(ufact)-dldvgs/(clfact));
        out_c.m_gm:=arg+beta1*out_c.m_vdsat+beta1*(vgs-vbin-eta*out_c.m_vdsat-gammad*bsarg)*dsdvgs;
        out_c.m_gds:=(-out_c.m_cdrain)*dldvds/(clfact)-beta1*dgdvds*bodys/(1.5);
        arg:=out_c.m_cdrain*(dudvbs/(ufact)-dldvbs/(clfact));
        out_c.m_gmbs:=arg-beta1*(gdbdvs+dgdvbs*bodys/(1.5)-factor*out_c.m_vdsat)+beta1*(vgs-vbin-eta*out_c.m_vdsat-gammad*bsarg)*dsdvbs;
      end if;
...
<p>This function drainCur calculates the main currents that flows from drain node to source node (level 2).</p>
   ...
   // components of mos2RenameParameters
   ...
   // algorithms and equations of mos2RenameParameters
   algorithm
      intern.m_narrowFactor:=ex.DELTA;
      intern.m_critFieldExp:=ex.UEXP;
      intern.m_critField:=ex.UCRIT;
      intern.m_maxDriftVel:=ex.VMAX;
      intern.m_junctionDepth:=ex.XJ;
      intern.m_channelCharge:=ex.NEFF;
      intern.m_fastSurfaceStateDensity:=ex.NFS;
      intern.m_oxideCapFactor:=0;
      intern.m_vtOIsGiven:=(if ex.VTO>-1e40 then 1 else 0);
      intern.m_vt0:=(if ex.VTO>-1e40 then ex.VTO else 0);
      intern.m_capBDIsGiven:=(if ex.CBD>-1e40 then 1 else 0);
      ...
      intern.m_bulkJctBotGradingCoeff:=ex.MJ;
      intern.m_bulkJctSideGradingCoeff:=ex.MJSW;
      intern.m_oxideThickness:=ex.TOX;
      intern.m_oxideThicknessIsGiven:=(if ex.TOX>-1e40 then 1 else 0);
...
to the internal parameters (e.g., m_drainResistance). It also does the analysis of the IsGiven values (level 2).</p>
   ...
   // components of mos2RenameParametersDev
   ...
   // algorithms and equations of mos2RenameParametersDev
   algorithm
      dev.m_len:=L;
      dev.m_width:=W;
      dev.m_drainArea:=AD;
...
<p>This package Mos2 contains functions and records with data of the mosfet model level 2.</p>
  ...
  package Diode
   ...
   // components of DiodeModelLineParams
    ...
    Modelica.SIunits.Capacitance m_junctionCap(start=0.0) "CJO, Junction capacitance";
    ...
    Modelica.SIunits.ActivationEnergy m_activationEnergy(start=1.11) "EG, Activation energy";
    ...
    Modelica.SIunits.Current m_breakdownCurrent(start=1.0e-3) "IBV, Current at reverse breakdown voltage";
    Modelica.SIunits.Temp_C m_nomTemp(start=SpiceConstants.CKTnomTemp) "TNOM, Parameter measurement temperature";
    Real m_fNcoef(start=0.0) "KF, flicker noise coefficient";
    Real m_fNexp(start=1.0) "AF, flicker noise exponent";
...
<p>This record contains the model line (also called model card) parameters that are used for the diode model  in SPICE3.</p>
   ...
   // components of DiodeModelLineVariables
    Real m_gradingCoeff;
...
<p>This record contains the model variables that are used for the diode model in SPICE3.</p>
   ...
   // components of CurrentsCapacitances
...
<p>This record contains the model variables that are used for the diode model in SPICE3.</p>
   ...
   // components of diodeModelLineInitEquations
    input DiodeModelLineParams in_p "Input record with diode model line parameters";
    output DiodeModelLineVariables out_v "Output record with diode model line variables";

   // algorithms and equations of diodeModelLineInitEquations
   algorithm
...
<p>In this function some initial calculations for the diode model are done, especially concerning the handling of the breakthrough voltage.</p>
   ...
   // components of diodeCalcTempDependencies
   ...
   // algorithms and equations of diodeCalcTempDependencies
   algorithm
      (out_c.m_tJctPot,out_c.m_tJctCap):=Modelica.Electrical.Spice3.Internal.Functions.junctionParamDepTempSPICE3(in_p.m_junctionPot,in_p.m_junctionCap,in_p.m_gradingCoeff,in_m.m_dTemp,in_p.m_nomTemp);
      out_c.m_tJctCap:=in_dp.m_area*out_c.m_tJctCap;
      (out_c.m_tF1,out_c.m_f2,out_c.m_f3):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapCoeffs(in_p.m_gradingCoeff,in_p.m_depletionCapCoeff,out_c.m_tJctPot);
      out_c.m_tSatCur:=Modelica.Electrical.Spice3.Internal.Functions.saturationCurDepTempSPICE3(in_p.m_satCur,in_m.m_dTemp,in_p.m_nomTemp,in_p.m_emissionCoeff,in_p.m_activationEnergy,in_p.m_saturationCurrentExp);
      out_c.m_tVcrit:=Modelica.Electrical.Spice3.Internal.Functions.junctionVCrit(in_m.m_dTemp,in_p.m_emissionCoeff,out_c.m_tSatCur);
      out_c.m_dVte:=in_m.m_dTemp*SpiceConstants.CONSTKoverQ*in_p.m_emissionCoeff;
      if in_v.m_pBvIsGiven>0.5 then
        out_c.m_tBrkdwnV:=Modelica.Electrical.Spice3.Internal.Functions.junctionVoltage23SPICE3(in_p.m_breakdownVoltage,in_p.m_breakdownCurrent,out_c.m_tSatCur,in_m.m_dTemp,in_p.m_emissionCoeff);
      end if;
...
<p>In this function for the diode model temperature dependencies are calculated using temperature treating functions from the equation package.</p>
   ...
   // components of diodeNoBypassCode
    ...
    input Modelica.SIunits.Voltage in_m_pVoltageValues[2];
   ...
   // algorithms and equations of diodeNoBypassCode
   algorithm
      ...
      if in_p.m_pBvIsGiven>0.5 then
        (out_cc.m_dCurrent,m_dCond):=Modelica.Electrical.Spice3.Internal.Functions.junction3(m_dPNVoltage,in_m.m_dTemp,in_p.m_emissionCoeff,in_c.m_tSatCur,in_c.m_tBrkdwnV);
      else
        (out_cc.m_dCurrent,m_dCond):=Modelica.Electrical.Spice3.Internal.Functions.junction2(m_dPNVoltage,in_m.m_dTemp,in_p.m_emissionCoeff,in_c.m_tSatCur);
      end if;
      (m_dCap,m_dCharge):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapTransTime(in_c.m_tJctCap,m_dPNVoltage,in_c.m_tJctPot*in_p.m_depletionCapCoeff,in_p.m_gradingCoeff,in_p.m_junctionPot,in_c.m_tF1,in_c.m_f2,in_c.m_f3,in_p.m_transitTime,m_dCond,m_dCurrent);
...
<p>This function NoBypassCode calculates the currents (and the capacitances) that are necessary for the currents to be used in the toplevel model.</p>
   ...
   // components of diodeCalcAdditionalValues
   ...
   // algorithms and equations of diodeCalcAdditionalValues
   algorithm
      out_v:=in_v;
...
<p>This function is prepared for additional calculations but it is plain (inputs are written to the outputs) in the actual version of this library.</p>
   ...
   // components of diodeRenameParameters
    input ModelcardDIODE ex "Modelcard with technologie parameters";
    input SpiceConstants con "Spice constants";
    output DiodeModelLineParams intern "Output record diode model line parameters";

   // algorithms and equations of diodeRenameParameters
   algorithm
...
to the internal parameters (e.g., m_satCur). It also does the analysis of the IsGiven values.</p>
   ...
   function diodeRenameParametersDev
    "Temperature calculation"

   // components of diodeRenameParametersDev
    input Modelica.SIunits.Temp_K TEMP "Temperature";
    ...
    input Boolean SENS_AREA "Flag to request sensitivity WRT area, not implemented yet";
    output DiodeParams dev "Output record with calculated diode parameters";

   // algorithms and equations of diodeRenameParametersDev
   algorithm
      dev.m_area:=AREA;
      dev.m_pIcIsGiven:=(if IC>-1e40 then 1 else 0);
      dev.m_dIC:=(if IC>-1e40 then IC else 0);
      dev.m_bOff:=OFF;
...
to the internal parameters (e.g., m_area). It also does the analysis of the IsGiven values.</p>
   ...
   function diodeRenameParametersDevTemp
    "Temperature calculation"

   // components of diodeRenameParametersDevTemp
    input Modelica.SIunits.Temp_C TEMP "Temperature";
    output Model.Model dev_temp "Input record Model";

   // algorithms and equations of diodeRenameParametersDevTemp
   algorithm
...
<p>This package Diode contains functions and record with data of the semiconductor diode model.</p>
  ...
  package Rsemiconductor
   ...
   // components of ResistorParams
    Modelica.SIunits.Resistance m_dResist(start=1000) "Device is a resistor model";
    ...
    Boolean m_bSensResist(start=false) "flag to request sensitivity WRT resistance";
...
<p>This record contains the device parameters that are used for the resistor model in SPICE3.</p>
   ...
   // components of ResistorModelLineParams
    Modelica.SIunits.Conversions.NonSIunits.FirstOrderTemperaturCoefficient m_dTC1 "First order temp, coefficient";
    Modelica.SIunits.Conversions.NonSIunits.SecondOrderTemperaturCoefficient m_dTC2 "Second order temp, coefficient";
...
<p>This record contains the model line (also called model card) parameters that are used for the resistor model in SPICE3.</p>
   ...
   // components of ResistorVariables
...
<p>This record contains the model variables that are used for the resistor model in SPICE3.</p>
   ...
   // components of resistorRenameParameters
   ...
   // algorithms and equations of resistorRenameParameters
   algorithm
      ...
      intern.m_dTnom:=(if ex.TNOM>-1e40 then ex.TNOM+SpiceConstants.CONSTCtoK else 300.15);
...
to the internal parameters (e.g., m_emissionCoeff). It also does the analysis of the IsGiven values.</p>
   ...
   // components of resistorRenameParametersDev
   ...
   // algorithms and equations of resistorRenameParametersDev
   algorithm
      intern.m_dResIsGiven:=(if R>-1e40 then 1 else 0);
      intern.m_dResist:=(if R>-1e40 then R else 0);
      intern.m_dWidthIsGiven:=(if W>-1e40 then 1 else 0);
      intern.m_dWidth:=(if W>-1e40 then W else 0);
      intern.m_dLengthIsGiven:=(if L>-1e40 then 1 else 0);
      intern.m_dLength:=(if L>-1e40 then L else 0);
      intern.m_bSensResist:=SENS_AREA;
      intern.m_dTemp:=(if TEMP>-1e40 then TEMP+SpiceConstants.CONSTCtoK else 300.15);
...
to the internal parameters (e.g., m_area). It also does the analysis of the IsGiven values.</p>
   ...
   // components of resistorInitEquations
   ...
   // algorithms and equations of resistorInitEquations
   algorithm
      ...
      if in_p.m_dResIsGiven<0.5 then
        if (abs(in_p.m_dLength)>1e-8) and (abs(in_p2.m_dRsh)>1e-25) then
          ...
          (out.m_dResist):=Modelica.Electrical.Spice3.Internal.Functions.resDepGeom(in_p2.m_dRsh,out.m_dWidth,in_p.m_dLength,in_p2.m_dNarrow);
        else
          out.m_dResist:=1000;
        end if;
      end if;
...
<p>This package Rsemiconductor contains functions and records with data of the semiconductor resistor model.</p>
  ...
  package Bjt3
   ...
   // components of BjtModelLineParams
    ...
    Modelica.SIunits.Temp_C m_tnom(start=SpiceConstants.CKTnomTemp) "TNOM, Parameter measurement temperature";
    ...
    Modelica.SIunits.Current m_leakBEcurrent(start=0.) "ISE, B-E leakage saturation current";
    Real m_c2(start=0.) "C2, Obsolete parameter name";
    Modelica.SIunits.Current m_leakBCcurrent(start=0.) "ISC, B-C leakage saturation current";
    ...
    Modelica.SIunits.Voltage m_earlyVoltF(start=0.0) "VAF, Forward Early voltage";
    Modelica.SIunits.Current m_rollOffF(start=0.0) "IKF, Forward beta roll-off corner current";
    Modelica.SIunits.Voltage m_earlyVoltR(start=0.0) "VAR, Reverse Early voltage";
    Modelica.SIunits.Current m_rollOffR(start=0.0) "IKR, reverse beta roll-off corner current";
    Modelica.SIunits.Resistance m_emitterResist(start=0.0) "RE, Emitter resistance";
    Modelica.SIunits.Resistance m_collectorResist(start=0.0) "RC, Collector resistance";
    Modelica.SIunits.Current m_baseCurrentHalfResist(start=0.0) "IRB, Current for base resistance=(rb+rbm)/2";
    Modelica.SIunits.Resistance m_baseResist(start=0.0) "RB, Zero bias base resistance";
    Modelica.SIunits.Resistance m_minBaseResist(start=0.0) "RBM, Minimum base resistance";
    Real m_minBaseResistIsGiven;
    Modelica.SIunits.Capacitance m_depletionCapBE(start=0.0) "CJE, Zero bias B-E depletion capacitance";
    Modelica.SIunits.Voltage m_potentialBE(start=0.75) "VJE, B-E built in potential";
    Real m_junctionExpBE(start=0.33) "MJE, B-E built in potential";
    Modelica.SIunits.Time m_transitTimeF(start=0.0) "TF, Ideal forward transit time";
    Real m_transitTimeBiasCoeffF(start=0.0) "XTF, Coefficient for bias dependence of TF";
    Modelica.SIunits.Current m_transitTimeHighCurrentF(start=0.0) "ITF, High current dependence of TF";
    Modelica.SIunits.Voltage m_transitTimeFVBC(start=0.0) "VTF, Voltage giving VBC dependence of TF";
    Modelica.SIunits.Temp_C m_excessPhase(start=0.0) "PTF, Excess phase";
    Modelica.SIunits.Capacitance m_depletionCapBC(start=0.0) "CJC, Zero bias B-C depletion capacitance";
    Modelica.SIunits.Voltage m_potentialBC(start=0.75) "VJC, B-C built in potential";
    ...
    Modelica.SIunits.Time m_transitTimeR(start=0.0) "TR, Ideal reverse transit time";
    Modelica.SIunits.Capacitance m_capCS(start=0.0) "CJS, Zero bias C-S capacitance";
    Modelica.SIunits.Voltage m_potentialSubstrate(start=0.75) "VJS, Zero bias C-S capacitance";
    ...
    Modelica.SIunits.GapEnergy m_energyGap(start=1.11) "EG, Energy gap for IS temp. dependency";
...
<p>This record contains the model line (also called model card) parameters that are used for the bipolar transistor model in SPICE3.</p>
   ...
   // components of BjtModelLineVariables
...
<p>This record contains the model line (also called model card) variables that are used for the bipolar transistor model in SPICE3.</p>
   ...
   // components of bjtModelLineInitEquations
    input BjtModelLineParams in_p "Input record with Bjt model line parameters";
    output BjtModelLineVariables out_v "Output record with Bjt model line variables";
   protected
    Real xfc;

   // algorithms and equations of bjtModelLineInitEquations
   algorithm
      out_v.m_type:=(if in_p.m_bPNP then -1 else 1);
...
<p>This record contains the model variables that are used for the bipoar transistor model in SPICE3.</p>
   ...
   // components of bjt3InitEquations
   ...
   // algorithms and equations of bjt3InitEquations
   algorithm
...
<p>Within this function some parameters are initially precalculated from model line parameters.</p>
   ...
   // components of bjt3CalcTempDependencies
   ...
   // algorithms and equations of bjt3CalcTempDependencies
   algorithm
      ...
      arg:=(-egfet)/(2*Modelica.Constants.k*m.m_dTemp)+1.1150877/(Modelica.Constants.k*(SpiceConstants.REFTEMP+SpiceConstants.REFTEMP));
      pbfact:=(-2)*vt*(1.5*Modelica.Math.log(fact2)+SpiceConstants.CHARGE*arg);
      ...
      out_c.m_tBEleakCur:=in_vl.m_leakBEcurrent*exp(factlog/(in_p.m_leakBEemissionCoeff))/(bfactor)*in_p3.m_area;
      out_c.m_tBCleakCur:=in_vl.m_leakBCcurrent*exp(factlog/(in_p.m_leakBCemissionCoeff))/(bfactor)*in_p3.m_area;
      ...
      (out_c.m_tF1c,out_c.m_f2c,out_c.m_f3c):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapCoeffs(in_p.m_junctionExpBC,in_p.m_depletionCapCoeff,out_c.m_tBCpot);
      (out_c.m_tF1e,out_c.m_f2e,out_c.m_f3e):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapCoeffs(in_p.m_junctionExpBE,in_p.m_depletionCapCoeff,out_c.m_tBEpot);
...
<p>In this function for the bipolar transistor model temperature dependencies are calculated using temperature treating functions from the equation package.</p>
   ...
   // components of bjt3NoBypassCode
    input Model.Model in_m "Input record model";
    input Bjt in_p3 "Input record Bjt3";
    input BjtModelLineParams in_p "Input record with Bjt model line parameters";
    input Bjt3Calc in_c "Input record Bjt3Calc";
    input BjtModelLineVariables in_vl "Input record with Bjt model line variables";
    input Modelica.SIunits.Voltage in_m_pVoltageValues[6];
    input Boolean in_m_bInit;
    output CurrentsCapacitances out_cc "Output record with calculated currents and capacitances";
   ...
   // algorithms and equations of bjt3NoBypassCode
   algorithm
      ...
      vbc:=vbe-vce;
      (cbe,gbe):=Modelica.Electrical.Spice3.Internal.Functions.junction2(vbe,in_m.m_dTemp,in_p.m_emissionCoeffF,in_c.m_tSatCur);
      out_cc.iBE:=in_p.m_type*cbe/(in_c.m_tBetaF);
      (cben,gben):=Modelica.Electrical.Spice3.Internal.Functions.junction2(vbe,in_m.m_dTemp,in_p.m_leakBEemissionCoeff,in_c.m_tBEleakCur);
      out_cc.iBEN:=in_p.m_type*cben;
      (cbc,gbc):=Modelica.Electrical.Spice3.Internal.Functions.junction2(vbc,in_m.m_dTemp,in_p.m_emissionCoeffR,in_c.m_tSatCur);
      out_cc.iBC:=in_p.m_type*cbc/(in_c.m_tBetaR);
      (cbcn,gbcn):=Modelica.Electrical.Spice3.Internal.Functions.junction2(vbc,in_m.m_dTemp,in_p.m_leakBCemissionCoeff,in_c.m_tBCleakCur);
      ...
      if (in_vl.m_excessPhaseFactor<>0) and (ttime>0.0) then
        ...
        denom:=1+arg1+arg2;
        arg3:=arg1/(denom);
        cc:=(bcex0*(1+step/(laststep)+arg2)-bcex1*step/(laststep))/(denom);
        cex:=cbe*arg3;
        gex:=gbe*arg3;
      end if;
      cc:=cc+(cex-cbc)/(qb);
      ...
      (capbe,chargebe):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapTransTime(in_c.m_tBEcap,vbe,in_c.m_tDepCapBE,in_p.m_junctionExpBE,in_c.m_tBEpot,in_c.m_tF1e,in_c.m_f2e,in_c.m_f3e,in_p.m_transitTimeF,gbe,cbe);
      out_cc.iXX:=0;
      aux1:=in_c.m_tBCcap*in_p.m_baseFractionBCcap;
      (capbc,chargebc):=Modelica.Electrical.Spice3.Internal.Functions.junctionCapTransTime(aux1,vbc,in_c.m_tDepCapBC,in_p.m_junctionExpBC,in_c.m_tBCpot,in_c.m_tF1c,in_c.m_f2c,in_c.m_f3c,in_p.m_transitTimeR,gbc,cbc);
      aux2:=in_c.m_tBCcap*(1.-in_p.m_baseFractionBCcap);
      (capbx,chargebx):=Modelica.Electrical.Spice3.Internal.Functions.junctionCap(aux2,vbx,in_c.m_tDepCapBC,in_p.m_junctionExpBC,in_c.m_tBCpot,in_c.m_tF1c,in_c.m_f2c,in_c.m_f3c);
...
<p>This record contains the model variables that are used for the bipoar transistor bjt model in SPICE3.</p>
   ...
   // components of bjtInitEquations
   ...
   // algorithms and equations of bjtInitEquations
   algorithm
...
<p>Within this function some parameters are initially precalculated from model line parameters.</p>
   ...
   // components of bjtNoBypassCode
    ...
    output Modelica.SIunits.Capacitance capbx "Capacitance";
   protected
    Modelica.SIunits.Voltage bjt3_VoltageValues[6];
    Integer i;
   ...
   // algorithms and equations of bjtNoBypassCode
   algorithm
      for i in 1:3 loop
      ...
      (out_cc,capbe,capbc,capbx):=bjt3NoBypassCode(in_m,in_p3,in_p,in_c,in_vl,bjt3_VoltageValues,in_m_bInit);
      capcs:=0;
      chargecs:=0;
      vcs:=in_p.m_type*(0-in_m_pVoltageValues[4]);
      if vcs<0 then
        arg:=1-vcs/(in_p.m_potentialSubstrate);
        sarg:=exp((-in_p.m_exponentialSubstrate)*Modelica.Math.log(arg));
        capcs:=in_v.m_CScap*sarg;
        chargecs:=in_p.m_potentialSubstrate*in_v.m_CScap*(1-arg*sarg)/(1-in_p.m_exponentialSubstrate);
      else
        capcs:=in_v.m_CScap*(1+in_p.m_exponentialSubstrate*vcs/(in_p.m_potentialSubstrate));
        chargecs:=vcs*in_v.m_CScap*(1+in_p.m_exponentialSubstrate*vcs/(2*in_p.m_potentialSubstrate));
      end if;
...
<p>This function NoBypassCode calculates the currents (and the capacitances) that are necessary for the currents to be used in the toplevel model.</p>
   ...
   // components of bjtRenameParameters
   ...
   // algorithms and equations of bjtRenameParameters
   algorithm
      intern.m_type:=TBJT;
      intern.m_satCur:=ex.IS;
...
to the internal parameters (e.g., m_satCur). It also does the analysis of the IsGiven values.</p>
   ...
   // components of bjtRenameParametersDev
    input Real AREA "Area factor";
    input Boolean OFF "Optional initial condition: false - IC not used, true - IC used, not implemented yet";
    input Modelica.SIunits.Voltage IC_VBE "Initial condition value, not yet implemented";
    input Modelica.SIunits.Voltage IC_VCE "Initial condition value, not yet implemented";
    input Boolean SENS_AREA "Flag for sensitivity analysis, not yet implemented";
    output Bjt3 dev "Output record Bjt3";

   // algorithms and equations of bjtRenameParametersDev
   algorithm
      dev.m_area:=AREA;
      dev.m_bOff:=OFF;
...
<p>This function assigns the external (given by the user, e.g., AREA) device parameters to the internal parameters (e.g., m_area). It also does the analysis of the IsGiven values.</p>
   ...
   function bjtRenameParametersDevTemp
    "Temperature calculation"

   // components of bjtRenameParametersDevTemp
    input Modelica.SIunits.Temp_C TEMP "Temperature";
    output Model.Model m "Output record model";

   // algorithms and equations of bjtRenameParametersDevTemp
   algorithm
...
<p>This function calculates device parameters wehich are temperature dependent.</p>
   ...
   function bjtRenameParametersType
    "Type"

   // components of bjtRenameParametersType
    input Real TBJT "Type";
    output BjtModelLineParams dev_type "Outputrecord Bjt3";

   // algorithms and equations of bjtRenameParametersType
   algorithm
...
annotation(preferedView="info",Window(x=0.05,y=0.06,width=0.16,height=0.58,library=1,autolayout=1),Documentation(info="<html>
