...
<li> Introducing a new name in the protected section of a non-partial
   ...
   class Version_3_2_BugFixes
    "Version 3.2 with bug fixes (Sept. 4, 2011)"
    extends Modelica.Icons.ReleaseNotes;
