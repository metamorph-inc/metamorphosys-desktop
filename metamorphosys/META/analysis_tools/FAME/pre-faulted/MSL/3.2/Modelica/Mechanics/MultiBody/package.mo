...
<li> <a href=\"modelica://Modelica.Mechanics.MultiBody.UsersGuide.Contact\">Contact</a> provides
 ...
 // locally defined classes in World
  replaceable   function gravityAcceleration = Modelica.Mechanics.MultiBody.Forces.Internal.standardGravityAcceleration(gravityType=gravityType,g=g*Modelica.Math.Vectors.normalize(n,0.0),mue=mue) constrainedby Modelica.Mechanics.MultiBody.Interfaces.partialGravityAcceleration;
 ...
 // components of World
  ...
  parameter Real mue(unit="m3/s2",min=0)=3.986e14 "Gravity field constant (default = field constant of earth)" annotation(Dialog(enable=gravityType==Modelica.Mechanics.MultiBody.Types.GravityTypes.PointGravity));
 ...
 // algorithms and equations of World
 equation
