...
// components of HeatingResistor
 Basic.HeatingResistor heatingResistor(R_ref=100,alpha=1e-3,T_ref=293.15) annotation(Placement(transformation(extent={{-10,10},{10,-10}},rotation=-90,origin={-32,34})));
