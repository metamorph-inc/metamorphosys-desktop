 ...
 package Conversions
  ...
  package NonSIunits
   ...
   extends Modelica.Icons.Package;
      ...
      type Temperature_degF = Real(final quantity="ThermodynamicTemperature",final unit="degF") "Absolute temperature in degree Fahrenheit (for relative temperature use SIunits.TemperatureDifference)" annotation(__Dymola_absoluteValue=true);
      type Temperature_degRk = Real(final quantity="ThermodynamicTemperature",final unit="degRk") "Absolute temperature in degree Rankine (for relative temperature use SIunits.TemperatureDifference)" annotation(__Dymola_absoluteValue=true);
...
<p>
      ...
      type MassFlowRate_gps = Real(final quantity="MassFlowRate",final unit="g/s") "Mass flow rate in gramm per second";
      type FirstOrderTemperaturCoefficient = Real(final quantity="FirstOrderTemperatureCoefficient",final unit="Ohm/degC") "First Order Temperatur Coefficient" annotation(__Dymola_absoluteValue=true);
      type SecondOrderTemperaturCoefficient = Real(final quantity="SecondOrderTemperatureCoefficient",final unit="Ohm/degC2") "Second Order Temperatur Coefficient" annotation(__Dymola_absoluteValue=true);
...
"),Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-66,-13},{52,-67}},lineColor={0,0,0},textString="[km/h]")}));
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-20,100},{-100,20}},lineColor={0,0,0},textString="K"),Text(extent={{100,-20},{20,-100}},lineColor={0,0,0},textString="degF")}));
  end to_degF;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-20,100},{-100,20}},lineColor={0,0,0},textString="degF"),Text(extent={{100,-20},{20,-100}},lineColor={0,0,0},textString="K"),Text(extent={{-20,100},{-100,20}},lineColor={0,0,0},textString="degF")}));
  end from_degF;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-20,100},{-100,20}},lineColor={0,0,0},textString="K"),Text(extent={{100,-32},{-18,-100}},lineColor={0,0,0},textString="degRk")}));
  end to_degRk;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-8,100},{-100,42}},lineColor={0,0,0},textString="degRk"),Text(extent={{100,-20},{20,-100}},lineColor={0,0,0},textString="K")}));
  end from_degRk;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{10,100},{-100,46}},lineColor={0,0,0},textString="rad"),Text(extent={{100,-44},{-10,-100}},lineColor={0,0,0},textString="deg")}));
  end to_deg;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{8,100},{-100,58}},lineColor={0,0,0},textString="m/s"),Text(extent={{100,-56},{-16,-100}},lineColor={0,0,0},textString="km/h")}));
  end to_kmh;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{10,100},{-100,56}},lineColor={0,0,0},textString="km/h"),Text(extent={{100,-50},{-20,-100}},lineColor={0,0,0},textString="m/s")}));
  end from_kmh;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-6,100},{-100,48}},lineColor={0,0,0},textString="s"),Text(extent={{100,-48},{-10,-98}},lineColor={0,0,0},textString="day")}));
  end to_day;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{10,100},{-100,52}},lineColor={0,0,0},textString="day"),Text(extent={{100,-54},{20,-100}},lineColor={0,0,0},textString="s")}));
  end from_day;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{12,100},{-100,50}},lineColor={0,0,0},textString="s"),Text(extent={{100,-56},{-20,-100}},lineColor={0,0,0},textString="hour")}));
  end to_hour;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{12,100},{-100,58}},lineColor={0,0,0},textString="hour"),Text(extent={{100,-50},{16,-100}},lineColor={0,0,0},textString="s")}));
  end from_hour;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-26,100},{-100,52}},lineColor={0,0,0},textString="s"),Text(extent={{100,-54},{-20,-100}},lineColor={0,0,0},textString="min")}));
  end to_minute;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{26,100},{-100,48}},lineColor={0,0,0},textString="min"),Text(extent={{100,-46},{0,-100}},lineColor={0,0,0},textString="s")}));
  end from_minute;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-4,100},{-100,62}},lineColor={0,0,0},textString="litre"),Text(extent={{100,-56},{-6,-100}},lineColor={0,0,0},textString="m3")}));
  end from_litre;
  ...
  // algorithms and equations of from_Ah
  algorithm
     Coulomb:=AmpereHour*3600;

  annotation(Icon(graphics={Text(extent={{-2,100},{-100,48}},lineColor={0,0,0},textString="Ah"),Text(extent={{100,-46},{0,-100}},lineColor={0,0,0},textString="C")}));
  end from_Ah;
  ...
  // algorithms and equations of to_Ah
  algorithm
     AmpereHour:=Coulomb/(3600);

  annotation(Icon(graphics={Text(extent={{-18,100},{-100,48}},lineColor={0,0,0},textString="C"),Text(extent={{100,-48},{2,-100}},lineColor={0,0,0},textString="Ah")}));
  end to_Ah;
  ...
  // components of from_Wh
   input NonSIunits.Energy_Wh WattHour "Watt hour";
   output Modelica.SIunits.Energy Joule "Joule";

  // algorithms and equations of from_Wh
  algorithm
     Joule:=WattHour*3600;

  annotation(Icon(graphics={Text(extent={{-20,100},{-100,54}},lineColor={0,0,0},textString="Wh"),Text(extent={{100,-38},{4,-100}},lineColor={0,0,0},textString="J")}));
  end from_Wh;
  ...
  // algorithms and equations of to_Wh
  algorithm
     WattHour:=Joule/(3600);

  annotation(Icon(graphics={Text(extent={{-30,100},{-100,48}},lineColor={0,0,0},textString="J"),Text(extent={{100,-46},{-14,-100}},lineColor={0,0,0},textString="Wh")}));
  end to_Wh;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-20,100},{-100,54}},lineColor={0,0,0},textString="J"),Text(extent={{100,-50},{-10,-100}},lineColor={0,0,0},textString="kWh")}));
  end to_kWh;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{12,100},{-100,52}},lineColor={0,0,0},textString="kWh"),Text(extent={{100,-44},{12,-100}},lineColor={0,0,0},textString="J")}));
  end from_kWh;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{100,-56},{12,-100}},lineColor={0,0,0},textString="Pa"),Text(extent={{2,100},{-100,52}},lineColor={0,0,0},textString="bar")}));
  end from_bar;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-12,100},{-100,60}},lineColor={0,0,0},textString="kg/s"),Text(extent={{100,-46},{-6,-100}},lineColor={0,0,0},textString="g/s")}));
  end to_gps;
  ...
  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-8,100},{-100,54}},lineColor={0,0,0},textString="g/s"),Text(extent={{100,-44},{-10,-100}},lineColor={0,0,0},textString="kg/s")}));
  end from_gps;
  ...
  // components of from_Hz
   input SIunits.Frequency f "frequency";
   output SIunits.AngularVelocity w "angular velocity";

  // algorithms and equations of from_Hz
  algorithm
     w:=2*Modelica.Constants.pi*f;

  annotation(Inline=true,Icon(graphics={Text(extent={{2,100},{-100,52}},lineColor={0,0,0},textString="Hz"),Text(extent={{100,-56},{12,-100}},lineColor={0,0,0},textString="1/s")}));
  end from_Hz;
  ...
  // algorithms and equations of to_Hz
  algorithm
     f:=w/(2*Modelica.Constants.pi);

  annotation(Inline=true,Icon(graphics={Text(extent={{100,-52},{-2,-100}},lineColor={0,0,0},textString="Hz"),Text(extent={{-12,100},{-100,56}},lineColor={0,0,0},textString="1/s")}));
  end to_Hz;
  ...
  // components of to_cm2
   input Area m2 "square metre value";
   output NonSIunits.Area_cm cm2 "square centimetre value";

  // algorithms and equations of to_cm2
  algorithm
     cm2:=0.0001*m2;

  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{-20,100},{-100,58}},lineColor={0,0,0},textString="m/s"),Text(extent={{100,-50},{-18,-100}},lineColor={0,0,0},textString="cm2")}));
  end to_cm2;
  ...
  // components of from_cm2
   input NonSIunits.Area_cm cm2 "square centimetre value";
   output Area m2 "square metre value";

  // algorithms and equations of from_cm2
  algorithm
     m2:=10000*cm2;

  annotation(Inline=true,Icon(coordinateSystem(preserveAspectRatio=true,extent={{-100,-100},{100,100}}),graphics={Text(extent={{2,100},{-100,58}},lineColor={0,0,0},textString="cm2"),Text(extent={{100,-50},{-16,-98}},lineColor={0,0,0},textString="m/s")}));
  end from_cm2;
...
"));
  ...
  type Density = Real(final quantity="Density",final unit="kg/m3",displayUnit="g/cm3",min=1e-6,max=30e3);
  type RelativeDensity = Real(final quantity="RelativeDensity",final unit="1",min=1e-6);
  type SpecificVolume = Real(final quantity="SpecificVolume",final unit="m3/kg",min=3e-5,max=1e6);
  ...
  type Pressure = Real(final quantity="Pressure",final unit="Pa",min=-10000e5,max=10000e5,nominal=1e5,start=1e5,displayUnit="bar");
  ...
  type ThermodynamicTemperature = Real(final quantity="ThermodynamicTemperature",final unit="K",min=1,max=6000,start=288.15,nominal=300,displayUnit="degC") "Absolute temperature (use type TemperatureDifference for relative temperatures)" annotation(__Dymola_absoluteValue=true);
  type Temp_K = ThermodynamicTemperature;
  type Temperature = ThermodynamicTemperature;
  type TemperatureDifference = Real(final quantity="ThermodynamicTemperature",final unit="K",min=-2000,max=2000,nominal=1,start=1,displayUnit="K") annotation(__Dymola_absoluteValue=false);
  ...
  type SpecificEntropy = Real(final quantity="SpecificEntropy",final unit="J/(kg.K)",nominal=1000);
  ...
  type MassFraction = Real(final quantity="MassFraction",final unit="1",min=0,max=1,nominal=0.01,start=0.2);
  ...
  type MoleFraction = Real(final quantity="MoleFraction",final unit="1",min=0,max=1,nominal=0.01,start=0.2);
  ...
  record ComplexCurrent = Complex(redeclare Modelica.SIunits.Current re,redeclare Modelica.SIunits.Current im) "Complex electrical current";
  record ComplexCurrentSlope = Complex(redeclare Modelica.SIunits.CurrentSlope re,redeclare Modelica.SIunits.CurrentSlope im) "Complex current slope";
  record ComplexCurrentDensity = Complex(redeclare Modelica.SIunits.CurrentDensity re,redeclare Modelica.SIunits.CurrentDensity im) "Complex electrical current density";
  record ComplexElectricPotential = Complex(redeclare Modelica.SIunits.ElectricPotential re,redeclare Modelica.SIunits.ElectricPotential im) "Complex electric potential";
  record ComplexPotentialDifference = Complex(redeclare Modelica.SIunits.PotentialDifference re,redeclare Modelica.SIunits.PotentialDifference im) "Complex electric potential difference";
  record ComplexVoltage = Complex(redeclare Modelica.SIunits.Voltage re,redeclare Modelica.SIunits.Voltage im) "Complex electrical voltage";
  record ComplexVoltageSlope = Complex(redeclare Modelica.SIunits.VoltageSlope re,redeclare Modelica.SIunits.VoltageSlope im) "Complex voltage slope";
  record ComplexElectricFieldStrength = Complex(redeclare Modelica.SIunits.ElectricFieldStrength re,redeclare Modelica.SIunits.ElectricFieldStrength im) "Complex electric field strength";
  record ComplexElectricFluxDensity = Complex(redeclare Modelica.SIunits.ElectricFluxDensity re,redeclare Modelica.SIunits.ElectricFluxDensity im) "Complex electric flux density";
  record ComplexElectricFlux = Complex(redeclare Modelica.SIunits.ElectricFlux re,redeclare Modelica.SIunits.ElectricFlux im) "Complex electric flux";
  record ComplexMagneticFieldStrength = Complex(redeclare Modelica.SIunits.MagneticFieldStrength re,redeclare Modelica.SIunits.MagneticFieldStrength im) "Complex magnetic field strength";
  record ComplexMagneticPotential = Complex(redeclare Modelica.SIunits.MagneticPotential re,redeclare Modelica.SIunits.MagneticPotential im) "Complex magnetic potential";
  record ComplexMagneticPotentialDifference = Complex(redeclare Modelica.SIunits.MagneticPotentialDifference re,redeclare Modelica.SIunits.MagneticPotentialDifference im) "Complex magnetic potential difference";
  record ComplexMagnetomotiveForce = Complex(redeclare Modelica.SIunits.MagnetomotiveForce re,redeclare Modelica.SIunits.MagnetomotiveForce im) "Complex magneto motive force";
  record ComplexMagneticFluxDensity = Complex(redeclare Modelica.SIunits.MagneticFluxDensity re,redeclare Modelica.SIunits.MagneticFluxDensity im) "Complex magnetic flux density";
  record ComplexMagneticFlux = Complex(redeclare Modelica.SIunits.MagneticFlux re,redeclare Modelica.SIunits.MagneticFlux im) "Complex magnetic flux";
  record ComplexReluctance = Complex(redeclare Modelica.SIunits.Reluctance re,redeclare Modelica.SIunits.Reluctance im) "Complex reluctance";
  record ComplexImpedance = Complex(redeclare Resistance re,redeclare Reactance im) "Complex electrical impedance";
  record ComplexAdmittance = Complex(redeclare Conductance re,redeclare Susceptance im) "Complex electrical impedance";
  record ComplexPower = Complex(redeclare ActivePower re,redeclare ReactivePower im) "Complex electrical power";
