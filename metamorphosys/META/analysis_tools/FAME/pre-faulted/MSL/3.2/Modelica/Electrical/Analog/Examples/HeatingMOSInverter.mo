...
model HeatingMOSInverter
 "Heating MOS Inverter"
 extends Modelica.Icons.Example;

// components of HeatingMOSInverter
 Modelica.Electrical.Analog.Basic.Ground G annotation(Placement(transformation(extent={{-80,-40},{-60,-20}},rotation=0)));
 Modelica.Electrical.Analog.Sources.SineVoltage Sin(V=5,freqHz=1) annotation(Placement(transformation(origin={-70,0},extent={{-10,-10},{10,10}},rotation=270)));
 Modelica.Electrical.Analog.Basic.Capacitor Capacitor1(C=0.00001) annotation(Placement(transformation(origin={30,10},extent={{-10,-10},{10,10}},rotation=270)));
 ...
 Modelica.Electrical.Analog.Sources.RampVoltage V(V=5,duration=1.e-2) annotation(Placement(transformation(origin={50,50},extent={{-10,-10},{10,10}},rotation=270)));
...
// algorithms and equations of HeatingMOSInverter
equation
 ...
 connect(Sin.p,H_NMOS.G) annotation(Line(points={{-70,10},{-54,10},{-54,5},{-40,5}},color={0,0,255},smooth=Smooth.None));
 connect(H_PMOS.G,Sin.p) annotation(Line(points={{-40,45},{-48,45},{-48,44},{-54,44},{-54,10},{-70,10}},color={0,0,255},smooth=Smooth.None));
