...
// components of ThyristorBehaviourTest
 ...
 Modelica.Electrical.Analog.Sources.PulseCurrent pulseCurrent(width=10,period=0.0001,startTime=0.00002,I=0.005) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=180,origin={-8,70})));
 ...
 Modelica.Electrical.Analog.Basic.Inductor inductor(L=2e-6) annotation(Placement(transformation(extent={{-10,-10},{10,10}},rotation=270,origin={8,-4})));

// algorithms and equations of ThyristorBehaviourTest
equation
