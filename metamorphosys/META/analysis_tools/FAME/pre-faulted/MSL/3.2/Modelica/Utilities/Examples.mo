...
package Examples
 ...
 // algorithms and equations of calculator
 algorithm
...
<blockquote><pre>
 ...
 // locally defined classes in expression
 ...
 protected
  ...
  // algorithms and equations of term
  algorithm
  ...
  // algorithms and equations of primary
  algorithm
 ...
 // algorithms and equations of expression
 algorithm
...
<blockquote><pre>
 ...
 // components of readRealParameter
 ...
 // algorithms and equations of readRealParameter
 algorithm
...
readRealParameter(\"test.txt\", \"w_rel0\")
 ...
 // components of readRealParameterModel
  parameter String file="Modelica/Resources/Data/Utilities/Examples_readRealParameters.txt" "File on which data is present" annotation(Dialog(__Dymola_loadSelector(filter="Text files (*.txt)",caption="Open text file to read parameters of the form \"name = value\"")));
