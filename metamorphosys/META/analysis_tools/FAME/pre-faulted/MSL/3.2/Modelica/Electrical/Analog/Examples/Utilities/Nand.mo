...
// components of Nand
 Semiconductors.PMOS TP1(W=6.5e-6,L=3.1e-6,Beta=1.05e-5,Vt=-1,K2=0.41,K5=0.8385,dW=-2.5e-6,dL=-2.1e-6) annotation(Placement(transformation(extent={{10,60},{30,80}},rotation=0)));
 Semiconductors.PMOS TP2(W=6.5e-6,L=3.1e-6,Beta=1.05e-5,Vt=-1,K2=0.41,K5=0.8385,dW=-2.5e-6,dL=-2.1e-6) annotation(Placement(transformation(extent={{-40,45},{-20,65}},rotation=0)));
 Semiconductors.NMOS TN1(W=6.5e-6,L=3.1e-6,Beta=4.1e-5,Vt=0.8,K2=1.144,K5=0.7311,dW=-2.5e-6,dL=-1.5e-6) annotation(Placement(transformation(extent={{10,15},{30,35}},rotation=0)));
 Semiconductors.NMOS TN2(W=6.5e-6,L=3.1e-6,Beta=4.1e-5,Vt=0.8,K2=1.144,K5=0.7311,dW=-2.5e-6,dL=-1.5e-6) annotation(Placement(transformation(extent={{10,-25},{30,-5}},rotation=0)));
 Basic.Capacitor C4(C=0.4e-13) annotation(Placement(transformation(origin={60,30},extent={{-10,-10},{10,10}},rotation=270)));
 Basic.Capacitor C7(C=0.4e-13) annotation(Placement(transformation(origin={55,-50},extent={{-10,-10},{10,10}},rotation=270)));
