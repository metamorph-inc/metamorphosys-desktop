...
// components of CauerLowPassAnalog
...
// algorithms and equations of CauerLowPassAnalog
equation
...
</html>"),Icon(coordinateSystem(preserveAspectRatio=true,extent={{-200,-100},{200,100}}),graphics));
