...
package Sources
 ...
 // locally defined classes in SignalVoltage
...
<p>The signall voltage source is a parameterless converter of real valued signals into a the source voltage. No further effects are modeled. The real valued signal has to be provided by components of the blocks library. It can be regarded as the &quot;Opposite&quot; of a voltage sensor.</p>
 ...
 // locally defined classes in ConstantVoltage

  model _famefaults_V
   extends FAME.Parametric.BaseParametricFault(amount=0.0);

  // locally defined classes in _famefaults_V

   type Modes = enumeration(Nominal, Weak);

  // components of _famefaults_V
   parameter Modes mode=Modes.Nominal;

  // algorithms and equations of _famefaults_V
  equation
   if mode==Modes.Weak then
    y = u*(1-amount);
   else
    y = u;
   end if;
 ...
 // components of ConstantVoltage
  ...
  _famefaults_V _famefault_V(u=V);
...
<p>The ConstantVoltage source is a simple source for an ideal constant voltage which is provided by a parameter. There is no internal resistance modeled. If it is used instead of a battery model it is not very realistic: This battery will never be unloaded.</p>
 ...
 // locally defined classes in StepVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of StepVoltage
  ...
  Modelica.Blocks.Sources.Step signalSource(final startTime=startTime,height=V,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of StepVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in RampVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of RampVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Time duration(min=Modelica.Constants.small,start=2) "Duration of ramp";
  parameter Modelica.SIunits.Voltage V(start=1) "Height of ramp";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  Modelica.Blocks.Sources.Ramp signalSource(final startTime=startTime,final duration=duration,final height=V,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of RampVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in SineVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;
 ...
 // components of SineVoltage
  ...
  Modelica.Blocks.Sources.Sine signalSource(final startTime=startTime,freqHz=freqHz,final offset=offset,phase=phase,amplitude=V);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 model ExpSineVoltage
  "Exponentially damped sine voltage source"

 // locally defined classes in ExpSineVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of ExpSineVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Voltage V(start=1) "Amplitude of sine wave";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  ...
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Damping damping(start=1) "Damping coefficient of sine wave";
  parameter Modelica.SIunits.Frequency freqHz(start=2) "Frequency of sine wave";
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  parameter Modelica.SIunits.Angle phase=0 "Phase of sine wave";
  Modelica.Blocks.Sources.ExpSine signalSource(final startTime=startTime,damping=damping,freqHz=freqHz,final offset=offset,phase=phase,amplitude=V);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of ExpSineVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in ExponentialsVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of ExponentialsVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Time fallTimeConst(min=Modelica.Constants.small,start=riseTimeConst) "Fall time constant";
  parameter Real vMax(start=1) "Upper bound for rising edge";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  parameter Modelica.SIunits.Time riseTimeConst(min=Modelica.Constants.small,start=0.1) "Rise time constant";
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Time riseTime(min=0,start=0.5) "Rise time";
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  Modelica.Blocks.Sources.Exponentials signalSource(final startTime=startTime,fallTimeConst=fallTimeConst,outMax=vMax,riseTimeConst=riseTimeConst,riseTime=riseTime,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of ExponentialsVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in PulseVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of PulseVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  ...
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  Modelica.Blocks.Sources.Pulse signalSource(final startTime=startTime,width=width,period=period,final offset=offset,amplitude=V);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of PulseVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 model SawToothVoltage
  "Saw tooth voltage source"

 // locally defined classes in SawToothVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of SawToothVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Voltage V(start=1) "Amplitude of saw tooth";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Time period(start=1) "Time for one period";
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  Modelica.Blocks.Sources.SawTooth signalSource(final startTime=startTime,period=period,final offset=offset,amplitude=V);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of SawToothVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 model TrapezoidVoltage
  "Trapezoidal voltage source"

 // locally defined classes in TrapezoidVoltage
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of TrapezoidVoltage
  parameter Modelica.SIunits.Time width(final min=0,start=0.5) "Width duration of trapezoid";
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Time falling(final min=0,start=0) "Falling duration of trapezoid";
  parameter Integer nperiod(start=-1) "Number of periods (< 0 means infinite number of periods)";
  parameter Modelica.SIunits.Time period(final min=Modelica.Constants.small,start=1) "Time for one period";
  Modelica.Blocks.Sources.Trapezoid signalSource(final startTime=startTime,rising=rising,width=width,falling=falling,nperiod=nperiod,period=period,final offset=offset,amplitude=V);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Voltage V(start=1) "Amplitude of trapezoid";
  parameter Modelica.SIunits.Time rising(final min=0,start=0) "Rising duration of trapezoid";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of TrapezoidVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This voltage source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in TableVoltage
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of TableVoltage
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  ...
  parameter Modelica.SIunits.Voltage offset=0 "Voltage offset";
  Modelica.Blocks.Sources.TimeTable signalSource(final startTime=startTime,table=table,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of TableVoltage
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<li><i> 1998   </i>
 ...
 // locally defined classes in SignalCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;
...
<p>The signall current source is a parameterless converter of real valued signals into a the source currrent. No further effects are modeled. The real valued signal has to be provided by components of the blocks library. It can be regarded as the &quot;Opposite&quot; of a current sensor.</p>
 ...
 // locally defined classes in ConstantCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;
...
<p>The ConstantCurrrent source is a simple source for an ideal constant current which is provided by a parameter. There is no internal resistance modeled. No further effects are modeled. Especially, th currend flow will never end.</p>
 ...
 // locally defined classes in StepCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of StepCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  ...
  parameter Modelica.SIunits.Current I(start=1) "Height of step";
  Modelica.Blocks.Sources.Step signalSource(final startTime=startTime,height=I,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of StepCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in RampCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of RampCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Time duration(min=Modelica.Constants.small,start=2) "Duration of ramp";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  ...
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Current offset=0 "Current offset";
  parameter Modelica.SIunits.Current I(start=1) "Height of ramp";
  Modelica.Blocks.Sources.Ramp signalSource(final startTime=startTime,final duration=duration,final height=I,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of RampCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in SineCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;
 ...
 // components of SineCurrent
  ...
  Modelica.Blocks.Sources.Sine signalSource(final startTime=startTime,freqHz=freqHz,final offset=offset,phase=phase,amplitude=I);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 model ExpSineCurrent
  "Exponentially damped sine current source"

 // locally defined classes in ExpSineCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of ExpSineCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  ...
  Modelica.Blocks.Sources.ExpSine signalSource(final startTime=startTime,damping=damping,freqHz=freqHz,final offset=offset,phase=phase,amplitude=I);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of ExpSineCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in ExponentialsCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of ExponentialsCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Time fallTimeConst(min=Modelica.Constants.small,start=riseTimeConst) "Fall time constant";
  ...
  parameter Modelica.SIunits.Time riseTime(min=0,start=0.5) "Rise time";
  parameter Modelica.SIunits.Current offset=0 "Current offset";
  Modelica.Blocks.Sources.Exponentials signalSource(final startTime=startTime,fallTimeConst=fallTimeConst,outMax=iMax,riseTimeConst=riseTimeConst,riseTime=riseTime,final offset=offset);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of ExponentialsCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in PulseCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of PulseCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Real width(final min=Modelica.Constants.small,final max=100,start=50) "Width of pulse in % of period";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  ...
  parameter Modelica.SIunits.Time period(final min=Modelica.Constants.small,start=1) "Time for one period";
  parameter Modelica.SIunits.Current offset=0 "Current offset";
  parameter Modelica.SIunits.Current I(start=1) "Amplitude of pulse";
  Modelica.Blocks.Sources.Pulse signalSource(final startTime=startTime,width=width,period=period,final offset=offset,amplitude=I);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of PulseCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in SawToothCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of SawToothCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
  ...
  parameter Modelica.SIunits.Time period(start=1) "Time for one period";
  parameter Modelica.SIunits.Current offset=0 "Current offset";
  parameter Modelica.SIunits.Current I(start=1) "Amplitude of saw tooth";
  Modelica.Blocks.Sources.SawTooth signalSource(final startTime=startTime,period=period,final offset=offset,amplitude=I);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  FAME.Bridges.Electrical _famefault_n__p(amount=0.0);

 // algorithms and equations of SawToothCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 model TrapezoidCurrent
  "Trapezoidal current source"

 // locally defined classes in TrapezoidCurrent
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of TrapezoidCurrent
  parameter Modelica.SIunits.Time width(final min=0,start=0.5) "Width duration of trapezoid";
  Modelica.Electrical.Analog.Interfaces.NegativePin n "Negative pin" annotation(Placement(transformation(extent={{110,-10},{90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_n(amount=0.0);
  parameter Modelica.SIunits.Time falling(final min=0,start=0) "Falling duration of trapezoid";
  parameter Integer nperiod(start=-1) "Number of periods (< 0 means infinite number of periods)";
  parameter Modelica.SIunits.Time period(final min=Modelica.Constants.small,start=1) "Time for one period";
  parameter Modelica.SIunits.Current I(start=1) "Amplitude of trapezoid";
  Modelica.Blocks.Sources.Trapezoid signalSource(final startTime=startTime,rising=rising,width=width,falling=falling,nperiod=nperiod,period=period,final offset=offset,amplitude=I);
  Modelica.SIunits.Current i "Current flowing from pin p to pin n";
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  parameter Modelica.SIunits.Time rising(final min=0,start=0) "Rising duration of trapezoid";
 ...
 // algorithms and equations of TrapezoidCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
...
<p>This current source uses the coresponding signal source of the Modelica.Blocks.Sources package. Care for the meaning of the parameters in the Blocks package. Furthermore, an offset parameter is introduced, which is added to the value calculated by the blocks source. The startTime parameter allows to shift the blocks source behavior on the time axis.</p>
 ...
 // locally defined classes in TableCurrent
    model _famefaults_p = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n = FAME.Dampers.ElectricalWithoutConnectEquations;
    model _famefaults_n__p = FAME.Bridges.Electrical;

 // components of TableCurrent
  parameter Modelica.SIunits.Time startTime=0 "Time offset";
  Modelica.SIunits.Voltage v "Voltage drop between the two pins (= p.v - n.v)";
  Modelica.Electrical.Analog.Interfaces.PositivePin p "Positive pin (potential p.v > n.v for positive voltage drop v)" annotation(Placement(transformation(extent={{-110,-10},{-90,10}},rotation=0)));
  FAME.Dampers.ElectricalWithoutConnectEquations _famefault_p(amount=0.0);
 ...
 // algorithms and equations of TableCurrent
 equation
  v = _famefault_p.port_b.v-_famefault_n.port_b.v;
  0 = _famefault_p.port_b.i+_famefault_n.port_b.i;
  i = _famefault_p.port_b.i;
