...
package Types
 ...
 extends Modelica.Icons.Package;
  ...
  type Roughness = Modelica.Icons.TypeReal(final quantity="Length",final unit="m",displayUnit="mm") "Real type for roughness of a pipe" annotation(Documentation(info="<html>
<p>
...
<dl>
 ...
 type Dynamics = enumeration(DynamicFreeInitial, FixedInitial, SteadyStateInitial, SteadyState)  "Enumeration to define definition of balance equations"
...
media have Medium.singleState = <b>true</b>.
 ...
 type CvTypes = enumeration(Av, Kv, Cv, OpPoint)  "Enumeration to define the choice of valve flow coefficient"
 annotation(Documentation(info="<html>
...
<a href=\"modelica://Modelica.Fluid.UsersGuide.ComponentDefinition.ValveCharacteristics\">
 ...
 type PortFlowDirection = enumeration(Entering, Leaving, Bidirectional)  "Enumeration to define whether flow reversal is allowed"
 annotation(Documentation(info="<html>
...
make the simulation of your model faster.
 ...
 type ModelStructure = enumeration(av_vb, a_v_b, av_b, a_vb)  "Enumeration with choices for model structure in distributed pipe model"
 annotation(Documentation(info="<html>
