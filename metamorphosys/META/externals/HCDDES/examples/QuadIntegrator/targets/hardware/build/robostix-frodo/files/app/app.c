...
typedef struct {
    ...
    MsingleC1C1M InnerLoop_vel_err;
...
void app_tasks_init() { 
   ...
   toggle = 1;
   pos_ref = 0.0;
   DataHandling_pos_msg.DataHandling_pos_ref_out = 0.0;
...
static void InnerLoop (void *parameters)
{
   ...
   for(;;)
   {
      ...
      //InnerLoop_thrust_commands.InnerLoop_Torque = DataHandling_pos_msg.DataHandling_pos_data_out;
      PORTC &=~0x40;
...
static void DataHandling (void *parameters)
{
   ...
   for(;;)
   {
     ...
     //DataHandling_pos_msg.DataHandling_pos_data_out = DataHandling_pos_msg.DataHandling_pos_data_out + DataHandling_sensor_data_in.DataHandling_pos_data;
...
task_entry tasks[] = {
   ...
   { DataHandling, "DataHandling", 5, 0},
   { InnerLoop, "InnerLoop", 14, 0},
   {NULL, NULL, 0, 0}
};

msg_entry msgs[] = {

   { 1, MSG_DIR_SEND, sizeof( DataHandling_pos_msg ), (portCHAR *) & DataHandling_pos_msg, (portCHAR *) & DataHandling_pos_msg_c, 6, pdFALSE},
   { 2, MSG_DIR_RECV, sizeof( OuterLoop_ang_ref ), (portCHAR *) & OuterLoop_ang_ref, (portCHAR *) & OuterLoop_ang_ref_c, 9, pdFALSE},
   { -1, 0, 0, NULL, NULL, 0, 0}
};

per_entry pers[] = {

  {1,"ADC",ADC_EXT_AVCC,0,ADC_PIN1,sizeof(DataHandling_pos_ref_t),(portCHAR*)&DataHandling_pos_ref,(portCHAR*)&DataHandling_pos_ref_c,2,NULL},
  {2,"UART",IN,1,0,sizeof(DataHandling_sensor_data_in_t),(portCHAR*)&DataHandling_sensor_data_in,(portCHAR*)&DataHandling_sensor_data_in_c,3,NULL},
  {3,"UART",OUT,1,0,sizeof(InnerLoop_thrust_commands_t),(portCHAR*)&InnerLoop_thrust_commands,(portCHAR*)&InnerLoop_thrust_commands_c,16,NULL},
