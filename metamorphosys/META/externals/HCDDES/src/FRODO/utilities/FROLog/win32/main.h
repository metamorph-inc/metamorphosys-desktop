...
#include "arch/win32/win32_platform.h"
...
#define UDP_LOCALADDRESS					"129.59.129.189"	// Must be actual IP address - not localhost or 127.0.0.1
#define UDP_REMOTEADDRESS					"129.59.129.255"
