...
#include "arch/osx/osx_platform.h"
...
#define UDP_LOCALADDRESS					"129.59.129.139"	// Must be actual IP address - not localhost or 127.0.0.1
#define UDP_REMOTEADDRESS					"129.59.129.255"	//"129.59.129.183"
...
#define UDP_EXPECTEPSILON					0.5
#define UDP_EXPECTFRACTION					0.75
// Logger
