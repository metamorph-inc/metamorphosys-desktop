...
IF %QUERY_ERRORLEVEL% == 1 (
 ...
 REM ----------------------------
 REM Antenna directivity pattern
 REM ----------------------------
...
IF EXIST "%META_PATH%..\tonka\src\CyPhy2RF\FDTDPostprocess\bin\Debug\FDTDPostprocess.exe" (
    SET CP2RFPP="%META_PATH%..\tonka\src\CyPhy2RF\FDTDPostprocess\bin\Debug\FDTDPostprocess.exe"
) ELSE (
IF EXIST "%META_PATH%..\tonka\src\CyPhy2RF\FDTDPostprocess\bin\Release\FDTDPostprocess.exe" (
    SET CP2RFPP="%META_PATH%..\tonka\src\CyPhy2RF\FDTDPostprocess\bin\Release\FDTDPostprocess.exe"
) ELSE (
    SET CP2RFPP="%META_PATH%bin\FDTDPostprocess.exe"
))
ECHO Running %CP2RFPP% -dir openEMS_input.xml...
%CP2RFPP% -dir openEMS_input.xml
