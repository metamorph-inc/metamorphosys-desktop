...
@if NOT EXIST "%ANDROID_BAT%" ( echo android.bat not found at %ANDROID_BAT%. Please install it by running //longbox/share/installers/Android/install_ant_build_deps.cmd & exit /b 2 )
@if NOT EXIST "%ANT_BAT%" ( echo ant.bat not found at %ANT_BAT%. Please install it by running //longbox/share/installers/Android/install_ant_build_deps.cmd & exit /b 2 )
