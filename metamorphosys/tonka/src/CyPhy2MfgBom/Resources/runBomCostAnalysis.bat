...
IF EXIST "%META_PATH%\..\tonka\src\BomCostAnalysis\bin\Release\BomCostAnalysis.exe" SET BOMCOSTANALYSIS=%META_PATH%\..\tonka\src\BomCostAnalysis\bin\Release\BomCostAnalysis.exe
