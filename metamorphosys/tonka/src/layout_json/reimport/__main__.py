...
boardSynthesis = [p for p in (os.path.join(meta_path, path) for path in ('bin/BoardSynthesis.exe', '../tonka/src/BoardSynthesis/bin/Release/BoardSynthesis.exe')) if os.path.isfile(p)][0]
