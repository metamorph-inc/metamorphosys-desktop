...
#ifndef  __AT_INITIATOR_ANNOTATED_H__
#define  __AT_INITIATOR_ANNOTATED_H__

#include "tlm.h"                                      // TLM headers
#include <map>                                        // STL map
#include "tlm_utils/peq_with_get.h"                   // Payload event queue FIFO

class at_initiator_annotated                          // TLM AT at_initiator_annotated 
...
//=============================================================================
    ...
    at_initiator_annotated                                // constructor
