...
//
/// @brief header file for initiator top for example with LT and DMI
//
//==============================================================================
//
//  Original Authors:
...
#include "lt_dmi_initiator.h"                  // LT/BLocking initiator with DMI
#include "traffic_generator.h"                 // traffic generator

class initiator_top                          		       
  : public sc_core::sc_module    
  , virtual public tlm::tlm_bw_transport_if<>  // inherit form TLM 2.0 interfaces
{
...
private:
  ...
  lt_dmi_initiator           m_lt_dmi_initiator;///< TLM initiator instance
