...
//=====================================================================
///  @file lt_extension_mandatory.cpp
///
///  @brief Example main instantiates the lt_extension_mandatory_top and call sc_start() 
///
//=====================================================================
//  Original Authors:
//    Charles Wilson, ESLX
...
#include "lt_extension_mandatory_top.h"  		    // top module
...
{
  REPORT_ENABLE_ALL_REPORTING ();         // REPORT_DISABLE_INFO_REPORTING
  
  lt_extension_mandatory_top top("top");  // instantiate a exmaple top module
