...
#  if defined(SC_BOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(SC_BOOST_HAS_WINTHREADS) && !defined(SC_BOOST_HAS_MPTASKS)
#        define SC_BOOST_HAS_PTHREADS
#     endif

      // SC_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // SC_BOOST_HAS_GETTIMEOFDAY:
      // SC_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
