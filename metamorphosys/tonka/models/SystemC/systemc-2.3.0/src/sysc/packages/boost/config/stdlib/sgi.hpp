...
#     define SC_BOOST_NO_LIMITS
// Note: <sysc/packages/boost/limits.hpp> will provide compile-time constants
#     undef SC_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#define SC_BOOST_STDLIB "SGI standard library"
