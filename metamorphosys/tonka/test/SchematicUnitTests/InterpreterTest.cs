 ...
 *
 * NOTES:
 *      This test assembly has been added to tonka/test/tests.xunit,
 ...
 *      is at "tonka\tonka\test\SchematicUnitTests\bin\Release".
 * 
 ************************************************************************/
...
namespace SchematicUnitTests
{
    ...
    public class InterpreterTest : InterpreterTestBaseClass, IUseFixture<InterpreterTestFixture>
    {
        ...
        public void MaxRetriesParameter()
        {
            ...
            string TestbenchPath = "/@TestBenches|kind=Testing|relpos=0/MaxRetriesParameter|kind=TestBench|relpos=0";
